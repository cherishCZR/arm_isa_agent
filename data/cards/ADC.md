...
**Title**: ADC -- A64 | **Class**: `general` | **XML ID**: `ADC`

**Summary**: Add with carry

**Description**:
This instruction adds two register values and the Carry flag
value, and writes the result to the destination register.

### Variant: `Not setting the condition flags (ADC_32_addsub_carry)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.addsub_carry.ADC_32_addsub_carry)
...
#### Execute (A64.dpreg.addsub_carry.ADC_32_addsub_carry)
...
### Variant: `Not setting the condition flags (ADC_64_addsub_carry)` (64-bit)
- **Condition**: `sf == 1`
