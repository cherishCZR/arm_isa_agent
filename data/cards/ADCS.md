...
**Title**: ADCS -- A64 | **Class**: `general` | **XML ID**: `ADCS`

**Summary**: Add with carry, setting flags

**Description**:
This instruction adds two register values and the
Carry flag value, and writes the result to the destination
register. It updates the condition flags based on the result.

### Variant: `Setting the condition flags (ADCS_32_addsub_carry)` (32-bit)
- **Condition**: `sf == 0`
...
|--------------------------|
| sf  0   1   11010000 Rm  000000 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_carry.ADCS_32_addsub_carry)
...
#### Execute (A64.dpreg.addsub_carry.ADCS_32_addsub_carry)
...
### Variant: `Setting the condition flags (ADCS_64_addsub_carry)` (64-bit)
- **Condition**: `sf == 1`
