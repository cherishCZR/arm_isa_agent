...
**Title**: ADDHN, ADDHN2 -- A64 | **Class**: `advsimd` | **XML ID**: `ADDHN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Add returning high narrow
...
The ADDHN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The ADDHN2 instruction writes the vector
...
- **Assembly**: `ADDHN{2}  <Vd>.<Tb>, <Vn>.<Ta>, <Vm>.<Ta>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  01  0   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.ADDHN_asimddiff_N)
...
#### Execute (A64.simd_dp.asimddiff.ADDHN_asimddiff_N)
