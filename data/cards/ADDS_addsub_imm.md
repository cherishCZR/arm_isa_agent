...
**Title**: ADDS (immediate) -- A64 | **Class**: `general` | **XML ID**: `ADDS_addsub_imm`

**Summary**: Add immediate value, setting flags
...
### Variant: `Setting the condition flags (ADDS_32S_addsub_imm)` (32-bit)
- **Condition**: `sf == 0`
...
|--------------------------|
| sf  0   1   100010 sh  imm12 Rn  Rd  |
```

#### Decode (A64.dpimm.addsub_imm.ADDS_32S_addsub_imm)
...
#### Execute (A64.dpimm.addsub_imm.ADDS_32S_addsub_imm)
...
### Variant: `Setting the condition flags (ADDS_64S_addsub_imm)` (64-bit)
- **Condition**: `sf == 1`
