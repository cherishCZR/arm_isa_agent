...
**Title**: ADDS (shifted register) -- A64 | **Class**: `general` | **XML ID**: `ADDS_addsub_shift`

**Summary**: Add optionally-shifted register, setting flags

**Description**:
This instruction adds a register value
and an optionally-shifted register value, and writes the
result to the destination register. It updates the condition
flags based on the result.

### Variant: `Setting the condition flags (ADDS_32_addsub_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|--------------------------------|
| sf  0   1   01011 shift 0   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_shift.ADDS_32_addsub_shift)
...
#### Execute (A64.dpreg.addsub_shift.ADDS_32_addsub_shift)
...
### Variant: `Setting the condition flags (ADDS_64_addsub_shift)` (64-bit)
- **Condition**: `sf == 1`
