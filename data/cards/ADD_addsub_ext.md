...
**Title**: ADD (extended register) -- A64 | **Class**: `general` | **XML ID**: `ADD_addsub_ext`

**Summary**: Add extended and scaled register

**Description**:
This instruction adds a register value and a sign or zero-extended
...
### Variant: `Not setting the condition flags (ADD_32_addsub_ext)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------------|
| sf  0   0   01011 00  1   Rm  option imm3 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_ext.ADD_32_addsub_ext)
...
#### Execute (A64.dpreg.addsub_ext.ADD_32_addsub_ext)
...
### Variant: `Not setting the condition flags (ADD_64_addsub_ext)` (64-bit)
- **Condition**: `sf == 1`
