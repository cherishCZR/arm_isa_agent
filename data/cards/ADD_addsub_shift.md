...
**Title**: ADD (shifted register) -- A64 | **Class**: `general` | **XML ID**: `ADD_addsub_shift`

**Summary**: Add optionally-shifted register

**Description**:
This instruction adds a register value and an optionally-shifted
register value, and writes the result to the destination register.

### Variant: `Not setting the condition flags (ADD_32_addsub_shift)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.addsub_shift.ADD_32_addsub_shift)
...
#### Execute (A64.dpreg.addsub_shift.ADD_32_addsub_shift)
...
### Variant: `Not setting the condition flags (ADD_64_addsub_shift)` (64-bit)
- **Condition**: `sf == 1`
