...
**Title**: AESD -- A64 | **Class**: `advsimd` | **XML ID**: `AESD_advsimd`
...
|--------------------------------|
| 0100 111 0   00  10100 0010 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.cryptoaes.AESD_B_cryptoaes)
...
#### Execute (A64.simd_dp.cryptoaes.AESD_B_cryptoaes)
