...
**Title**: AESMC -- A64 | **Class**: `advsimd` | **XML ID**: `AESMC_advsimd`
...
|--------------------------------|
| 0100 111 0   00  10100 0011 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.cryptoaes.AESMC_B_cryptoaes)
...
#### Execute (A64.simd_dp.cryptoaes.AESMC_B_cryptoaes)

```
AArch64.CheckFPAdvSIMDEnabled();

constant bits(128) operand = V[n, 128];
V[d, 128] = AESMixColumns(operand);
```
