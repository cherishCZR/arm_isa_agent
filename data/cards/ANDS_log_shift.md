...
**Title**: ANDS (shifted register) -- A64 | **Class**: `general` | **XML ID**: `ANDS_log_shift`

**Summary**: Bitwise AND (shifted register), setting flags
...
### Variant: `Setting the condition flags (ANDS_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.log_shift.ANDS_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.ANDS_32_log_shift)
...
### Variant: `Setting the condition flags (ANDS_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
