...
**Title**: AND (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `AND_advsimd`
...
|-----------------------------------------|
| 0   Q   0   0   111 0   00  1   Rm  00011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.AND_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.AND_asimdsame_only)
