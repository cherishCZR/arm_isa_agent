...
**Title**: AND (immediate) -- A64 | **Class**: `general` | **XML ID**: `AND_log_imm`

**Summary**: Bitwise AND (immediate)
...
### Variant: `Not setting the condition flags (AND_32_log_imm)` (32-bit)
- **Condition**: `sf == 0 && N == 0`
...
|--------------------------|
| sf  00  100100 N   immr imms Rn  Rd  |
```

#### Decode (A64.dpimm.log_imm.AND_32_log_imm)
...
#### Execute (A64.dpimm.log_imm.AND_32_log_imm)
...
### Variant: `Not setting the condition flags (AND_64_log_imm)` (64-bit)
- **Condition**: `sf == 1`
