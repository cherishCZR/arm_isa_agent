...
**Title**: AND (shifted register) -- A64 | **Class**: `general` | **XML ID**: `AND_log_shift`

**Summary**: Bitwise AND (shifted register)

**Description**:
This instruction performs a bitwise AND of a register value
and an optionally-shifted register value, and writes the result to the destination
register.

### Variant: `Not setting the condition flags (AND_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------|
| sf  00  01010 shift 0   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.log_shift.AND_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.AND_32_log_shift)
...
### Variant: `Not setting the condition flags (AND_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
