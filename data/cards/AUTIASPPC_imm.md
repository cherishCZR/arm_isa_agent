...
**Title**: AUTIASPPC -- A64 | **Class**: `general` | **XML ID**: `AUTIASPPC_imm`

**Architecture**: `FEAT_PAuth_LR` (ARMv9.5)

**Summary**: Authenticate return address using key A, using an immediate offset
...
### Variant: `Integer`
- **Assembly**: `AUTIASPPC  <label>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  25  22  20   4  |
|-----------------------|
| 1   11  100 111 00  imm16 11111 |
```

#### Decode (A64.dpimm.dp_1src_imm.AUTIASPPC_only_dp_1src_imm)
...
#### Execute (A64.dpimm.dp_1src_imm.AUTIASPPC_only_dp_1src_imm)

```
constant bits(64) pac_addr = PC64 - offset;

X[d, 64] = AuthIA2(X[d, 64], SP[64], pac_addr, auth_combined);
```
