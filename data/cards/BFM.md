...
**Title**: BFM -- A64 | **Class**: `general` | **XML ID**: `BFM`

**Summary**: Bitfield move

**Description**:
This instruction is usually accessed via one of its aliases, which are
...
### Variant: `Leaving other bits unchanged (BFM_32M_bitfield)` (32-bit)
- **Condition**: `sf == 0 && N == 0`
...
#### Decode (A64.dpimm.bitfield.BFM_32M_bitfield)
...
#### Execute (A64.dpimm.bitfield.BFM_32M_bitfield)
...
### Variant: `Leaving other bits unchanged (BFM_64M_bitfield)` (64-bit)
- **Condition**: `sf == 1 && N == 1`
