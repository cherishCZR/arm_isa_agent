...
**Title**: BIC (vector, immediate) -- A64 | **Class**: `advsimd` | **XML ID**: `BIC_advsimd_imm`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Bitwise bit clear (vector, immediate)

**Description**:
This instruction reads each vector element from the destination
SIMD&FP register, performs a bitwise AND between each result
and the complement of an immediate constant, places the result into
...
### Variant: `Shifted immediate (BIC_asimdimm_L_hl)` (16-bit)
...
|--------------------------------------------------|
| 0   Q   1   0111100000 a   b   c   xxx1 0   1   d   e   f   g   h   Rd  |
```

#### Decode (A64.simd_dp.asimdimm.BIC_asimdimm_L_hl)
...
#### Execute (A64.simd_dp.asimdimm.BIC_asimdimm_L_hl)
...
### Variant: `Shifted immediate (BIC_asimdimm_L_sl)` (32-bit)
