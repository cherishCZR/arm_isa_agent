...
**Title**: BIC (shifted register) -- A64 | **Class**: `general` | **XML ID**: `BIC_log_shift`

**Summary**: Bitwise bit clear (shifted register)
...
### Variant: `Not setting the condition flags (BIC_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------|
| sf  00  01010 shift 1   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.log_shift.BIC_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.BIC_32_log_shift)
...
### Variant: `Not setting the condition flags (BIC_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
