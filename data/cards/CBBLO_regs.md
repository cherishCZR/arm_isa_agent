...
**Title**: CBBLO -- A64 | **Class**: `general` | **XML ID**: `CBBLO_regs`

**Architecture**: `FEAT_CMPBR` (ARMv9.6)

**Summary**: Compare unsigned lower than bytes and branch

**Description**:
This instruction compares the unsigned byte values in two registers, and conditionally
...
### Variant: `Branch` (Higher)
- **Assembly**: `CBBLO  <Wm>, <Wt>, <label>`
- **Alias of**: `CBBHI  <Wt>, <Wm>, <label>`
  Condition: Never
...
- alias_mnemonic: `CBBLO`
- datatype: `8`
- isa: `A64`
- sve-compare-type: `hi`
- source: `cbblo_regs.xml`
</details>