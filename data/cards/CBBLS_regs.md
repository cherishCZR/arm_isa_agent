...
**Title**: CBBLS -- A64 | **Class**: `general` | **XML ID**: `CBBLS_regs`

**Architecture**: `FEAT_CMPBR` (ARMv9.6)

**Summary**: Compare unsigned lower than or equal bytes and branch
...
- **Assembly**: `CBBLS  <Wm>, <Wt>, <label>`
- **Alias of**: `CBBHS  <Wt>, <Wm>, <label>`
  Condition: Never
...
- alias_mnemonic: `CBBLS`
- datatype: `8`
- isa: `A64`
- sve-compare-type: `hs`
- source: `cbbls_regs.xml`
</details>