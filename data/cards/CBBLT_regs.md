...
**Title**: CBBLT -- A64 | **Class**: `general` | **XML ID**: `CBBLT_regs`

**Architecture**: `FEAT_CMPBR` (ARMv9.6)

**Summary**: Compare signed less than bytes and branch
...
- **Assembly**: `CBBLT  <Wm>, <Wt>, <label>`
- **Alias of**: `CBBGT  <Wt>, <Wm>, <label>`
  Condition: Never
...
- alias_mnemonic: `CBBLT`
- datatype: `8`
- isa: `A64`
- sve-compare-type: `gt`
- source: `cbblt_regs.xml`
</details>