...
**Title**: CBHLE -- A64 | **Class**: `general` | **XML ID**: `CBHLE_regs`

**Architecture**: `FEAT_CMPBR` (ARMv9.6)

**Summary**: Compare signed less than or equal halfwords and branch
...
- **Assembly**: `CBHLE  <Wm>, <Wt>, <label>`
- **Alias of**: `CBHGE  <Wt>, <Wm>, <label>`
  Condition: Never
...
- alias_mnemonic: `CBHLE`
- datatype: `16`
- isa: `A64`
- sve-compare-type: `ge`
- source: `cbhle_regs.xml`
</details>