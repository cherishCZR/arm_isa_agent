...
**Title**: CBHLO -- A64 | **Class**: `general` | **XML ID**: `CBHLO_regs`

**Architecture**: `FEAT_CMPBR` (ARMv9.6)

**Summary**: Compare unsigned lower than halfwords and branch
...
- **Assembly**: `CBHLO  <Wm>, <Wt>, <label>`
- **Alias of**: `CBHHI  <Wt>, <Wm>, <label>`
  Condition: Never
...
- alias_mnemonic: `CBHLO`
- datatype: `16`
- isa: `A64`
- sve-compare-type: `hi`
- source: `cbhlo_regs.xml`
</details>