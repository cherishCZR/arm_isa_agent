...
**Title**: CCMN (immediate) -- A64 | **Class**: `general` | **XML ID**: `CCMN_imm`

**Summary**: Conditional compare negative (immediate)
...
### Variant: `5-bit unsigned immediate (CCMN_32_condcmp_imm)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------------|
| sf  0   1   11010010 imm5 cond 1   0   Rn  0   nzcv |
```

#### Decode (A64.dpreg.condcmp_imm.CCMN_32_condcmp_imm)
...
#### Execute (A64.dpreg.condcmp_imm.CCMN_32_condcmp_imm)
...
### Variant: `5-bit unsigned immediate (CCMN_64_condcmp_imm)` (64-bit)
- **Condition**: `sf == 1`
