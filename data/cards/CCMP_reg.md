...
**Title**: CCMP (register) -- A64 | **Class**: `general` | **XML ID**: `CCMP_reg`

**Summary**: Conditional compare (register)
...
### Variant: `Integer (CCMP_32_condcmp_reg)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------------|
| sf  1   1   11010010 Rm  cond 0   0   Rn  0   nzcv |
```

#### Decode (A64.dpreg.condcmp_reg.CCMP_32_condcmp_reg)
...
#### Execute (A64.dpreg.condcmp_reg.CCMP_32_condcmp_reg)
...
### Variant: `Integer (CCMP_64_condcmp_reg)` (64-bit)
- **Condition**: `sf == 1`
