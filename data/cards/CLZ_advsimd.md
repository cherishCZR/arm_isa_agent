...
**Title**: CLZ (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `CLZ_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Count leading zero bits (vector)
...
|--------------------------------------|
| 0   Q   1   0   111 0   size 10000 00100 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.CLZ_asimdmisc_R)
...
#### Execute (A64.simd_dp.asimdmisc.CLZ_asimdmisc_R)
