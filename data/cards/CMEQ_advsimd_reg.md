...
**Title**: CMEQ (register) -- A64 | **Class**: `advsimd` | **XML ID**: `CMEQ_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Compare bitwise equal (vector)

**Description**:
This instruction compares each vector element from the first source SIMD&FP register
with the corresponding vector element from the second source SIMD&FP register,
and if the comparison is equal sets every bit of the corresponding vector element
...
### Variant: `Scalar`
- **Assembly**: `CMEQ  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  10  9   4  |
|--------------------------------------|
| 01  1   1   111 0   11  1   Rm  10001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.CMEQ_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.CMEQ_asisdsame_only)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  10001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.CMEQ_asimdsame_only)
