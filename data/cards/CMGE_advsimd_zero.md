...
**Title**: CMGE (zero) -- A64 | **Class**: `advsimd` | **XML ID**: `CMGE_advsimd_zero`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Compare signed greater than or equal to zero (vector)

**Description**:
This instruction reads each vector element in the source SIMD&FP register
and if the signed integer value is greater than or equal to zero
...
### Variant: `Scalar`
- **Assembly**: `CMGE  D<d>, D<n>, #0`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21  16  12 11   9   4  |
|--------------------------------------|
| 01  1   1   111 0   11  10000 0100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.CMGE_asisdmisc_Z)
...
#### Execute (A64.simd_dp.asisdmisc.CMGE_asisdmisc_Z)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 10000 0100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.CMGE_asimdmisc_Z)
