...
**Title**: CMGT (register) -- A64 | **Class**: `advsimd` | **XML ID**: `CMGT_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Compare signed greater than (vector)
...
and if the first signed integer value is greater than
...
### Variant: `Scalar`
- **Assembly**: `CMGT  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  11 10  9   4  |
|-----------------------------------------|
| 01  0   1   111 0   11  1   Rm  0011 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.CMGT_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.CMGT_asisdsame_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  0011 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.CMGT_asimdsame_only)
