...
**Title**: CMHS (register) -- A64 | **Class**: `advsimd` | **XML ID**: `CMHS_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Compare unsigned higher or same (vector)
...
and if the first unsigned integer value is greater than or equal to
...
### Variant: `Scalar`
- **Assembly**: `CMHS  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  11 10  9   4  |
|-----------------------------------------|
| 01  1   1   111 0   11  1   Rm  0011 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.CMHS_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.CMHS_asisdsame_only)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  0011 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.CMHS_asimdsame_only)
