...
**Title**: CMLT (zero) -- A64 | **Class**: `advsimd` | **XML ID**: `CMLT_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Compare signed less than zero (vector)

**Description**:
This instruction reads each vector element in the source SIMD&FP register
and if the signed integer value is less than zero
...
### Variant: `Scalar`
- **Assembly**: `CMLT  D<d>, D<n>, #0`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21  16  11   9   4  |
|-----------------------------------|
| 01  0   1   111 0   11  10000 01010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.CMLT_asisdmisc_Z)
...
#### Execute (A64.simd_dp.asisdmisc.CMLT_asisdmisc_Z)
...
|--------------------------------------|
| 0   Q   0   0   111 0   size 10000 01010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.CMLT_asimdmisc_Z)
