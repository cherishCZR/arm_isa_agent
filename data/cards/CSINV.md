...
**Title**: CSINV -- A64 | **Class**: `general` | **XML ID**: `CSINV`

**Summary**: Conditional select invert

**Description**:
This instruction returns, in the destination register,
the value of the first source register if the condition is TRUE,
and otherwise returns the bitwise inversion value of the second
source register.

### Variant: `Integer (CSINV_32_condsel)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.condsel.CSINV_32_condsel)
...
#### Execute (A64.dpreg.condsel.CSINV_32_condsel)
...
### Variant: `Integer (CSINV_64_condsel)` (64-bit)
- **Condition**: `sf == 1`
