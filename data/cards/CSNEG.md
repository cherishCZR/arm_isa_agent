...
**Title**: CSNEG -- A64 | **Class**: `general` | **XML ID**: `CSNEG`

**Summary**: Conditional select negation
...
### Variant: `Integer (CSNEG_32_condsel)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.condsel.CSNEG_32_condsel)
...
#### Execute (A64.dpreg.condsel.CSNEG_32_condsel)
...
### Variant: `Integer (CSNEG_64_condsel)` (64-bit)
- **Condition**: `sf == 1`
