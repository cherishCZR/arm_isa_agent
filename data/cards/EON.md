...
**Title**: EON (shifted register) -- A64 | **Class**: `general` | **XML ID**: `EON`

**Summary**: Bitwise exclusive-OR NOT (shifted register)

**Description**:
This instruction performs a bitwise exclusive-OR
NOT of a register value and an optionally-shifted
register value, and writes the result to the destination
register.

### Variant: `Not setting the condition flags (EON_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------|
| sf  10  01010 shift 1   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.log_shift.EON_32_log_shift)
...
### Variant: `Not setting the condition flags (EON_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
