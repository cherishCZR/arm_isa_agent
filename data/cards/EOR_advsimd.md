...
**Title**: EOR (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `EOR_advsimd`
...
two source SIMD&FP registers, and places the
...
|-----------------------------------------|
| 0   Q   1   0   111 0   00  1   Rm  00011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.EOR_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.EOR_asimdsame_only)
...
constant bits(datasize) operand3 = Ones(datasize);
constant bits(datasize) operand4 = V[n, datasize];
