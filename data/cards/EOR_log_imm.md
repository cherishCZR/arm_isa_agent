...
**Title**: EOR (immediate) -- A64 | **Class**: `general` | **XML ID**: `EOR_log_imm`

**Summary**: Bitwise exclusive-OR (immediate)

**Description**:
This instruction performs a bitwise exclusive-OR
of a register value and an immediate value,
and writes the result to the destination register.

### Variant: `Not setting the condition flags (EOR_32_log_imm)` (32-bit)
- **Condition**: `sf == 0 && N == 0`
...
#### Decode (A64.dpimm.log_imm.EOR_32_log_imm)
...
#### Execute (A64.dpimm.log_imm.EOR_32_log_imm)
...
### Variant: `Not setting the condition flags (EOR_64_log_imm)` (64-bit)
- **Condition**: `sf == 1`
