...
**Title**: EOR (shifted register) -- A64 | **Class**: `general` | **XML ID**: `EOR_log_shift`

**Summary**: Bitwise exclusive-OR (shifted register)
...
### Variant: `Integer (EOR_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------|
| sf  10  01010 shift 0   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.log_shift.EOR_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.EOR_32_log_shift)
...
### Variant: `Integer (EOR_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
