...
**Title**: FACGT -- A64 | **Class**: `advsimd` | **XML ID**: `FACGT_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point absolute compare greater than (vector)
...
- **Assembly**: `FACGT  <Hd>, <Hn>, <Hm>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  20  15  13  11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 0   1   10  Rm  00  10  1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsamefp16.FACGT_asisdsamefp16_only)
...
#### Execute (A64.simd_dp.asisdsamefp16.FACGT_asisdsamefp16_only)
...
|--------------------------------------------|
| 01  1   1   111 0   1   sz  1   Rm  1110 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.FACGT_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  10  1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FACGT_asimdsamefp16_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   1   sz  1   Rm  1110 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FACGT_asimdsame_only)
