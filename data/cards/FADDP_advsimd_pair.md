...
**Title**: FADDP (scalar) -- A64 | **Class**: `advsimd` | **XML ID**: `FADDP_advsimd_pair`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point add pair of elements (scalar)

**Description**:
This instruction adds two floating-point vector elements in the source SIMD&FP register
...
- **Assembly**: `FADDP  H<d>, <Vn>.2H`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22 21  16  11   9   4  |
|--------------------------------------|
| 01  0   1   111 0   0   0   11000 01101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdpair.FADDP_asisdpair_only_H)
...
#### Execute (A64.simd_dp.asisdpair.FADDP_asisdpair_only_H)
...
| 31  29 28 27  24 23 22 21  16  11   9   4  |
|--------------------------------------|
| 01  1   1   111 0   0   sz  11000 01101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdpair.FADDP_asisdpair_only_SD)
