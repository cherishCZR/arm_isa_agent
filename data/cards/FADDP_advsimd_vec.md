...
**Title**: FADDP (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FADDP_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point add pairwise (vector)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   10  Rm  00  010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FADDP_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FADDP_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   sz  1   Rm  11010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FADDP_asimdsame_only)
