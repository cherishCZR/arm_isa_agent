...
**Title**: FADD (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FADD_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point add (vector)

**Description**:
This instruction adds corresponding vector elements in the
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   10  Rm  00  010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FADD_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FADD_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   sz  1   Rm  11010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FADD_asimdsame_only)
