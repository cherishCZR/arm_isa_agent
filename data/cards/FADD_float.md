...
**Title**: FADD (scalar) -- A64 | **Class**: `float` | **XML ID**: `FADD_float`

**Summary**: Floating-point add (scalar)

**Description**:
This instruction adds the floating-point values of the two
source SIMD&FP registers, and
...
### Variant: `Floating-point (FADD_H_floatdp2)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FADD  <Hd>, <Hn>, <Hm>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  001 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp2.FADD_H_floatdp2)
...
#### Execute (A64.simd_dp.floatdp2.FADD_H_floatdp2)
...
### Variant: `Floating-point (FADD_S_floatdp2)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FADD_D_floatdp2)` (Double-precision)
- **Condition**: `ftype == 01`
