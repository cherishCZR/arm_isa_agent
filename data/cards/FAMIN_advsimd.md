...
**Title**: FAMIN -- A64 | **Class**: `advsimd` | **XML ID**: `FAMIN_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FAMINMAX` (FEAT_AdvSIMD && FEAT_FAMINMAX)

**Summary**: Floating-point absolute minimum
...
- **Assembly**: `FAMIN  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22  20  15  13  10  9   4  |
|--------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FAMIN_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FAMIN_asimdsamefp16_only)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   1x  1   Rm  11011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FAMIN_asimdsame_only)
