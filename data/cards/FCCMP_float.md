...
**Title**: FCCMP -- A64 | **Class**: `float` | **XML ID**: `FCCMP_float`

**Summary**: Floating-point conditional quiet compare (scalar)
...
### Variant: `Floating-point (FCCMP_H_floatccmp)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FCCMP  <Hn>, <Hm>, #<nzcv>, <cond>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  cond 01  Rn  0   nzcv |
```

#### Decode (A64.simd_dp.floatccmp.FCCMP_H_floatccmp)
...
#### Execute (A64.simd_dp.floatccmp.FCCMP_H_floatccmp)
...
### Variant: `Floating-point (FCCMP_S_floatccmp)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FCCMP_D_floatccmp)` (Double-precision)
- **Condition**: `ftype == 01`
