...
**Title**: FCMGE (zero) -- A64 | **Class**: `advsimd` | **XML ID**: `FCMGE_advsimd_zero`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point compare greater than or equal to zero (vector)
...
- **Assembly**: `FCMGE  <Hd>, <Hn>, #0.0`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  12 11   9   4  |
|-----------------------------------------|
| 01  1   1   111 0   1   1111 00  0110 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FCMGE_asisdmiscfp16_FZ)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FCMGE_asisdmiscfp16_FZ)
...
|-----------------------------------------|
| 01  1   1   111 0   1   sz  10000 0110 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FCMGE_asisdmisc_FZ)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   1111 00  0110 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FCMGE_asimdmiscfp16_FZ)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   sz  10000 0110 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FCMGE_asimdmisc_FZ)
