...
**Title**: FCMGT (register) -- A64 | **Class**: `advsimd` | **XML ID**: `FCMGT_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point compare greater than (vector)
...
- **Assembly**: `FCMGT  <Hd>, <Hn>, <Hm>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  20  15  13  11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 0   1   10  Rm  00  10  0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsamefp16.FCMGT_asisdsamefp16_only)
...
#### Execute (A64.simd_dp.asisdsamefp16.FCMGT_asisdsamefp16_only)
...
|--------------------------------------------|
| 01  1   1   111 0   1   sz  1   Rm  1110 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.FCMGT_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  10  0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FCMGT_asimdsamefp16_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   1   sz  1   Rm  1110 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FCMGT_asimdsame_only)
