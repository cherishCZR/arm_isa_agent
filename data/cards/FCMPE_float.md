...
**Title**: FCMPE -- A64 | **Class**: `float` | **XML ID**: `FCMPE_float`

**Summary**: Floating-point signaling compare (scalar)

**Description**:
This instruction compares the two SIMD&FP source
register values, or the first SIMD&FP source register value and zero. It writes the result
to the PSTATE.{N, Z, C, V} flags.
...
### Variant: `Floating-point (FCMPE_H_floatcmp)` (Half-precision)
- **Condition**: `ftype == 11 && opc == 10`
- **Assembly**: `FCMPE  <Hn>, <Hm>`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  00  1000 Rn  1x  000 |
```

#### Decode (A64.simd_dp.floatcmp.FCMPE_H_floatcmp)
...
#### Execute (A64.simd_dp.floatcmp.FCMPE_H_floatcmp)
...
### Variant: `Floating-point (FCMPE_HZ_floatcmp)` (Half-precision, zero)
- **Condition**: `ftype == 11 && Rm == (00000) && opc == 11`
- **Assembly**: `FCMPE  <Hn>, #0.0`
...
### Variant: `Floating-point (FCMPE_S_floatcmp)` (Single-precision)
- **Condition**: `ftype == 00 && opc == 10`
...
### Variant: `Floating-point (FCMPE_SZ_floatcmp)` (Single-precision, zero)
- **Condition**: `ftype == 00 && Rm == (00000) && opc == 11`
- **Assembly**: `FCMPE  <Sn>, #0.0`
...
### Variant: `Floating-point (FCMPE_D_floatcmp)` (Double-precision)
- **Condition**: `ftype == 01 && opc == 10`
...
### Variant: `Floating-point (FCMPE_DZ_floatcmp)` (Double-precision, zero)
- **Condition**: `ftype == 01 && Rm == (00000) && opc == 11`
- **Assembly**: `FCMPE  <Dn>, #0.0`
