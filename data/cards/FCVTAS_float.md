...
**Title**: FCVTAS (scalar) -- A64 | **Class**: `float` | **XML ID**: `FCVTAS_float`

**Summary**: Floating-point convert to signed integer, rounding to nearest with ties to away (scalar)
...
### Variant: `Floating-point (FCVTAS_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTAS  <Wd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   00  100 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTAS_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTAS_32H_float2int)
...
### Variant: `Floating-point (FCVTAS_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTAS  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTAS_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTAS_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTAS_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTAS_64D_float2int)` (Double-precision to 64-bit)
