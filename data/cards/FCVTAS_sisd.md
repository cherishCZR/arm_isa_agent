...
**Title**: FCVTAS (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTAS_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to signed integer, rounding to nearest with ties to away (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTAS_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTAS  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   11  010 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTAS_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTAS_sisd_32H)
...
### Variant: `Floating-point (FCVTAS_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTAS  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTAS_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTAS  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTAS_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTAS  <Sd>, <Dn>`
