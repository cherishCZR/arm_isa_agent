...
**Title**: FCVTAU (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FCVTAU_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point convert to unsigned integer, rounding to nearest with ties to away (vector)

**Description**:
This instruction
converts each element in a vector from a floating-point value to an unsigned integer value
...
- **Assembly**: `FCVTAU  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  11   9   4  |
|--------------------------------------|
| 01  1   1   111 0   0   1111 00  11100 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FCVTAU_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FCVTAU_asisdmiscfp16_R)
...
|--------------------------------------|
| 01  1   1   111 0   0   sz  10000 11100 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FCVTAU_asisdmisc_R)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   0   1111 00  11100 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FCVTAU_asimdmiscfp16_R)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   0   sz  10000 11100 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FCVTAU_asimdmisc_R)
