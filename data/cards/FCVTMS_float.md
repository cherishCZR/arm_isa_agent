...
**Title**: FCVTMS (scalar) -- A64 | **Class**: `float` | **XML ID**: `FCVTMS_float`

**Summary**: Floating-point convert to signed integer, rounding toward minus infinity (scalar)
...
### Variant: `Floating-point (FCVTMS_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTMS  <Wd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  000 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTMS_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTMS_32H_float2int)
...
### Variant: `Floating-point (FCVTMS_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTMS  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTMS_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTMS_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTMS_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTMS_64D_float2int)` (Double-precision to 64-bit)
