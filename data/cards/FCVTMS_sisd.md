...
**Title**: FCVTMS (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTMS_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to signed integer, rounding toward minus infinity (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTMS_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTMS  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  100 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTMS_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTMS_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, FALSE, FPCR, FPRounding_NEGINF, intsize);
...
### Variant: `Floating-point (FCVTMS_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTMS  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTMS_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTMS  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTMS_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTMS  <Sd>, <Dn>`
