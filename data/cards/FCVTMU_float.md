...
**Title**: FCVTMU (scalar) -- A64 | **Class**: `float` | **XML ID**: `FCVTMU_float`

**Summary**: Floating-point convert to unsigned integer, rounding toward minus infinity (scalar)
...
### Variant: `Floating-point (FCVTMU_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTMU  <Wd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  001 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTMU_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTMU_32H_float2int)
...
### Variant: `Floating-point (FCVTMU_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTMU  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTMU_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTMU_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTMU_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTMU_64D_float2int)` (Double-precision to 64-bit)
