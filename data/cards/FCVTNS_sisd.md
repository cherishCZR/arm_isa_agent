...
**Title**: FCVTNS (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTNS_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to signed integer, rounding to nearest with ties to even (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTNS_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTNS  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   01  010 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTNS_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTNS_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, FALSE, FPCR, FPRounding_TIEEVEN, intsize);
...
### Variant: `Floating-point (FCVTNS_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTNS  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTNS_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTNS  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTNS_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTNS  <Sd>, <Dn>`
