...
**Title**: FCVTNU (scalar) -- A64 | **Class**: `float` | **XML ID**: `FCVTNU_float`

**Summary**: Floating-point convert to unsigned integer, rounding to nearest with ties to even (scalar)
...
### Variant: `Floating-point (FCVTNU_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTNU  <Wd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   00  001 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTNU_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTNU_32H_float2int)
...
### Variant: `Floating-point (FCVTNU_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTNU  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTNU_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTNU_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTNU_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTNU_64D_float2int)` (Double-precision to 64-bit)
