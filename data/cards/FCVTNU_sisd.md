...
**Title**: FCVTNU (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTNU_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to unsigned integer, rounding to nearest with ties to even (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTNU_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTNU  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   01  011 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTNU_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTNU_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, TRUE, FPCR, FPRounding_TIEEVEN, intsize);
...
### Variant: `Floating-point (FCVTNU_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTNU  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTNU_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTNU  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTNU_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTNU  <Sd>, <Dn>`
