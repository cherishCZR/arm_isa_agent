...
**Title**: FCVTPS (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FCVTPS_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point convert to signed integer, rounding toward plus infinity (vector)
...
- **Assembly**: `FCVTPS  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  12 11   9   4  |
|-----------------------------------------|
| 01  0   1   111 0   1   1111 00  1101 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FCVTPS_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FCVTPS_asisdmiscfp16_R)
...
|-----------------------------------------|
| 01  0   1   111 0   1   sz  10000 1101 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FCVTPS_asisdmisc_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   1111 00  1101 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FCVTPS_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  10000 1101 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FCVTPS_asimdmisc_R)
