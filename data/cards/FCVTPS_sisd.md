...
**Title**: FCVTPS (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTPS_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to signed integer, rounding toward plus infinity (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTPS_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTPS  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  010 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTPS_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTPS_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, FALSE, FPCR, FPRounding_POSINF, intsize);
...
### Variant: `Floating-point (FCVTPS_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTPS  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTPS_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTPS  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTPS_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTPS  <Sd>, <Dn>`
