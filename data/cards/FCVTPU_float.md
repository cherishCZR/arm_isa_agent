...
**Title**: FCVTPU (scalar) -- A64 | **Class**: `float` | **XML ID**: `FCVTPU_float`

**Summary**: Floating-point convert to unsigned integer, rounding toward plus infinity (scalar)
...
### Variant: `Floating-point (FCVTPU_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTPU  <Wd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   01  001 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTPU_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTPU_32H_float2int)
...
### Variant: `Floating-point (FCVTPU_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTPU  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTPU_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTPU_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTPU_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTPU_64D_float2int)` (Double-precision to 64-bit)
