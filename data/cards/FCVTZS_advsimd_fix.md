...
**Title**: FCVTZS (vector, fixed-point) -- A64 | **Class**: `advsimd` | **XML ID**: `FCVTZS_advsimd_fix`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point convert to signed fixed-point, rounding toward zero (vector)
...
|-----------------------------------|
| 01  0   1   111 10  ?   immb 11111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.FCVTZS_asisdshf_C)
...
#### Execute (A64.simd_dp.asisdshf.FCVTZS_asisdshf_C)
...
|--------------------------------------|
| 0   Q   0   0   111 10  ?   immb 11111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.FCVTZS_asimdshf_C)
