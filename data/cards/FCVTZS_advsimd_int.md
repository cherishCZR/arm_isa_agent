...
**Title**: FCVTZS (vector, integer) -- A64 | **Class**: `advsimd` | **XML ID**: `FCVTZS_advsimd_int`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point convert to signed integer, rounding toward zero (vector)
...
- **Assembly**: `FCVTZS  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  12 11   9   4  |
|-----------------------------------------|
| 01  0   1   111 0   1   1111 00  1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FCVTZS_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FCVTZS_asisdmiscfp16_R)
...
|-----------------------------------------|
| 01  0   1   111 0   1   sz  10000 1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FCVTZS_asisdmisc_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   1111 00  1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FCVTZS_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  10000 1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FCVTZS_asimdmisc_R)
