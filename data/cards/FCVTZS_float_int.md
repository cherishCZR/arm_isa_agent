...
**Title**: FCVTZS (scalar, integer) -- A64 | **Class**: `float` | **XML ID**: `FCVTZS_float_int`

**Summary**: Floating-point convert to signed integer, rounding toward zero (scalar)
...
### Variant: `Floating-point (FCVTZS_32H_float2int)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTZS  <Wd>, <Hn>`
...
#### Decode (A64.simd_dp.float2int.FCVTZS_32H_float2int)
...
#### Execute (A64.simd_dp.float2int.FCVTZS_32H_float2int)
...
### Variant: `Floating-point (FCVTZS_64H_float2int)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTZS  <Xd>, <Hn>`
...
### Variant: `Floating-point (FCVTZS_32S_float2int)` (Single-precision to 32-bit)
...
### Variant: `Floating-point (FCVTZS_64S_float2int)` (Single-precision to 64-bit)
...
### Variant: `Floating-point (FCVTZS_32D_float2int)` (Double-precision to 32-bit)
...
### Variant: `Floating-point (FCVTZS_64D_float2int)` (Double-precision to 64-bit)
