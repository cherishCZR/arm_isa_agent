...
**Title**: FCVTZS (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTZS_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to signed integer, rounding toward zero (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTZS_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTZS  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  110 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTZS_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTZS_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, FALSE, FPCR, FPRounding_ZERO, intsize);
...
### Variant: `Floating-point (FCVTZS_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTZS  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTZS_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTZS  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTZS_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTZS  <Sd>, <Dn>`
