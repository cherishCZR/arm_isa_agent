...
**Title**: FCVTZU (vector, integer) -- A64 | **Class**: `advsimd` | **XML ID**: `FCVTZU_advsimd_int`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point convert to unsigned integer, rounding toward zero (vector)
...
- **Assembly**: `FCVTZU  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  12 11   9   4  |
|-----------------------------------------|
| 01  1   1   111 0   1   1111 00  1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FCVTZU_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FCVTZU_asisdmiscfp16_R)
...
|-----------------------------------------|
| 01  1   1   111 0   1   sz  10000 1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FCVTZU_asisdmisc_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   1111 00  1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FCVTZU_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   sz  10000 1101 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FCVTZU_asimdmisc_R)
