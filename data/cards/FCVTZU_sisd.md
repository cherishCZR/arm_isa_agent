...
**Title**: FCVTZU (scalar SIMD&FP) -- A64 | **Class**: `float` | **XML ID**: `FCVTZU_sisd`

**Architecture**: `FEAT_FPRCVT` (ARMv9.6)

**Summary**: Floating-point convert to unsigned integer, rounding toward zero (scalar SIMD&FP)
...
### Variant: `Floating-point (FCVTZU_sisd_32H)` (Half-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `FCVTZU  <Sd>, <Hn>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 1   10  111 000000 Rn  Rd  |
```

#### Decode (A64.simd_dp.float2int.FCVTZU_sisd_32H)
...
#### Execute (A64.simd_dp.float2int.FCVTZU_sisd_32H)
...
fltval = V[n, fltsize];
intval = FPToFixed(fltval, 0, TRUE, FPCR, FPRounding_ZERO, intsize);
...
### Variant: `Floating-point (FCVTZU_sisd_64H)` (Half-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `FCVTZU  <Dd>, <Hn>`
...
### Variant: `Floating-point (FCVTZU_sisd_64S)` (Single-precision to 64-bit)
- **Condition**: `sf == 1 && ftype == 00`
- **Assembly**: `FCVTZU  <Dd>, <Sn>`
...
### Variant: `Floating-point (FCVTZU_sisd_32D)` (Double-precision to 32-bit)
- **Condition**: `sf == 0 && ftype == 01`
- **Assembly**: `FCVTZU  <Sd>, <Dn>`
