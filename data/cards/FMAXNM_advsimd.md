...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   10  Rm  00  000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMAXNM_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMAXNM_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   sz  1   Rm  11000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMAXNM_asimdsame_only)
