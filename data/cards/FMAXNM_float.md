...
**Title**: FMAXNM (scalar) -- A64 | **Class**: `float` | **XML ID**: `FMAXNM_float`

**Summary**: Floating-point maximum number (scalar)
...
### Variant: `Floating-point (FMAXNM_H_floatdp2)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FMAXNM  <Hd>, <Hn>, <Hm>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  01  10  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp2.FMAXNM_H_floatdp2)
...
#### Execute (A64.simd_dp.floatdp2.FMAXNM_H_floatdp2)
...
### Variant: `Floating-point (FMAXNM_S_floatdp2)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FMAXNM_D_floatdp2)` (Double-precision)
- **Condition**: `ftype == 01`
