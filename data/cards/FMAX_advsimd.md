...
**Title**: FMAX (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FMAX_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point maximum (vector)

**Description**:
This instruction compares corresponding vector elements
in the two source SIMD&FP registers,
places the larger of each of the two floating-point values
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   10  Rm  00  110 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMAX_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMAX_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   sz  1   Rm  11110 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMAX_asimdsame_only)
