...
**Title**: FMAX (scalar) -- A64 | **Class**: `float` | **XML ID**: `FMAX_float`

**Summary**: Floating-point maximum (scalar)
...
### Variant: `Floating-point (FMAX_H_floatdp2)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FMAX  <Hd>, <Hn>, <Hm>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  01  00  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp2.FMAX_H_floatdp2)
...
#### Execute (A64.simd_dp.floatdp2.FMAX_H_floatdp2)
...
### Variant: `Floating-point (FMAX_S_floatdp2)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FMAX_D_floatdp2)` (Double-precision)
- **Condition**: `ftype == 01`
