...
**Title**: FMINNMP (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FMINNMP_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point minimum number pairwise (vector)
...
writes the smallest of each pair of floating-point values
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMINNMP_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMINNMP_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   sz  1   Rm  11000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMINNMP_asimdsame_only)
...
- advsimd-type: `simd`
- isa: `A64`
- source: `fminnmp_advsimd_vec.xml`
</details>