...
**Title**: FMINNM (scalar) -- A64 | **Class**: `float` | **XML ID**: `FMINNM_float`

**Summary**: Floating-point minimum number (scalar)
...
### Variant: `Floating-point (FMINNM_H_floatdp2)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FMINNM  <Hd>, <Hn>, <Hm>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------------|
| 0   0   0   11110 ftype 1   Rm  01  11  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp2.FMINNM_H_floatdp2)
...
#### Execute (A64.simd_dp.floatdp2.FMINNM_H_floatdp2)
...
### Variant: `Floating-point (FMINNM_S_floatdp2)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FMINNM_D_floatdp2)` (Double-precision)
- **Condition**: `ftype == 01`
