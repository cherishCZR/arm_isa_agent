...
**Title**: FMINP (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FMINP_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point minimum pairwise (vector)
...
writes the smaller of each pair of values
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  110 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMINP_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMINP_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   sz  1   Rm  11110 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMINP_asimdsame_only)
