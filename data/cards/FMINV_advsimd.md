...
**Title**: FMINV -- A64 | **Class**: `advsimd` | **XML ID**: `FMINV_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point minimum across vector
...
|-----------------------------------------|
| 0   Q   0   0   111 0   1   0   11000 01111 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdall.FMINV_asimdall_only_H)
...
#### Execute (A64.simd_dp.asimdall.FMINV_asimdall_only_H)
...
- **Assembly**: `FMINV  S<d>, <Vn>.4S`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22 21  16  11   9   4  |
|-----------------------------------------|
| 0   1   1   0   111 0   1   0   11000 01111 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdall.FMINV_asimdall_only_SD)
