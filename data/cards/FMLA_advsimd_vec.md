...
**Title**: FMLA (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FMLA_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point fused multiply-add to accumulator (vector)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   10  Rm  00  001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMLA_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMLA_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   sz  1   Rm  11001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMLA_asimdsame_only)
