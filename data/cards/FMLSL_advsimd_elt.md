...
**Title**: FMLSL, FMLSL2 (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `FMLSL_advsimd_elt`

**Architecture**: `FEAT_FHM` (ARMv8.4)

**Summary**: Floating-point fused multiply-subtract long from accumulator (by element)
...
### Variant: `FMLSL`
- **Assembly**: `FMLSL  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22 21 20 19  15 14 13  11 10  9   4  |
|--------------------------------------------------------|
| 0   Q   0   0   111 1   1   0   L   M   Rm  0   1   00  H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.FMLSL_asimdelem_LH)
...
#### Execute (A64.simd_dp.asimdelem.FMLSL_asimdelem_LH)
...
### Variant: `FMLSL2`
- **Assembly**: `FMLSL2  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22 21 20 19  15 14 13  11 10  9   4  |
|--------------------------------------------------------|
| 0   Q   1   0   111 1   1   0   L   M   Rm  1   1   00  H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.FMLSL2_asimdelem_LH)
