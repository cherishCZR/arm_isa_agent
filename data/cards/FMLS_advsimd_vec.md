...
**Title**: FMLS (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FMLS_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point fused multiply-subtract from accumulator (vector)

**Description**:
This instruction multiplies corresponding floating-point values
in the vectors in the two source
SIMD&FP registers, negates the product, adds the result to the
corresponding vector element of the
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   10  Rm  00  001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMLS_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMLS_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  1   Rm  11001 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMLS_asimdsame_only)
