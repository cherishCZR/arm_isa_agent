...
**Title**: FMULX (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `FMULX_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point multiply extended (by element)

**Description**:
This instruction multiplies the floating-point values
...
- **Assembly**: `FMULX  <Hd>, <Hn>, <Vm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20 19  15  11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 1   00  L   M   Rm  1001 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdelem.FMULX_asisdelem_RH_H)
...
#### Execute (A64.simd_dp.asisdelem.FMULX_asisdelem_RH_H)
...
```text
| 31  29 28 27  24 23 22 21 20 19  15  11 10  9   4  |
|-----------------------------------------------|
| 01  1   1   111 1   1   sz  L   M   Rm  1001 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdelem.FMULX_asisdelem_R_SD)
...
- **Assembly**: `FMULX  <Vd>.<T>, <Vn>.<T>, <Vm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20 19  15  11 10  9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 1   00  L   M   Rm  1001 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.FMULX_asimdelem_RH_H)
...
|--------------------------------------------------|
| 0   Q   1   0   111 1   1   sz  L   M   Rm  1001 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.FMULX_asimdelem_R_SD)
