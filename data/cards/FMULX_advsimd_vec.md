...
**Title**: FMULX -- A64 | **Class**: `advsimd` | **XML ID**: `FMULX_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point multiply extended
...
- **Assembly**: `FMULX  <Hd>, <Hn>, <Hm>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  20  15  13  10  9   4  |
|-----------------------------------------|
| 01  0   1   111 0   0   10  Rm  00  011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsamefp16.FMULX_asisdsamefp16_only)
...
#### Execute (A64.simd_dp.asisdsamefp16.FMULX_asisdsamefp16_only)
...
|-----------------------------------------|
| 01  0   1   111 0   0   sz  1   Rm  11011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.FMULX_asisdsame_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   10  Rm  00  011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMULX_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   0   sz  1   Rm  11011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMULX_asimdsame_only)
