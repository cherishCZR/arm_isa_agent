...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   10  Rm  00  011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FMUL_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FMUL_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   sz  1   Rm  11011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FMUL_asimdsame_only)
