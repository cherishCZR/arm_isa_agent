...
**Title**: FRINT32X (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINT32X_advsimd`

**Architecture**: `FEAT_FRINTTS` (ARMv8.5)

**Summary**: Floating-point round to 32-bit integer, using current rounding mode (vector)

**Description**:
This instruction rounds a vector of floating-point values in the SIMD&FP source register to integral floating-point
values that fit into a 32-bit integer size using the rounding mode that is determined by the FPCR,
...
- **Assembly**: `FRINT32X  <Vd>.<T>, <Vn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22 21  16  12 11   9   4  |
|--------------------------------------------|
| 0   Q   1   0   111 0   0   sz  10000 1111 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINT32X_asimdmisc_R)
...
#### Execute (A64.simd_dp.asimdmisc.FRINT32X_asimdmisc_R)
