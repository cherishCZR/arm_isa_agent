...
**Title**: FRINTA (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINTA_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point round to integral, to nearest with ties to away (vector)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   1111 00  1100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRINTA_asimdmiscfp16_R)
...
#### Execute (A64.simd_dp.asimdmiscfp16.FRINTA_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   sz  10000 1100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINTA_asimdmisc_R)
