...
**Title**: FRINTA (scalar) -- A64 | **Class**: `float` | **XML ID**: `FRINTA_float`

**Summary**: Floating-point round to integral, to nearest with ties to away (scalar)
...
### Variant: `Floating-point (FRINTA_H_floatdp1)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FRINTA  <Hd>, <Hn>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------|
| 0   0   0   11110 ftype 1001 100 10000 Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp1.FRINTA_H_floatdp1)
...
#### Execute (A64.simd_dp.floatdp1.FRINTA_H_floatdp1)
...
### Variant: `Floating-point (FRINTA_S_floatdp1)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FRINTA_D_floatdp1)` (Double-precision)
- **Condition**: `ftype == 01`
