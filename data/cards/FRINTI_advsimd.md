...
**Title**: FRINTI (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINTI_advsimd`
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   1111 00  1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRINTI_asimdmiscfp16_R)
...
#### Execute (A64.simd_dp.asimdmiscfp16.FRINTI_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   1   sz  10000 1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINTI_asimdmisc_R)
