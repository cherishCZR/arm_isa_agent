...
**Title**: FRINTI (scalar) -- A64 | **Class**: `float` | **XML ID**: `FRINTI_float`

**Summary**: Floating-point round to integral, using current rounding mode (scalar)
...
### Variant: `Floating-point (FRINTI_H_floatdp1)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FRINTI  <Hd>, <Hn>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------|
| 0   0   0   11110 ftype 1001 111 10000 Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp1.FRINTI_H_floatdp1)
...
#### Execute (A64.simd_dp.floatdp1.FRINTI_H_floatdp1)
...
### Variant: `Floating-point (FRINTI_S_floatdp1)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FRINTI_D_floatdp1)` (Double-precision)
- **Condition**: `ftype == 01`
