...
**Title**: FRINTM (scalar) -- A64 | **Class**: `float` | **XML ID**: `FRINTM_float`

**Summary**: Floating-point round to integral, toward minus infinity (scalar)
...
### Variant: `Floating-point (FRINTM_H_floatdp1)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FRINTM  <Hd>, <Hn>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------|
| 0   0   0   11110 ftype 1001 010 10000 Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp1.FRINTM_H_floatdp1)
...
#### Execute (A64.simd_dp.floatdp1.FRINTM_H_floatdp1)
...
### Variant: `Floating-point (FRINTM_S_floatdp1)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FRINTM_D_floatdp1)` (Double-precision)
- **Condition**: `ftype == 01`
