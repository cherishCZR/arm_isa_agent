...
**Title**: FRINTN (scalar) -- A64 | **Class**: `float` | **XML ID**: `FRINTN_float`

**Summary**: Floating-point round to integral, to nearest with ties to even (scalar)
...
### Variant: `Floating-point (FRINTN_H_floatdp1)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FRINTN  <Hd>, <Hn>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------|
| 0   0   0   11110 ftype 1001 000 10000 Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp1.FRINTN_H_floatdp1)
...
#### Execute (A64.simd_dp.floatdp1.FRINTN_H_floatdp1)
...
### Variant: `Floating-point (FRINTN_S_floatdp1)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FRINTN_D_floatdp1)` (Double-precision)
- **Condition**: `ftype == 01`
