...
**Title**: FRINTP (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINTP_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point round to integral, toward plus infinity (vector)
...
Round towards Plus Infinity rounding mode,
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   1111 00  1100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRINTP_asimdmiscfp16_R)
...
#### Execute (A64.simd_dp.asimdmiscfp16.FRINTP_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  10000 1100 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINTP_asimdmisc_R)
