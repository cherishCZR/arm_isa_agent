...
**Title**: FRINTP (scalar) -- A64 | **Class**: `float` | **XML ID**: `FRINTP_float`

**Summary**: Floating-point round to integral, toward plus infinity (scalar)
...
Round towards Plus Infinity rounding mode, and writes the
...
### Variant: `Floating-point (FRINTP_H_floatdp1)` (Half-precision)
- **Condition**: `ftype == 11`
- **Assembly**: `FRINTP  <Hd>, <Hn>`
- **Fixed bits**: `ftype`=`11`
- **Bit Pattern**: `??????????????????????11????????`
...
|--------------------------------|
| 0   0   0   11110 ftype 1001 001 10000 Rn  Rd  |
```

#### Decode (A64.simd_dp.floatdp1.FRINTP_H_floatdp1)
...
#### Execute (A64.simd_dp.floatdp1.FRINTP_H_floatdp1)
...
### Variant: `Floating-point (FRINTP_S_floatdp1)` (Single-precision)
- **Condition**: `ftype == 00`
...
### Variant: `Floating-point (FRINTP_D_floatdp1)` (Double-precision)
- **Condition**: `ftype == 01`
