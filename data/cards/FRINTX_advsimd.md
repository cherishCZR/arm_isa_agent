...
**Title**: FRINTX (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINTX_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point round to integral exact, using current rounding mode (vector)
...
When a result value is not numerically equal to
the corresponding input value, an Inexact exception is raised.
A zero input
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   1111 00  1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRINTX_asimdmiscfp16_R)
...
#### Execute (A64.simd_dp.asimdmiscfp16.FRINTX_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 0   0   sz  10000 1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINTX_asimdmisc_R)
