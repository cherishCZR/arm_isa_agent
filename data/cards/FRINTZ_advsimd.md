...
**Title**: FRINTZ (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `FRINTZ_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point round to integral, toward zero (vector)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   1111 00  1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRINTZ_asimdmiscfp16_R)
...
#### Execute (A64.simd_dp.asimdmiscfp16.FRINTZ_asimdmiscfp16_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  10000 1100 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRINTZ_asimdmisc_R)
