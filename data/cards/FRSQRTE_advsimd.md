...
**Title**: FRSQRTE -- A64 | **Class**: `advsimd` | **XML ID**: `FRSQRTE_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point reciprocal square root estimate
...
- **Assembly**: `FRSQRTE  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  11   9   4  |
|--------------------------------------|
| 01  1   1   111 0   1   1111 00  11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.FRSQRTE_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.FRSQRTE_asisdmiscfp16_R)
...
|--------------------------------------|
| 01  1   1   111 0   1   sz  10000 11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.FRSQRTE_asisdmisc_R)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   1   1111 00  11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.FRSQRTE_asimdmiscfp16_R)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   1   sz  10000 11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.FRSQRTE_asimdmisc_R)
