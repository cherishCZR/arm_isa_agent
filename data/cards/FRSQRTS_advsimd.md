...
**Title**: FRSQRTS -- A64 | **Class**: `advsimd` | **XML ID**: `FRSQRTS_advsimd`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Floating-point reciprocal square root step

**Description**:
This instruction multiplies corresponding floating-point values in the vectors of the two source SIMD&FP registers,
subtracts each of the products from 3.0, divides these results by 2.0, places the results into a
...
- **Assembly**: `FRSQRTS  <Hd>, <Hn>, <Hm>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  20  15  13  10  9   4  |
|-----------------------------------------|
| 01  0   1   111 0   1   10  Rm  00  111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsamefp16.FRSQRTS_asisdsamefp16_only)
...
#### Execute (A64.simd_dp.asisdsamefp16.FRSQRTS_asisdsamefp16_only)
...
|-----------------------------------------|
| 01  0   1   111 0   1   sz  1   Rm  11111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.FRSQRTS_asisdsame_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   10  Rm  00  111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FRSQRTS_asimdsamefp16_only)
...
|--------------------------------------------|
| 0   Q   0   0   111 0   1   sz  1   Rm  11111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FRSQRTS_asimdsame_only)
