...
**Title**: FSCALE -- A64 | **Class**: `advsimd` | **XML ID**: `FSCALE_advsimd`

**Architecture**: `FEAT_FP8` (ARMv9.5)

**Summary**: Floating-point adjust exponent by vector
...
- **Assembly**: `FSCALE  <Vd>.<T>, <Vn>.<T>, <Vm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22  20  15  13  10  9   4  |
|--------------------------------------------|
| 0   Q   1   0   111 0   1   10  Rm  00  111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsamefp16.FSCALE_asimdsamefp16_only)
...
#### Execute (A64.simd_dp.asimdsamefp16.FSCALE_asimdsamefp16_only)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   1x  1   Rm  11111 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.FSCALE_asimdsame_only)
