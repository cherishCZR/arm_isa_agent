...
**Title**: LD1R -- A64 | **Class**: `advsimd` | **XML ID**: `LD1R_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load one single-element structure and replicate to all lanes (of one register)
...
|--------------------------------------------------|
| 0   Q   00  1   1   0   10  1   0   0000 0   110 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.LD1R_asisdlso_R1)
...
#### Postdecode (A64.ldst.asisdlso.LD1R_asisdlso_R1)
...
#### Execute (A64.ldst.asisdlso.LD1R_asisdlso_R1)
...
### Variant: `Post-index (LD1R_asisdlsop_R1_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|-----------------------------------|
| 0   Q   0011011 1   0   Rm  110 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.LD1R_asisdlsop_R1_i)
...
### Variant: `Post-index (LD1R_asisdlsop_RX1_r)` (Register offset)
- **Condition**: `Rm != 11111`
