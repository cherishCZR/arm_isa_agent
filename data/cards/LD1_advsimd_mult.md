...
**Title**: LD1 (multiple structures) -- A64 | **Class**: `advsimd` | **XML ID**: `LD1_advsimd_mult`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load multiple single-element structures to one, two, three, or four registers
...
### Variant: `No offset (LD1_asisdlse_R1_1v)` (One register)
...
|-----------------------------|
| 0   Q   0011000 1   000000 xx1x size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlse.LD1_asisdlse_R1_1v)
...
#### Postdecode (A64.ldst.asisdlse.LD1_asisdlse_R1_1v)
...
#### Execute (A64.ldst.asisdlse.LD1_asisdlse_R1_1v)
...
### Variant: `No offset (LD1_asisdlse_R2_2v)` (Two registers)
...
### Variant: `No offset (LD1_asisdlse_R3_3v)` (Three registers)
...
### Variant: `No offset (LD1_asisdlse_R4_4v)` (Four registers)
...
### Variant: `Post-index (LD1_asisdlsep_I1_i1)` (One register, immediate offset)
...
|--------------------------------|
| 0   Q   0011001 1   0   Rm  xx1x size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsep.LD1_asisdlsep_I1_i1)
...
### Variant: `Post-index (LD1_asisdlsep_R1_r1)` (One register, register offset)
- **Condition**: `Rm != 11111 && opcode == 0111`
...
### Variant: `Post-index (LD1_asisdlsep_I2_i2)` (Two registers, immediate offset)
...
### Variant: `Post-index (LD1_asisdlsep_R2_r2)` (Two registers, register offset)
- **Condition**: `Rm != 11111 && opcode == 1010`
...
### Variant: `Post-index (LD1_asisdlsep_I3_i3)` (Three registers, immediate offset)
...
### Variant: `Post-index (LD1_asisdlsep_R3_r3)` (Three registers, register offset)
- **Condition**: `Rm != 11111 && opcode == 0110`
...
### Variant: `Post-index (LD1_asisdlsep_I4_i4)` (Four registers, immediate offset)
...
### Variant: `Post-index (LD1_asisdlsep_R4_r4)` (Four registers, register offset)
- **Condition**: `Rm != 11111 && opcode == 0010`
