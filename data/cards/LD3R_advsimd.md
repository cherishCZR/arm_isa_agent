...
**Title**: LD3R -- A64 | **Class**: `advsimd` | **XML ID**: `LD3R_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load single 3-element structure and replicate to all lanes of three registers
...
|--------------------------------------------------|
| 0   Q   00  1   1   0   10  1   0   0000 0   111 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.LD3R_asisdlso_R3)
...
#### Postdecode (A64.ldst.asisdlso.LD3R_asisdlso_R3)
...
#### Execute (A64.ldst.asisdlso.LD3R_asisdlso_R3)
...
### Variant: `Post-index (LD3R_asisdlsop_R3_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|-----------------------------------|
| 0   Q   0011011 1   0   Rm  111 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.LD3R_asisdlsop_R3_i)
...
### Variant: `Post-index (LD3R_asisdlsop_RX3_r)` (Register offset)
- **Condition**: `Rm != 11111`
