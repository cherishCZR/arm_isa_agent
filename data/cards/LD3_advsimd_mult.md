...
**Title**: LD3 (multiple structures) -- A64 | **Class**: `advsimd` | **XML ID**: `LD3_advsimd_mult`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load multiple 3-element structures to three registers

**Description**:
This instruction loads multiple 3-element structures
from memory and writes the result to the three SIMD&FP registers,
...
|-----------------------------------------|
| 0   Q   00  1   1   0   00  1   000000 0100 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlse.LD3_asisdlse_R3)
...
#### Postdecode (A64.ldst.asisdlse.LD3_asisdlse_R3)
...
#### Execute (A64.ldst.asisdlse.LD3_asisdlse_R3)
...
### Variant: `Post-index (LD3_asisdlsep_I3_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|--------------------------------|
| 0   Q   0011001 1   0   Rm  0100 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsep.LD3_asisdlsep_I3_i)
...
### Variant: `Post-index (LD3_asisdlsep_R3_r)` (Register offset)
- **Condition**: `Rm != 11111`
