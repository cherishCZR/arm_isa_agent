...
**Title**: LD3 (single structure) -- A64 | **Class**: `advsimd` | **XML ID**: `LD3_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load single 3-element structure to one lane of three registers

**Description**:
This instruction loads a 3-element structure
from memory and writes the result to the corresponding elements of the three
SIMD&FP registers
...
### Variant: `No offset (LD3_asisdlso_B3_3b)` (8-bit)
...
|--------------------------------------|
| 0   Q   0011010 1   0   0000 0   xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.LD3_asisdlso_B3_3b)
...
#### Postdecode (A64.ldst.asisdlso.LD3_asisdlso_B3_3b)
...
#### Execute (A64.ldst.asisdlso.LD3_asisdlso_B3_3b)
...
### Variant: `No offset (LD3_asisdlso_H3_3h)` (16-bit)
...
### Variant: `No offset (LD3_asisdlso_S3_3s)` (32-bit)
...
### Variant: `No offset (LD3_asisdlso_D3_3d)` (64-bit)
...
### Variant: `Post-index (LD3_asisdlsop_B3_i3b)` (8-bit, immediate offset)
...
|-----------------------------------|
| 0   Q   0011011 1   0   Rm  xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.LD3_asisdlsop_B3_i3b)
...
### Variant: `Post-index (LD3_asisdlsop_BX3_r3b)` (8-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 001`
...
### Variant: `Post-index (LD3_asisdlsop_H3_i3h)` (16-bit, immediate offset)
...
### Variant: `Post-index (LD3_asisdlsop_HX3_r3h)` (16-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 011 && size == x0`
...
### Variant: `Post-index (LD3_asisdlsop_S3_i3s)` (32-bit, immediate offset)
...
### Variant: `Post-index (LD3_asisdlsop_SX3_r3s)` (32-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && size == 00`
...
### Variant: `Post-index (LD3_asisdlsop_D3_i3d)` (64-bit, immediate offset)
...
### Variant: `Post-index (LD3_asisdlsop_DX3_r3d)` (64-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && S == 0 && size == 01`
