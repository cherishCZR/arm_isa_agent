...
**Title**: LD4R -- A64 | **Class**: `advsimd` | **XML ID**: `LD4R_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load single 4-element structure and replicate to all lanes of four registers
...
|--------------------------------------------------|
| 0   Q   00  1   1   0   10  1   1   0000 0   111 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.LD4R_asisdlso_R4)
...
#### Postdecode (A64.ldst.asisdlso.LD4R_asisdlso_R4)
...
#### Execute (A64.ldst.asisdlso.LD4R_asisdlso_R4)
...
### Variant: `Post-index (LD4R_asisdlsop_R4_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|-----------------------------------|
| 0   Q   0011011 1   1   Rm  111 0   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.LD4R_asisdlsop_R4_i)
...
### Variant: `Post-index (LD4R_asisdlsop_RX4_r)` (Register offset)
- **Condition**: `Rm != 11111`
