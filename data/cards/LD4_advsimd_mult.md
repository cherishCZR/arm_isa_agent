...
**Title**: LD4 (multiple structures) -- A64 | **Class**: `advsimd` | **XML ID**: `LD4_advsimd_mult`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load multiple 4-element structures to four registers

**Description**:
This instruction loads multiple 4-element structures
...
|-----------------------------------------|
| 0   Q   00  1   1   0   00  1   000000 0000 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlse.LD4_asisdlse_R4)
...
#### Postdecode (A64.ldst.asisdlse.LD4_asisdlse_R4)
...
#### Execute (A64.ldst.asisdlse.LD4_asisdlse_R4)
...
### Variant: `Post-index (LD4_asisdlsep_I4_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|--------------------------------|
| 0   Q   0011001 1   0   Rm  0000 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsep.LD4_asisdlsep_I4_i)
...
### Variant: `Post-index (LD4_asisdlsep_R4_r)` (Register offset)
- **Condition**: `Rm != 11111`
