...
**Title**: LD4 (single structure) -- A64 | **Class**: `advsimd` | **XML ID**: `LD4_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Load single 4-element structure to one lane of four registers

**Description**:
This instruction loads a 4-element structure
from memory and writes the result to the corresponding elements of the four
SIMD&FP registers
...
### Variant: `No offset (LD4_asisdlso_B4_4b)` (8-bit)
...
|--------------------------------------|
| 0   Q   0011010 1   1   0000 0   xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.LD4_asisdlso_B4_4b)
...
#### Postdecode (A64.ldst.asisdlso.LD4_asisdlso_B4_4b)
...
#### Execute (A64.ldst.asisdlso.LD4_asisdlso_B4_4b)
...
### Variant: `No offset (LD4_asisdlso_H4_4h)` (16-bit)
...
### Variant: `No offset (LD4_asisdlso_S4_4s)` (32-bit)
...
### Variant: `No offset (LD4_asisdlso_D4_4d)` (64-bit)
...
### Variant: `Post-index (LD4_asisdlsop_B4_i4b)` (8-bit, immediate offset)
...
|-----------------------------------|
| 0   Q   0011011 1   1   Rm  xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.LD4_asisdlsop_B4_i4b)
...
### Variant: `Post-index (LD4_asisdlsop_BX4_r4b)` (8-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 001`
...
### Variant: `Post-index (LD4_asisdlsop_H4_i4h)` (16-bit, immediate offset)
...
### Variant: `Post-index (LD4_asisdlsop_HX4_r4h)` (16-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 011 && size == x0`
...
### Variant: `Post-index (LD4_asisdlsop_S4_i4s)` (32-bit, immediate offset)
...
### Variant: `Post-index (LD4_asisdlsop_SX4_r4s)` (32-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && size == 00`
...
### Variant: `Post-index (LD4_asisdlsop_D4_i4d)` (64-bit, immediate offset)
...
### Variant: `Post-index (LD4_asisdlsop_DX4_r4d)` (64-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && S == 0 && size == 01`
