...
**Title**: LDADD, LDADDA, LDADDAL, LDADDL -- A64 | **Class**: `general` | **XML ID**: `LDADD`

**Architecture**: `FEAT_LSE` (ARMv8.1)

**Summary**: Atomic add on word or doubleword in memory
...
### Variant: `Integer (LDADD_32_memop)` (32-bit no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDADD  <Ws>, <Wt>, [<Xn|SP>]`
...
|-----------------------------------------|
| 1x  111 0   00  A   R   1   Rs  0   000 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDADD_32_memop)
...
#### Execute (A64.ldst.memop.LDADD_32_memop)
...
### Variant: `Integer (LDADDA_32_memop)` (32-bit acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDADDA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADDAL_32_memop)` (32-bit acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDADDAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADDL_32_memop)` (32-bit release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDADDL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADD_64_memop)` (64-bit no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDADD  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADDA_64_memop)` (64-bit acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDADDA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADDAL_64_memop)` (64-bit acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDADDAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDADDL_64_memop)` (64-bit release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDADDL  <Xs>, <Xt>, [<Xn|SP>]`
