...
**Title**: LDAPRB -- A64 | **Class**: `general` | **XML ID**: `LDAPRB`

**Architecture**: `FEAT_LRCPC` (ARMv8.3)

**Summary**: Load-acquire RCpc register byte
...
### Variant: `Integer`
- **Assembly**: `LDAPRB  <Wt>, [<Xn|SP> {, #0}]`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24 23 22 21 20  15 14  11   9   4  |
|-----------------------------------------------|
| 00  11  1   0   0   0   1   0   1   (1)(1)(1)(1)(1) 1   100 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDAPRB_32L_memop)
...
#### Execute (A64.ldst.memop.LDAPRB_32L_memop)
