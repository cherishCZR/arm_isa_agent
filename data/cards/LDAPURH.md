...
**Title**: LDAPURH -- A64 | **Class**: `general` | **XML ID**: `LDAPURH`

**Architecture**: `FEAT_LRCPC2` (ARMv8.4)

**Summary**: Load-acquire RCpc register halfword (unscaled)

**Description**:
This instruction calculates an address
from a base register and an immediate offset, loads a halfword from
...
- **Assembly**: `LDAPURH  <Wt>, [<Xn|SP>{, #<simm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24 23  21 20  11   9   4  |
|--------------------------------------|
| 01  01  1   0   0   1   01  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldapstl_unscaled.LDAPURH_32_ldapstl_unscaled)
...
#### Postdecode (A64.ldst.ldapstl_unscaled.LDAPURH_32_ldapstl_unscaled)
...
#### Execute (A64.ldst.ldapstl_unscaled.LDAPURH_32_ldapstl_unscaled)
