...
**Title**: LDEOR, LDEORA, LDEORAL, LDEORL -- A64 | **Class**: `general` | **XML ID**: `LDEOR`

**Architecture**: `FEAT_LSE` (ARMv8.1)

**Summary**: Atomic exclusive-OR on word or doubleword in memory
...
### Variant: `Integer (LDEOR_32_memop)` (32-bit no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDEOR  <Ws>, <Wt>, [<Xn|SP>]`
...
|-----------------------------------------|
| 1x  111 0   00  A   R   1   Rs  0   010 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDEOR_32_memop)
...
#### Execute (A64.ldst.memop.LDEOR_32_memop)

```
bits(64) address;

constant boolean privileged = PSTATE.EL != EL0;
constant AccessDescriptor accdesc = CreateAccDescAtomicOp(MemAtomicOp_EOR, acquire, release,
...
### Variant: `Integer (LDEORA_32_memop)` (32-bit acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDEORA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEORAL_32_memop)` (32-bit acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDEORAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEORL_32_memop)` (32-bit release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDEORL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEOR_64_memop)` (64-bit no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDEOR  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEORA_64_memop)` (64-bit acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDEORA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEORAL_64_memop)` (64-bit acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDEORAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDEORL_64_memop)` (64-bit release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDEORL  <Xs>, <Xt>, [<Xn|SP>]`
