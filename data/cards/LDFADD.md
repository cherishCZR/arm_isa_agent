...
**Title**: LDFADD, LDFADDA, LDFADDAL, LDFADDL -- A64 | **Class**: `advsimd` | **XML ID**: `LDFADD`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic add in memory
...
### Variant: `Floating-point (LDFADD_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && A == 0 && R == 0`
- **Assembly**: `LDFADD  <Hs>, <Ht>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  A   R   1   Rs  0   000 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDFADD_16)
...
#### Execute (A64.ldst.memop.LDFADD_16)
...
bits(datasize) value;
bits(datasize) data;
constant AccessDescriptor accdesc = CreateAccDescFPAtomicOp(MemAtomicOp_FPADD, acquire,
                                                            release, tagchecked);
...
### Variant: `Floating-point (LDFADDA_16)` (Half-precision acquire)
- **Condition**: `size == 01 && A == 1 && R == 0`
- **Assembly**: `LDFADDA  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDAL_16)` (Half-precision acquire-release)
- **Condition**: `size == 01 && A == 1 && R == 1`
- **Assembly**: `LDFADDAL  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDL_16)` (Half-precision release)
- **Condition**: `size == 01 && A == 0 && R == 1`
- **Assembly**: `LDFADDL  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADD_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDFADD  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDA_32)` (Single-precision acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDFADDA  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDAL_32)` (Single-precision acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDFADDAL  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDL_32)` (Single-precision release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDFADDL  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADD_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDFADD  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDA_64)` (Double-precision acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDFADDA  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDAL_64)` (Double-precision acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDFADDAL  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFADDL_64)` (Double-precision release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDFADDL  <Ds>, <Dt>, [<Xn|SP>]`
