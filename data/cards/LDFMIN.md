...
**Title**: LDFMIN, LDFMINA, LDFMINAL, LDFMINL -- A64 | **Class**: `advsimd` | **XML ID**: `LDFMIN`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic minimum in memory

**Description**:
This instruction atomically loads a 16-bit, 32-bit, or 64-bit value from memory,
computes the floating-point minimum with the value held in a register,
...
### Variant: `Floating-point (LDFMIN_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && A == 0 && R == 0`
- **Assembly**: `LDFMIN  <Hs>, <Ht>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  A   R   1   Rs  0   101 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDFMIN_16)
...
#### Execute (A64.ldst.memop.LDFMIN_16)
...
bits(datasize) value;
bits(datasize) data;
constant AccessDescriptor accdesc = CreateAccDescFPAtomicOp(MemAtomicOp_FPMIN, acquire,
                                                            release, tagchecked);
...
### Variant: `Floating-point (LDFMINA_16)` (Half-precision acquire)
- **Condition**: `size == 01 && A == 1 && R == 0`
- **Assembly**: `LDFMINA  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINAL_16)` (Half-precision acquire-release)
- **Condition**: `size == 01 && A == 1 && R == 1`
- **Assembly**: `LDFMINAL  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINL_16)` (Half-precision release)
- **Condition**: `size == 01 && A == 0 && R == 1`
- **Assembly**: `LDFMINL  <Hs>, <Ht>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMIN_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDFMIN  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINA_32)` (Single-precision acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDFMINA  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINAL_32)` (Single-precision acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDFMINAL  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINL_32)` (Single-precision release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDFMINL  <Ss>, <St>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMIN_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDFMIN  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINA_64)` (Double-precision acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDFMINA  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINAL_64)` (Double-precision acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDFMINAL  <Ds>, <Dt>, [<Xn|SP>]`
...
### Variant: `Floating-point (LDFMINL_64)` (Double-precision release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDFMINL  <Ds>, <Dt>, [<Xn|SP>]`
