...
**Title**: LDLARH -- A64 | **Class**: `general` | **XML ID**: `LDLARH`

**Architecture**: `FEAT_LOR` (PROFILE_A)

**Summary**: Load LOAcquire register halfword

**Description**:
This instruction loads a halfword
...
### Variant: `No offset`
- **Assembly**: `LDLARH  <Wt>, [<Xn|SP>{, #0}]`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24  22 21 20  15 14   9   4  |
|-----------------------------------------|
| 01  00  1   0   0   01  1   0   (1)(1)(1)(1)(1) 0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstord.LDLARH_LR32_ldstord)
...
#### Execute (A64.ldst.ldstord.LDLARH_LR32_ldstord)
