...
**Title**: LDRB (immediate) -- A64 | **Class**: `general` | **XML ID**: `LDRB_imm`

**Summary**: Load register byte (immediate)

**Description**:
This instruction loads a byte from memory,
zero-extends it, and writes the result to a
register.
...
|--------------------------------------|
| 00  11  1   0   0   0   01  0   imm9 01  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_immpost.LDRB_32_ldst_immpost)
...
#### Postdecode (A64.ldst.ldst_immpost.LDRB_32_ldst_immpost)
...
#### Execute (A64.ldst.ldst_immpost.LDRB_32_ldst_immpost)
...
| 31  29  27 26 25 24 23  21 20  11   9   4  |
|--------------------------------------|
| 00  11  1   0   0   0   01  0   imm9 11  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_immpre.LDRB_32_ldst_immpre)
...
|--------------------------------|
| 00  11  1   0   0   1   01  imm12 Rn  Rt  |
```

#### Decode (A64.ldst.ldst_pos.LDRB_32_ldst_pos)
