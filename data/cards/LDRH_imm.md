...
**Title**: LDRH (immediate) -- A64 | **Class**: `general` | **XML ID**: `LDRH_imm`

**Summary**: Load register halfword (immediate)
...
|--------------------------------------|
| 01  11  1   0   0   0   01  0   imm9 01  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_immpost.LDRH_32_ldst_immpost)
...
#### Postdecode (A64.ldst.ldst_immpost.LDRH_32_ldst_immpost)
...
#### Execute (A64.ldst.ldst_immpost.LDRH_32_ldst_immpost)
...
| 31  29  27 26 25 24 23  21 20  11   9   4  |
|--------------------------------------|
| 01  11  1   0   0   0   01  0   imm9 11  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_immpre.LDRH_32_ldst_immpre)
...
|--------------------------------|
| 01  11  1   0   0   1   01  imm12 Rn  Rt  |
```

#### Decode (A64.ldst.ldst_pos.LDRH_32_ldst_pos)
