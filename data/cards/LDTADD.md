...
**Title**: LDTADD, LDTADDA, LDTADDAL, LDTADDL -- A64 | **Class**: `general` | **XML ID**: `LDTADD`

**Architecture**: `FEAT_LSUI` (ARMv9.6)

**Summary**: Atomic add unprivileged

**Description**:
This instruction atomically loads a 32-bit word or
64-bit doubleword from memory, adds the value
...
### Variant: `Integer (LDTADD_32_memop_unpriv)` (32-bit no memory ordering)
- **Condition**: `sz == 0 && A == 0 && R == 0`
- **Assembly**: `LDTADD  <Ws>, <Wt>, [<Xn|SP>]`
...
|--------------------------------------|
| 0   sz  011001 A   R   1   Rs  0   000 01  Rn  Rt  |
```

#### Decode (A64.ldst.memop_unpriv.LDTADD_32_memop_unpriv)
...
#### Execute (A64.ldst.memop_unpriv.LDTADD_32_memop_unpriv)
...
### Variant: `Integer (LDTADDA_32_memop_unpriv)` (32-bit acquire)
- **Condition**: `sz == 0 && A == 1 && R == 0`
- **Assembly**: `LDTADDA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADDAL_32_memop_unpriv)` (32-bit acquire-release)
- **Condition**: `sz == 0 && A == 1 && R == 1`
- **Assembly**: `LDTADDAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADDL_32_memop_unpriv)` (32-bit release)
- **Condition**: `sz == 0 && A == 0 && R == 1`
- **Assembly**: `LDTADDL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADD_64_memop_unpriv)` (64-bit no memory ordering)
- **Condition**: `sz == 1 && A == 0 && R == 0`
- **Assembly**: `LDTADD  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADDA_64_memop_unpriv)` (64-bit acquire)
- **Condition**: `sz == 1 && A == 1 && R == 0`
- **Assembly**: `LDTADDA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADDAL_64_memop_unpriv)` (64-bit acquire-release)
- **Condition**: `sz == 1 && A == 1 && R == 1`
- **Assembly**: `LDTADDAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTADDL_64_memop_unpriv)` (64-bit release)
- **Condition**: `sz == 1 && A == 0 && R == 1`
- **Assembly**: `LDTADDL  <Xs>, <Xt>, [<Xn|SP>]`
