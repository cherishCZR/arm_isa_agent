...
**Title**: LDTNP -- A64 | **Class**: `general` | **XML ID**: `LDTNP_gen`

**Architecture**: `FEAT_LSUI` (ARMv9.6)

**Summary**: Load unprivileged pair of registers, with non-temporal hint
...
- **Assembly**: `LDTNP  <Xt1>, <Xt2>, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24  22 21  14   9   4  |
|-----------------------------------|
| 11  10  1   0   0   00  1   imm7 Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstnapair_offs.LDTNP_64_ldstnapair_offs)
...
#### Execute (A64.ldst.ldstnapair_offs.LDTNP_64_ldstnapair_offs)
...
- atomic-ops: `LDTNP-pair-64`
- isa: `A64`
- offset-type: `off7s_s`
- reg-type: `pair-64`
- source: `ldtnp_gen.xml`
</details>