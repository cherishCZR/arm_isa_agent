...
**Title**: LDTRH -- A64 | **Class**: `general` | **XML ID**: `LDTRH`

**Summary**: Load register halfword (unprivileged)
...
|--------------------------------------|
| 01  11  1   0   0   0   01  0   imm9 10  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unpriv.LDTRH_32_ldst_unpriv)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unpriv.LDTRH_32_ldst_unpriv)
...
#### Execute (A64.ldst.ldst_unpriv.LDTRH_32_ldst_unpriv)
