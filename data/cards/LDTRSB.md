...
**Title**: LDTRSB -- A64 | **Class**: `general` | **XML ID**: `LDTRSB`

**Summary**: Load register signed byte (unprivileged)
...
### Variant: `Unscaled offset (LDTRSB_32_ldst_unpriv)` (32-bit)
- **Condition**: `opc == 11`
...
|--------------------------------|
| 00  111 0   00  1x  0   imm9 10  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unpriv.LDTRSB_32_ldst_unpriv)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unpriv.LDTRSB_32_ldst_unpriv)
...
#### Execute (A64.ldst.ldst_unpriv.LDTRSB_32_ldst_unpriv)
...
### Variant: `Unscaled offset (LDTRSB_64_ldst_unpriv)` (64-bit)
- **Condition**: `opc == 10`
