...
**Title**: LDTSET, LDTSETA, LDTSETAL, LDTSETL -- A64 | **Class**: `general` | **XML ID**: `LDTSET`

**Architecture**: `FEAT_LSUI` (ARMv9.6)

**Summary**: Atomic bit set unprivileged
...
### Variant: `Integer (LDTSET_32_memop_unpriv)` (32-bit no memory ordering)
- **Condition**: `sz == 0 && A == 0 && R == 0`
- **Assembly**: `LDTSET  <Ws>, <Wt>, [<Xn|SP>]`
...
|--------------------------------------|
| 0   sz  011001 A   R   1   Rs  0   011 01  Rn  Rt  |
```

#### Decode (A64.ldst.memop_unpriv.LDTSET_32_memop_unpriv)
...
#### Execute (A64.ldst.memop_unpriv.LDTSET_32_memop_unpriv)
...
### Variant: `Integer (LDTSETA_32_memop_unpriv)` (32-bit acquire)
- **Condition**: `sz == 0 && A == 1 && R == 0`
- **Assembly**: `LDTSETA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSETAL_32_memop_unpriv)` (32-bit acquire-release)
- **Condition**: `sz == 0 && A == 1 && R == 1`
- **Assembly**: `LDTSETAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSETL_32_memop_unpriv)` (32-bit release)
- **Condition**: `sz == 0 && A == 0 && R == 1`
- **Assembly**: `LDTSETL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSET_64_memop_unpriv)` (64-bit no memory ordering)
- **Condition**: `sz == 1 && A == 0 && R == 0`
- **Assembly**: `LDTSET  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSETA_64_memop_unpriv)` (64-bit acquire)
- **Condition**: `sz == 1 && A == 1 && R == 0`
- **Assembly**: `LDTSETA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSETAL_64_memop_unpriv)` (64-bit acquire-release)
- **Condition**: `sz == 1 && A == 1 && R == 1`
- **Assembly**: `LDTSETAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDTSETL_64_memop_unpriv)` (64-bit release)
- **Condition**: `sz == 1 && A == 0 && R == 1`
- **Assembly**: `LDTSETL  <Xs>, <Xt>, [<Xn|SP>]`
