...
**Title**: LDUMAX, LDUMAXA, LDUMAXAL, LDUMAXL -- A64 | **Class**: `general` | **XML ID**: `LDUMAX`

**Architecture**: `FEAT_LSE` (ARMv8.1)

**Summary**: Atomic unsigned maximum on word or doubleword in memory
...
### Variant: `Integer (LDUMAX_32_memop)` (32-bit no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDUMAX  <Ws>, <Wt>, [<Xn|SP>]`
...
|-----------------------------------------|
| 1x  111 0   00  A   R   1   Rs  0   110 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDUMAX_32_memop)
...
#### Execute (A64.ldst.memop.LDUMAX_32_memop)
...
### Variant: `Integer (LDUMAXA_32_memop)` (32-bit acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDUMAXA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAXAL_32_memop)` (32-bit acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDUMAXAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAXL_32_memop)` (32-bit release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDUMAXL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAX_64_memop)` (64-bit no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDUMAX  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAXA_64_memop)` (64-bit acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDUMAXA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAXAL_64_memop)` (64-bit acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDUMAXAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMAXL_64_memop)` (64-bit release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDUMAXL  <Xs>, <Xt>, [<Xn|SP>]`
