...
**Title**: LDUMIN, LDUMINA, LDUMINAL, LDUMINL -- A64 | **Class**: `general` | **XML ID**: `LDUMIN`

**Architecture**: `FEAT_LSE` (ARMv8.1)

**Summary**: Atomic unsigned minimum on word or doubleword in memory
...
### Variant: `Integer (LDUMIN_32_memop)` (32-bit no memory ordering)
- **Condition**: `size == 10 && A == 0 && R == 0`
- **Assembly**: `LDUMIN  <Ws>, <Wt>, [<Xn|SP>]`
...
|-----------------------------------------|
| 1x  111 0   00  A   R   1   Rs  0   111 00  Rn  Rt  |
```

#### Decode (A64.ldst.memop.LDUMIN_32_memop)
...
#### Execute (A64.ldst.memop.LDUMIN_32_memop)
...
### Variant: `Integer (LDUMINA_32_memop)` (32-bit acquire)
- **Condition**: `size == 10 && A == 1 && R == 0`
- **Assembly**: `LDUMINA  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMINAL_32_memop)` (32-bit acquire-release)
- **Condition**: `size == 10 && A == 1 && R == 1`
- **Assembly**: `LDUMINAL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMINL_32_memop)` (32-bit release)
- **Condition**: `size == 10 && A == 0 && R == 1`
- **Assembly**: `LDUMINL  <Ws>, <Wt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMIN_64_memop)` (64-bit no memory ordering)
- **Condition**: `size == 11 && A == 0 && R == 0`
- **Assembly**: `LDUMIN  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMINA_64_memop)` (64-bit acquire)
- **Condition**: `size == 11 && A == 1 && R == 0`
- **Assembly**: `LDUMINA  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMINAL_64_memop)` (64-bit acquire-release)
- **Condition**: `size == 11 && A == 1 && R == 1`
- **Assembly**: `LDUMINAL  <Xs>, <Xt>, [<Xn|SP>]`
...
### Variant: `Integer (LDUMINL_64_memop)` (64-bit release)
- **Condition**: `size == 11 && A == 0 && R == 1`
- **Assembly**: `LDUMINL  <Xs>, <Xt>, [<Xn|SP>]`
