...
**Title**: LDURH -- A64 | **Class**: `general` | **XML ID**: `LDURH`

**Summary**: Load register halfword (unscaled)

**Description**:
This instruction calculates an address from a base
register and an immediate offset, loads a halfword from memory,
zero-extends it,
and writes it
...
|--------------------------------------|
| 01  11  1   0   0   0   01  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unscaled.LDURH_32_ldst_unscaled)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unscaled.LDURH_32_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.LDURH_32_ldst_unscaled)
