...
**Title**: LDURSB -- A64 | **Class**: `general` | **XML ID**: `LDURSB`

**Summary**: Load register signed byte (unscaled)
...
### Variant: `Unscaled offset (LDURSB_32_ldst_unscaled)` (32-bit)
- **Condition**: `opc == 11`
...
|--------------------------------|
| 00  111 0   00  1x  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unscaled.LDURSB_32_ldst_unscaled)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unscaled.LDURSB_32_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.LDURSB_32_ldst_unscaled)
...
### Variant: `Unscaled offset (LDURSB_64_ldst_unscaled)` (64-bit)
- **Condition**: `opc == 10`
