...
**Title**: LDURSW -- A64 | **Class**: `general` | **XML ID**: `LDURSW`

**Summary**: Load register signed word (unscaled)
...
|--------------------------------------|
| 10  11  1   0   0   0   10  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unscaled.LDURSW_64_ldst_unscaled)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unscaled.LDURSW_64_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.LDURSW_64_ldst_unscaled)
