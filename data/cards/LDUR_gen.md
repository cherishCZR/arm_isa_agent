...
**Title**: LDUR -- A64 | **Class**: `general` | **XML ID**: `LDUR_gen`

**Summary**: Load register (unscaled)
...
### Variant: `Unscaled offset (LDUR_32_ldst_unscaled)` (32-bit)
- **Condition**: `size == 10`
...
#### Decode (A64.ldst.ldst_unscaled.LDUR_32_ldst_unscaled)
...
#### Postdecode (A64.ldst.ldst_unscaled.LDUR_32_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.LDUR_32_ldst_unscaled)
...
### Variant: `Unscaled offset (LDUR_64_ldst_unscaled)` (64-bit)
- **Condition**: `size == 11`
