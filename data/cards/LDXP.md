...
**Title**: LDXP -- A64 | **Class**: `general` | **XML ID**: `LDXP`

**Summary**: Load exclusive pair of registers
...
### Variant: `No offset (LDXP_LP32_ldstexclp)` (32-bit)
- **Condition**: `sz == 0`
...
|--------------------------------|
| 1   sz  0010000 1   1   (1)(1)(1)(1)(1) 0   Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclp.LDXP_LP32_ldstexclp)
...
#### Execute (A64.ldst.ldstexclp.LDXP_LP32_ldstexclp)
...
### Variant: `No offset (LDXP_LP64_ldstexclp)` (64-bit)
- **Condition**: `sz == 1`
