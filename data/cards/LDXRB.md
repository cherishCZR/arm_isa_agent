...
**Title**: LDXRB -- A64 | **Class**: `general` | **XML ID**: `LDXRB`

**Summary**: Load exclusive register byte

**Description**:
This instruction derives an address from a base register
value, loads a byte from memory,
...
|-----------------------------------------|
| 00  00  1   0   0   00  1   0   (1)(1)(1)(1)(1) 0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.LDXRB_LR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.LDXRB_LR32_ldstexclr)
