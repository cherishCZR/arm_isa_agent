...
**Title**: LDXRH -- A64 | **Class**: `general` | **XML ID**: `LDXRH`

**Summary**: Load exclusive register halfword

**Description**:
This instruction derives an address from a base register
value, loads a halfword from memory,
zero-extends it and writes it to
...
|-----------------------------------------|
| 01  00  1   0   0   00  1   0   (1)(1)(1)(1)(1) 0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.LDXRH_LR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.LDXRH_LR32_ldstexclr)
