...
**Title**: LSLV -- A64 | **Class**: `general` | **XML ID**: `LSLV`

**Summary**: Logical shift left variable
...
the register size in bits gives the number of bits
by which the first source register is left-shifted.

### Variant: `Integer (LSLV_32_dp_2src)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.dp_2src.LSLV_32_dp_2src)
...
#### Execute (A64.dpreg.dp_2src.LSLV_32_dp_2src)
...
### Variant: `Integer (LSLV_64_dp_2src)` (64-bit)
- **Condition**: `sf == 1`
