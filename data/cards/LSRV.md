...
**Title**: LSRV -- A64 | **Class**: `general` | **XML ID**: `LSRV`

**Summary**: Logical shift right variable
...
### Variant: `Integer (LSRV_32_dp_2src)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.dp_2src.LSRV_32_dp_2src)
...
#### Execute (A64.dpreg.dp_2src.LSRV_32_dp_2src)
...
### Variant: `Integer (LSRV_64_dp_2src)` (64-bit)
- **Condition**: `sf == 1`
