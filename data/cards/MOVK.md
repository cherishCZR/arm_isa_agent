...
**Title**: MOVK -- A64 | **Class**: `general` | **XML ID**: `MOVK`

**Summary**: Move wide with keep

**Description**:
This instruction moves an optionally-shifted 16-bit immediate value into a
register, keeping other bits unchanged.

### Variant: `Immediate packed into 16-bit value and 2-bit shift (MOVK_32_movewide)` (32-bit)
...
#### Decode (A64.dpimm.movewide.MOVK_32_movewide)
...
#### Execute (A64.dpimm.movewide.MOVK_32_movewide)
...
### Variant: `Immediate packed into 16-bit value and 2-bit shift (MOVK_64_movewide)` (64-bit)
- **Condition**: `sf == 1`
