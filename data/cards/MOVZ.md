...
**Title**: MOVZ -- A64 | **Class**: `general` | **XML ID**: `MOVZ`

**Summary**: Move wide with zero

**Description**:
This instruction moves an optionally-shifted 16-bit immediate
value to a register.

### Variant: `Immediate packed into 16-bit value and 2-bit shift (MOVZ_32_movewide)` (32-bit)
...
#### Decode (A64.dpimm.movewide.MOVZ_32_movewide)
...
#### Execute (A64.dpimm.movewide.MOVZ_32_movewide)
...
### Variant: `Immediate packed into 16-bit value and 2-bit shift (MOVZ_64_movewide)` (64-bit)
- **Condition**: `sf == 1`
