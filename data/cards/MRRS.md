...
**Title**: MRRS -- A64 | **Class**: `system` | **XML ID**: `MRRS`

**Architecture**: `FEAT_SYSREG128` (ARMv9.4)

**Summary**: Move System register to two adjacent general-purpose registers

**Description**:
This instruction
allows the PE to read an AArch64 128-bit System register into
two adjacent 64-bit general-purpose registers.

### Variant: `System`
- **Assembly**: `MRRS  <Xt>, <Xt+1>, (<systemreg>|S<op0>_<op1>_<Cn>_<Cm>_<op2>)`
**Encoding Diagram (32-bit)**:

```text
| 31  28  25  21 20 19 18  15  11   7   4  |
|-----------------------------------|
| 110 101 0101 1   1   o0  op1 CRn CRm op2 Rt  |
```

#### Decode (A64.control.systemmovepr.MRRS_RS_systemmovepr)
...
#### Execute (A64.control.systemmovepr.MRRS_RS_systemmovepr)
...
|---|---|---|---|
| `<Xt>` | `register (64-bit)` | `Rt` | Is the 64-bit name of the first general-purpose destination register, encoded in the "Rt" field. |
| `<Xt+1>` | `register (64-bit)` | `Rt` | Is the 64-bit name of the second general-purpose destination register, encoded as "Rt" +1. |
