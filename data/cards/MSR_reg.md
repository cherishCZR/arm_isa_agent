...
**Title**: MSR (register) -- A64 | **Class**: `system` | **XML ID**: `MSR_reg`

**Summary**: Move general-purpose register to System register
...
### Variant: `System`
- **Assembly**: `MSR  (<systemreg>|S<op0>_<op1>_<Cn>_<Cm>_<op2>), <Xt>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  25  21 20 19 18  15  11   7   4  |
|-----------------------------------|
| 110 101 0100 0   1   o0  op1 CRn CRm op2 Rt  |
```

#### Decode (A64.control.systemmove.MSR_SR_systemmove)
...
#### Execute (A64.control.systemmove.MSR_SR_systemmove)
...
- isa: `A64`
- msr-sysreg-target: `register-field`
- source: `msr_reg.xml`
</details>