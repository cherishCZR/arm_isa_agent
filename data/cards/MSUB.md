...
**Title**: MSUB -- A64 | **Class**: `general` | **XML ID**: `MSUB`

**Summary**: Multiply-subtract
...
### Variant: `Integer (MSUB_32A_dp_3src)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.dp_3src.MSUB_32A_dp_3src)
...
#### Execute (A64.dpreg.dp_3src.MSUB_32A_dp_3src)
...
### Variant: `Integer (MSUB_64A_dp_3src)` (64-bit)
- **Condition**: `sf == 1`
...
| `<Wa>` | `register (32-bit)` | `Ra` | Is the 32-bit name of the third general-purpose source register holding the minuend, encoded in the "Ra" field. |
