...
**Title**: MSUBPT -- A64 | **Class**: `general` | **XML ID**: `MSUBPT`

**Architecture**: `FEAT_CPA` (ARMv9.5)

**Summary**: Multiply-subtract checked pointer
...
### Variant: `Integer`
- **Assembly**: `MSUBPT  <Xd>, <Xn>, <Xm>, <Xa>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28 27  24 23  20  15 14   9   4  |
|-----------------------------------|
| 1   00  1   101 1   011 Rm  1   Ra  Rn  Rd  |
```

#### Decode (A64.dpreg.dp_3src.MSUBPT_64A_dp_3src)
...
#### Execute (A64.dpreg.dp_3src.MSUBPT_64A_dp_3src)
