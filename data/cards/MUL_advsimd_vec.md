...
**Title**: MUL (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `MUL_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Multiply (vector)
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  10011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.MUL_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.MUL_asimdsame_only)
