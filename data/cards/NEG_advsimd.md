...
**Title**: NEG (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `NEG_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Negate (vector)

**Description**:
This instruction reads each vector element from the source SIMD&FP register,
negates each value, puts the result into a vector, and writes the
...
### Variant: `Scalar`
- **Assembly**: `NEG  D<d>, D<n>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21  16  11   9   4  |
|-----------------------------------|
| 01  1   1   111 0   11  10000 01011 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.NEG_asisdmisc_R)
...
#### Execute (A64.simd_dp.asisdmisc.NEG_asisdmisc_R)
...
|--------------------------------------|
| 0   Q   1   0   111 0   size 10000 01011 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.NEG_asimdmisc_R)
