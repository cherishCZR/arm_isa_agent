...
**Title**: ORN (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `ORN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Bitwise inclusive OR NOT (vector)

**Description**:
This instruction performs a bitwise OR NOT
between the two source SIMD&FP registers,
...
|-----------------------------------------|
| 0   Q   0   0   111 0   11  1   Rm  00011 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.ORN_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.ORN_asimdsame_only)
