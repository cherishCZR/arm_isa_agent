...
**Title**: ORN (shifted register) -- A64 | **Class**: `general` | **XML ID**: `ORN_log_shift`

**Summary**: Bitwise OR NOT (shifted register)

**Description**:
This instruction performs a bitwise (inclusive) OR
of a register value and the complement of an optionally-shifted
register value, and writes the result to the destination register.

### Variant: `Not setting the condition flags (ORN_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.log_shift.ORN_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.ORN_32_log_shift)
...
### Variant: `Not setting the condition flags (ORN_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
