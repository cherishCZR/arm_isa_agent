...
**Title**: ORR (vector, register) -- A64 | **Class**: `advsimd` | **XML ID**: `ORR_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Bitwise inclusive OR (vector, register)

**Description**:
This instruction performs a bitwise OR
...
#### Decode (A64.simd_dp.asimdsame.ORR_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.ORR_asimdsame_only)
