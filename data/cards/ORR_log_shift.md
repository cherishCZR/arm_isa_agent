...
**Title**: ORR (shifted register) -- A64 | **Class**: `general` | **XML ID**: `ORR_log_shift`

**Summary**: Bitwise OR (shifted register)

**Description**:
This instruction performs a bitwise (inclusive) OR of a
register value and an optionally-shifted register value, and writes
the result to the destination register.

### Variant: `Not setting the condition flags (ORR_32_log_shift)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.log_shift.ORR_32_log_shift)
...
#### Execute (A64.dpreg.log_shift.ORR_32_log_shift)
...
### Variant: `Not setting the condition flags (ORR_64_log_shift)` (64-bit)
- **Condition**: `sf == 1`
