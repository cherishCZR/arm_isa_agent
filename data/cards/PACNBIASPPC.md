...
**Title**: PACNBIASPPC -- A64 | **Class**: `general` | **XML ID**: `PACNBIASPPC`

**Architecture**: `FEAT_PAuth_LR` (ARMv9.5)

**Summary**: Pointer Authentication Code for return address, using key A, not a branch target
...
### Variant: `Integer`
- **Assembly**: `PACNBIASPPC`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24  20  15   9   4  |
|--------------------------------|
| 1   1   0   1   101 0110 00001 100000 11111 11110 |
```

#### Decode (A64.dpreg.dp_1src.PACNBIASPPC_64LR_dp_1src)
...
#### Execute (A64.dpreg.dp_1src.PACNBIASPPC_64LR_dp_1src)
