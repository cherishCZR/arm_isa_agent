...
**Title**: RADDHN, RADDHN2 -- A64 | **Class**: `advsimd` | **XML ID**: `RADDHN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Rounding add returning high narrow
...
- **Assembly**: `RADDHN{2}  <Vd>.<Tb>, <Vn>.<Ta>, <Vm>.<Ta>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  01  0   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.RADDHN_asimddiff_N)
...
#### Execute (A64.simd_dp.asimddiff.RADDHN_asimddiff_N)
