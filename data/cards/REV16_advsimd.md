...
**Title**: REV16 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `REV16_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Reverse elements in 16-bit halfwords (vector)
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 10000 0000 1   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.REV16_asimdmisc_R)
...
#### Execute (A64.simd_dp.asimdmisc.REV16_asimdmisc_R)
