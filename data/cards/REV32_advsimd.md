...
**Title**: REV32 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `REV32_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Reverse elements in 32-bit words (vector)

**Description**:
This instruction reverses the order of 8-bit or 16-bit elements in each word of the vector
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 10000 0000 0   10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.REV32_asimdmisc_R)
...
#### Execute (A64.simd_dp.asimdmisc.REV32_asimdmisc_R)
