...
**Title**: RORV -- A64 | **Class**: `general` | **XML ID**: `RORV`

**Summary**: Rotate right variable
...
### Variant: `Integer (RORV_32_dp_2src)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpreg.dp_2src.RORV_32_dp_2src)
...
#### Execute (A64.dpreg.dp_2src.RORV_32_dp_2src)
...
### Variant: `Integer (RORV_64_dp_2src)` (64-bit)
- **Condition**: `sf == 1`
