...
**Title**: RSUBHN, RSUBHN2 -- A64 | **Class**: `advsimd` | **XML ID**: `RSUBHN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Rounding subtract returning high narrow

**Description**:
This instruction subtracts each vector element of the second source SIMD&FP
...
The RSUBHN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The RSUBHN2 instruction writes the vector
...
- **Assembly**: `RSUBHN{2}  <Vd>.<Tb>, <Vn>.<Ta>, <Vm>.<Ta>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  01  1   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.RSUBHN_asimddiff_N)
...
#### Execute (A64.simd_dp.asimddiff.RSUBHN_asimddiff_N)
