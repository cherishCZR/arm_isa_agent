...
**Title**: SABA -- A64 | **Class**: `advsimd` | **XML ID**: `SABA_advsimd`
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  0111 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SABA_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SABA_asimdsame_only)
