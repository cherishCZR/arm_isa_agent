...
**Title**: SABDL, SABDL2 -- A64 | **Class**: `advsimd` | **XML ID**: `SABDL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed absolute difference long

**Description**:
This instruction subtracts the vector elements in the lower or upper half
of the second source SIMD&FP register from the corresponding vector elements
of the first source SIMD&FP register, places the absolute value of the results
...
The SABDL instruction extracts each source vector from
the lower half of each source register.
The SABDL2 instruction extracts each source vector from
...
- **Assembly**: `SABDL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  01  1   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.SABDL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.SABDL_asimddiff_L)
