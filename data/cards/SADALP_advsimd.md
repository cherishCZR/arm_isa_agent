...
**Title**: SADALP -- A64 | **Class**: `advsimd` | **XML ID**: `SADALP_advsimd`
...
**Description**:
This instruction adds pairs of adjacent signed integer values from the vector
in the source SIMD&FP register
and accumulates the
results into the vector elements of the destination
SIMD&FP register.
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 10000 00  1   10  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.SADALP_asimdmisc_P)
...
#### Execute (A64.simd_dp.asimdmisc.SADALP_asimdmisc_P)
...
for e = 0 to elements-1
    op1 = SInt(Elem[operand, 2*e+0, esize]);
    op2 = SInt(Elem[operand, 2*e+1, esize]);
