...
**Title**: SADDLP -- A64 | **Class**: `advsimd` | **XML ID**: `SADDLP_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed add long pairwise
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 10000 00  0   10  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.SADDLP_asimdmisc_P)
...
#### Execute (A64.simd_dp.asimdmisc.SADDLP_asimdmisc_P)
