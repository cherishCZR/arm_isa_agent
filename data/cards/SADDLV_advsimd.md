...
**Title**: SADDLV -- A64 | **Class**: `advsimd` | **XML ID**: `SADDLV_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed add long across vector
...
|--------------------------------------|
| 0   Q   0   0   111 0   size 11000 00011 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdall.SADDLV_asimdall_only)
...
#### Execute (A64.simd_dp.asimdall.SADDLV_asimdall_only)
