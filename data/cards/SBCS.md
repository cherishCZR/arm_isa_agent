...
**Title**: SBCS -- A64 | **Class**: `general` | **XML ID**: `SBCS`

**Summary**: Subtract with carry, setting flags

**Description**:
This instruction subtracts a register value and
the value of NOT (Carry flag) from a register
value, and writes the result to the destination register. It
updates the condition flags based on the result.

### Variant: `Setting the condition flags (SBCS_32_addsub_carry)` (32-bit)
- **Condition**: `sf == 0`
...
|--------------------------|
| sf  1   1   11010000 Rm  000000 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_carry.SBCS_32_addsub_carry)
...
#### Execute (A64.dpreg.addsub_carry.SBCS_32_addsub_carry)
...
### Variant: `Setting the condition flags (SBCS_64_addsub_carry)` (64-bit)
- **Condition**: `sf == 1`
