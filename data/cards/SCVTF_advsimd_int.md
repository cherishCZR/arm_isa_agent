...
**Title**: SCVTF (vector, integer) -- A64 | **Class**: `advsimd` | **XML ID**: `SCVTF_advsimd_int`

**Architecture**: `FEAT_AdvSIMD && FEAT_FP16` (FEAT_AdvSIMD && FEAT_FP16), `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed integer convert to floating-point (vector)

**Description**:
This instruction converts each element in a vector from signed integer to floating-point
...
- **Assembly**: `SCVTF  <Hd>, <Hn>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23 22  18  16  11   9   4  |
|--------------------------------------|
| 01  0   1   111 0   0   1111 00  11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmiscfp16.SCVTF_asisdmiscfp16_R)
...
#### Execute (A64.simd_dp.asisdmiscfp16.SCVTF_asisdmiscfp16_R)
...
|--------------------------------------|
| 01  0   1   111 0   0   sz  10000 11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.SCVTF_asisdmisc_R)
...
|-----------------------------------------|
| 0   Q   0   0   111 0   0   1111 00  11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmiscfp16.SCVTF_asimdmiscfp16_R)
...
|-----------------------------------------|
| 0   Q   0   0   111 0   0   sz  10000 11101 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.SCVTF_asimdmisc_R)
