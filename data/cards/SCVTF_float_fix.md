...
**Title**: SCVTF (scalar, fixed-point) -- A64 | **Class**: `float` | **XML ID**: `SCVTF_float_fix`

**Summary**: Signed fixed-point convert to floating-point (scalar)

**Description**:
This instruction converts the signed value
...
### Variant: `Floating-point (SCVTF_H32_float2fix)` (32-bit to half-precision)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `SCVTF  <Hd>, <Wn>, #<fbits>`
...
|-----------------------------------|
| sf  0   0   11110 ftype 0   00  010 scale Rn  Rd  |
```

#### Decode (A64.simd_dp.float2fix.SCVTF_H32_float2fix)
...
#### Execute (A64.simd_dp.float2fix.SCVTF_H32_float2fix)
...
### Variant: `Floating-point (SCVTF_H64_float2fix)` (64-bit to half-precision)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `SCVTF  <Hd>, <Xn>, #<fbits>`
...
### Variant: `Floating-point (SCVTF_S32_float2fix)` (32-bit to single-precision)
...
### Variant: `Floating-point (SCVTF_S64_float2fix)` (64-bit to single-precision)
...
### Variant: `Floating-point (SCVTF_D32_float2fix)` (32-bit to double-precision)
...
### Variant: `Floating-point (SCVTF_D64_float2fix)` (64-bit to double-precision)
