...
**Title**: SCVTF (scalar, integer) -- A64 | **Class**: `float` | **XML ID**: `SCVTF_float_int`

**Summary**: Signed integer convert to floating-point (scalar)
...
### Variant: `Floating-point (SCVTF_H32_float2int)` (32-bit to half-precision)
- **Condition**: `sf == 0 && ftype == 11`
- **Assembly**: `SCVTF  <Hd>, <Wn>`
...
#### Decode (A64.simd_dp.float2int.SCVTF_H32_float2int)
...
#### Execute (A64.simd_dp.float2int.SCVTF_H32_float2int)
...
### Variant: `Floating-point (SCVTF_S32_float2int)` (32-bit to single-precision)
...
### Variant: `Floating-point (SCVTF_D32_float2int)` (32-bit to double-precision)
...
### Variant: `Floating-point (SCVTF_H64_float2int)` (64-bit to half-precision)
- **Condition**: `sf == 1 && ftype == 11`
- **Assembly**: `SCVTF  <Hd>, <Xn>`
...
### Variant: `Floating-point (SCVTF_S64_float2int)` (64-bit to single-precision)
...
### Variant: `Floating-point (SCVTF_D64_float2int)` (64-bit to double-precision)
