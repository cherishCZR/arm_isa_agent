...
**Title**: SDOT (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SDOT_advsimd_elt`

**Architecture**: `FEAT_DotProd` (ARMv8.4)

**Summary**: Dot product signed arithmetic (vector, by element)

**Description**:
This instruction performs
the dot product of the four 8-bit elements in each 32-bit element of the
first source register with the four 8-bit elements of an indexed 32-bit
...
### Variant: `Vector`
- **Assembly**: `SDOT  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.4B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20 19  15  11 10  9   4  |
|-----------------------------------------------|
| 0   Q   0   0   111 1   size L   M   Rm  1110 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SDOT_asimdelem_D)
...
#### Execute (A64.simd_dp.asimdelem.SDOT_asimdelem_D)
