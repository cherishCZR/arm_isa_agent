...
**Title**: SDOT (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `SDOT_advsimd_vec`
...
### Variant: `Vector`
- **Assembly**: `SDOT  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15 14  10  9   4  |
|--------------------------------------------|
| 0   Q   0   0   111 0   size 0   Rm  1   0010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame2.SDOT_asimdsame2_D)
...
#### Execute (A64.simd_dp.asimdsame2.SDOT_asimdsame2_D)
