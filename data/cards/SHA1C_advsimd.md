...
**Title**: SHA1C -- A64 | **Class**: `advsimd` | **XML ID**: `SHA1C_advsimd`
...
|-----------------------------------|
| 0101 111 0   00  0   Rm  0   000 00  Rn  Rd  |
```

#### Decode (A64.simd_dp.cryptosha3.SHA1C_QSV_cryptosha3)
...
#### Execute (A64.simd_dp.cryptosha3.SHA1C_QSV_cryptosha3)
...
for e = 0 to 3
    constant bits(32) t = SHAchoose(x<63:32>, x<95:64>, x<127:96>);
