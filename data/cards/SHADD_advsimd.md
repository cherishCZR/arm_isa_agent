...
**Title**: SHADD -- A64 | **Class**: `advsimd` | **XML ID**: `SHADD_advsimd`
...
The results are
truncated. For rounded results, see SRHADD.
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  00000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SHADD_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SHADD_asimdsame_only)
