...
**Title**: SHSUB -- A64 | **Class**: `advsimd` | **XML ID**: `SHSUB_advsimd`
...
shifts each result right one bit, places each result into elements of a vector,
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  00100 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SHSUB_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SHSUB_asimdsame_only)
