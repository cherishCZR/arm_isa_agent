...
**Title**: SM3PARTW2 -- A64 | **Class**: `advsimd` | **XML ID**: `SM3PARTW2_advsimd`
...
**Description**:
This instruction takes three 128-bit vectors from three source SIMD&FP registers and
...
fixed rotations, see the Operation pseudocode for more information.

### Variant: `Advanced SIMD`
- **Assembly**: `SM3PARTW2  <Vd>.4S, <Vn>.4S, <Vm>.4S`
**Encoding Diagram (32-bit)**:

```text
| 31  27  24  22  20  15 14 13  11   9   4  |
|-----------------------------------|
| 1100 111 00  11  Rm  1   1   00  01  Rn  Rd  |
```

#### Decode (A64.simd_dp.cryptosha512_3.SM3PARTW2_VVV4_cryptosha512_3)
...
#### Execute (A64.simd_dp.cryptosha512_3.SM3PARTW2_VVV4_cryptosha512_3)
