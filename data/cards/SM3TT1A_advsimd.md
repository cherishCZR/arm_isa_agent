...
**Title**: SM3TT1A -- A64 | **Class**: `advsimd` | **XML ID**: `SM3TT1A_advsimd`
...
result in the destination SIMD&FP register.  It performs a
three-way exclusive-OR of the three 32-bit fields held in the upper
...
- **Assembly**: `SM3TT1A  <Vd>.4S, <Vn>.4S, <Vm>.S[<imm2>]`
**Encoding Diagram (32-bit)**:

```text
| 31  27  24  22  20  15  13  11   9   4  |
|--------------------------------|
| 1100 111 00  10  Rm  10  imm2 00  Rn  Rd  |
```

#### Decode (A64.simd_dp.crypto3_imm2.SM3TT1A_VVV4_crypto3_imm2)
...
#### Execute (A64.simd_dp.crypto3_imm2.SM3TT1A_VVV4_crypto3_imm2)
