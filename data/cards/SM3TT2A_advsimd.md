...
**Title**: SM3TT2A -- A64 | **Class**: `advsimd` | **XML ID**: `SM3TT2A_advsimd`
...
A three-way exclusive-OR is performed of the result of this addition,
...
- **Assembly**: `SM3TT2A  <Vd>.4S, <Vn>.4S, <Vm>.S[<imm2>]`
**Encoding Diagram (32-bit)**:

```text
| 31  27  24  22  20  15  13  11   9   4  |
|--------------------------------|
| 1100 111 00  10  Rm  10  imm2 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.crypto3_imm2.SM3TT2A_VVV4_crypto3_imm2)
...
#### Execute (A64.simd_dp.crypto3_imm2.SM3TT2A_VVV4_crypto3_imm2)
