...
**Title**: SM4E -- A64 | **Class**: `advsimd` | **XML ID**: `SM4E_advsimd`
...
**Description**:
This instruction takes input data as a 128-bit vector from the first source SIMD&FP
...
- **Assembly**: `SM4E  <Vd>.4S, <Vn>.4S`
**Encoding Diagram (32-bit)**:

```text
| 31  27  24  22  18  11   9   4  |
|--------------------------|
| 1100 111 01  1000 0001000 01  Rn  Rd  |
```

#### Decode (A64.simd_dp.cryptosha512_2.SM4E_VV4_cryptosha512_2)
...
#### Execute (A64.simd_dp.cryptosha512_2.SM4E_VV4_cryptosha512_2)
