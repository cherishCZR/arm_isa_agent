...
**Title**: SMAXP -- A64 | **Class**: `advsimd` | **XML ID**: `SMAXP_advsimd`
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  1010 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SMAXP_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SMAXP_asimdsame_only)
