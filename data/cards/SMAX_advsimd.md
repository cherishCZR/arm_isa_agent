...
**Title**: SMAX -- A64 | **Class**: `advsimd` | **XML ID**: `SMAX_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed maximum (vector)

**Description**:
This instruction compares corresponding elements in the
vectors in the two source SIMD&FP registers,
places the larger of each pair of signed
integer values
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  0110 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SMAX_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SMAX_asimdsame_only)
