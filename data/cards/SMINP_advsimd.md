...
**Title**: SMINP -- A64 | **Class**: `advsimd` | **XML ID**: `SMINP_advsimd`
...
writes the smallest of each pair of signed integer values
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  1010 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SMINP_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SMINP_asimdsame_only)
