...
**Title**: SMINV -- A64 | **Class**: `advsimd` | **XML ID**: `SMINV_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed minimum across vector
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 11000 1   1010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdall.SMINV_asimdall_only)
...
#### Execute (A64.simd_dp.asimdall.SMINV_asimdall_only)
