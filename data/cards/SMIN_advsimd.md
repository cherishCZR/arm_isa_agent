...
**Title**: SMIN -- A64 | **Class**: `advsimd` | **XML ID**: `SMIN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed minimum (vector)

**Description**:
This instruction compares corresponding elements in the
vectors in the two source SIMD&FP registers,
places the smaller of each of the two signed
integer values
...
|--------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  0110 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SMIN_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SMIN_asimdsame_only)
