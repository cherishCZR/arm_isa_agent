...
**Title**: SMLAL, SMLAL2 (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SMLAL_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed multiply-add long (vector, by element)

**Description**:
This instruction multiplies each vector element in the
lower or upper half of the first source SIMD&FP register
by the specified vector element in the
...
of the first source register. The SMLAL2 instruction extracts
...
|-----------------------------------------------------|
| 0   Q   0   0   111 1   size L   M   Rm  0   0   10  H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SMLAL_asimdelem_L)
...
#### Execute (A64.simd_dp.asimdelem.SMLAL_asimdelem_L)
