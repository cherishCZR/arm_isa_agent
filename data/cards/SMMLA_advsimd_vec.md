...
**Title**: SMMLA (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `SMMLA_advsimd_vec`

**Architecture**: `FEAT_I8MM` (PROFILE_A)

**Summary**: Signed 8-bit integer matrix multiply-accumulate (vector)

**Description**:
This instruction multiplies the
2x8 matrix of signed 8-bit integer values in the first source vector by the
...
### Variant: `Vector`
- **Assembly**: `SMMLA  <Vd>.4S, <Vn>.16B, <Vm>.16B`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15 14  11 10  9   4  |
|-----------------------------------------------|
| 0   1   0   0   111 0   10  0   Rm  1   010 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame2.SMMLA_asimdsame2_G)
...
#### Execute (A64.simd_dp.asimdsame2.SMMLA_asimdsame2_G)
