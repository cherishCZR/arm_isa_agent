...
**Title**: SMULH -- A64 | **Class**: `general` | **XML ID**: `SMULH`
...
|--------------------------------------|
| 1   00  1   101 1   0   10  Rm  0   (1)(1)(1)(1)(1) Rn  Rd  |
```

#### Decode (A64.dpreg.dp_3src.SMULH_64_dp_3src)
...
#### Execute (A64.dpreg.dp_3src.SMULH_64_dp_3src)
