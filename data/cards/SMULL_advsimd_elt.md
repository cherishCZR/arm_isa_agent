...
**Title**: SMULL, SMULL2 (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SMULL_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed multiply long (vector, by element)

**Description**:
This instruction
multiplies each vector element in the lower or upper half of the
first source SIMD&FP register
by the specified vector element of the
second source SIMD&FP register, places the result in a vector, and
...
The SMULL instruction extracts
vector elements from the lower half
of the first source register. The SMULL2 instruction extracts
...
|-----------------------------------------------|
| 0   Q   0   0   111 1   size L   M   Rm  1010 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SMULL_asimdelem_L)
...
#### Execute (A64.simd_dp.asimdelem.SMULL_asimdelem_L)
