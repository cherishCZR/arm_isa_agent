...
**Title**: SMULL, SMULL2 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `SMULL_advsimd_vec`
...
of each source register. The SMULL2 instruction extracts
...
- **Assembly**: `SMULL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  11   9   4  |
|-----------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  1100 00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.SMULL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.SMULL_asimddiff_L)
