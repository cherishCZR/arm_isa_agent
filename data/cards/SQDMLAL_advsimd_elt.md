...
**Title**: SQDMLAL, SQDMLAL2 (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SQDMLAL_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating doubling multiply-add long (by element)
...
|--------------------------------------------------|
| 01  0   1   111 1   size L   M   Rm  0   0   11  H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdelem.SQDMLAL_asisdelem_L)
...
#### Execute (A64.simd_dp.asisdelem.SQDMLAL_asisdelem_L)
...
|-----------------------------------------------------|
| 0   Q   0   0   111 1   size L   M   Rm  0   0   11  H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SQDMLAL_asimdelem_L)
...
- isa: `A64`
- source: `sqdmlal_advsimd_elt.xml`
</details>