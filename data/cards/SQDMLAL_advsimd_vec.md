...
**Title**: SQDMLAL, SQDMLAL2 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `SQDMLAL_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating doubling multiply-add long
...
of each source register. The SQDMLAL2 instruction extracts
...
|--------------------------------------------|
| 01  0   1   111 0   size 1   Rm  10  0   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisddiff.SQDMLAL_asisddiff_only)
...
#### Execute (A64.simd_dp.asisddiff.SQDMLAL_asisddiff_only)
...
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  10  0   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.SQDMLAL_asimddiff_L)
...
- isa: `A64`
- source: `sqdmlal_advsimd_vec.xml`
</details>