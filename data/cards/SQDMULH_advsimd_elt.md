...
**Title**: SQDMULH (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SQDMULH_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating doubling multiply returning high half (by element)
...
For rounded results, see SQRDMULH.
...
|-----------------------------------------------|
| 01  0   1   111 1   size L   M   Rm  110 0   H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdelem.SQDMULH_asisdelem_R)
...
#### Execute (A64.simd_dp.asisdelem.SQDMULH_asisdelem_R)
...
|--------------------------------------------------|
| 0   Q   0   0   111 1   size L   M   Rm  110 0   H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SQDMULH_asimdelem_R)
...
- isa: `A64`
- source: `sqdmulh_advsimd_elt.xml`
</details>