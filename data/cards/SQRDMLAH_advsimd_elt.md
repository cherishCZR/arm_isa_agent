...
**Title**: SQRDMLAH (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SQRDMLAH_advsimd_elt`

**Architecture**: `FEAT_RDM` (ARMv8.1)

**Summary**: Signed saturating rounding doubling multiply accumulate returning high half (by element)
...
### Variant: `Scalar`
- **Assembly**: `SQRDMLAH  <V><d>, <V><n>, <Vm>.<Ts>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20 19  15  13 12 11 10  9   4  |
|--------------------------------------------------|
| 01  1   1   111 1   size L   M   Rm  11  0   1   H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdelem.SQRDMLAH_asisdelem_R)
...
#### Execute (A64.simd_dp.asisdelem.SQRDMLAH_asisdelem_R)
...
### Variant: `Vector`
- **Assembly**: `SQRDMLAH  <Vd>.<T>, <Vn>.<T>, <Vm>.<Ts>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20 19  15  13 12 11 10  9   4  |
|-----------------------------------------------------|
| 0   Q   1   0   111 1   size L   M   Rm  11  0   1   H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SQRDMLAH_asimdelem_R)
...
- isa: `A64`
- source: `sqrdmlah_advsimd_elt.xml`
</details>