...
**Title**: SQRSHL -- A64 | **Class**: `advsimd` | **XML ID**: `SQRSHL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating rounding shift left (register)

**Description**:
This instruction takes each vector element in the first
...
The results are
rounded. For truncated results, see SQSHL.
...
|--------------------------------------------|
| 01  0   1   111 0   size 1   Rm  010 1   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.SQRSHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.SQRSHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  010 1   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SQRSHL_asimdsame_only)
