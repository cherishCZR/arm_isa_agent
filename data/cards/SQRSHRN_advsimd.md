...
**Title**: SQRSHRN, SQRSHRN2 -- A64 | **Class**: `advsimd` | **XML ID**: `SQRSHRN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating rounded shift right narrow (immediate)
...
The SQRSHRN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The SQRSHRN2 instruction writes the vector
...
|--------------------------------------|
| 01  0   1   111 10  ?   immb 1001 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SQRSHRN_asisdshf_N)
...
#### Execute (A64.simd_dp.asisdshf.SQRSHRN_asisdshf_N)
...
|-----------------------------------------|
| 0   Q   0   0   111 10  ?   immb 1001 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SQRSHRN_asimdshf_N)
