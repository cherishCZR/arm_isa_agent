...
**Title**: SQSHLU -- A64 | **Class**: `advsimd` | **XML ID**: `SQSHLU_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating shift left unsigned (immediate)

**Description**:
This instruction
reads each signed integer value in the vector of the
source SIMD&FP register, shifts each value by an immediate value,
saturates the shifted result to an unsigned integer value,
...
|-----------------------------------------|
| 01  1   1   111 10  ?   immb 011 0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SQSHLU_asisdshf_R)
...
constant boolean src_unsigned = FALSE;
constant boolean dst_unsigned = TRUE;
```

#### Execute (A64.simd_dp.asisdshf.SQSHLU_asisdshf_R)
...
|--------------------------------------------|
| 0   Q   1   0   111 10  ?   immb 011 0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SQSHLU_asimdshf_R)
