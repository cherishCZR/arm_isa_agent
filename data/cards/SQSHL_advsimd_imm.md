...
**Title**: SQSHL (immediate) -- A64 | **Class**: `advsimd` | **XML ID**: `SQSHL_advsimd_imm`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating shift left (immediate)

**Description**:
This instruction reads each vector element in the
source SIMD&FP register, shifts each result by an immediate value,
places the final result in a vector,
...
|-----------------------------------------|
| 01  0   1   111 10  ?   immb 011 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SQSHL_asisdshf_R)
...
constant boolean dst_unsigned = FALSE;
```

#### Execute (A64.simd_dp.asisdshf.SQSHL_asisdshf_R)
...
|--------------------------------------------|
| 0   Q   0   0   111 10  ?   immb 011 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SQSHL_asimdshf_R)
