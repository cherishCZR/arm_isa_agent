...
**Title**: SQSHL (register) -- A64 | **Class**: `advsimd` | **XML ID**: `SQSHL_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating shift left (register)
...
|--------------------------------------------|
| 01  0   1   111 0   size 1   Rm  010 0   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.SQSHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.SQSHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  010 0   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SQSHL_asimdsame_only)
