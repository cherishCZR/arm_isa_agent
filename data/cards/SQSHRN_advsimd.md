...
**Title**: SQSHRN, SQSHRN2 -- A64 | **Class**: `advsimd` | **XML ID**: `SQSHRN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating shift right narrow (immediate)
...
each vector element in the
 source SIMD&FP
register,
right shifts and truncates each result by an immediate value,
...
The SQSHRN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The SQSHRN2 instruction writes the vector
...
|--------------------------------------|
| 01  0   1   111 10  ?   immb 1001 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SQSHRN_asisdshf_N)
...
#### Execute (A64.simd_dp.asisdshf.SQSHRN_asisdshf_N)
...
|-----------------------------------------|
| 0   Q   0   0   111 10  ?   immb 1001 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SQSHRN_asimdshf_N)
