...
**Title**: SQSHRUN, SQSHRUN2 -- A64 | **Class**: `advsimd` | **XML ID**: `SQSHRUN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating shift right unsigned narrow (immediate)
...
The SQSHRUN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The SQSHRUN2 instruction writes the vector
...
|--------------------------------------|
| 01  1   1   111 10  ?   immb 1000 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SQSHRUN_asisdshf_N)
...
#### Execute (A64.simd_dp.asisdshf.SQSHRUN_asisdshf_N)
...
|-----------------------------------------|
| 0   Q   1   0   111 10  ?   immb 1000 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SQSHRUN_asimdshf_N)
