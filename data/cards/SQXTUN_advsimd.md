...
**Title**: SQXTUN, SQXTUN2 -- A64 | **Class**: `advsimd` | **XML ID**: `SQXTUN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed saturating extract unsigned narrow
...
The SQXTUN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The SQXTUN2 instruction writes the vector
...
|-----------------------------------|
| 01  1   1   111 0   size 10000 10010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.SQXTUN_asisdmisc_N)
...
#### Execute (A64.simd_dp.asisdmisc.SQXTUN_asisdmisc_N)
...
|--------------------------------------|
| 0   Q   1   0   111 0   size 10000 10010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.SQXTUN_asimdmisc_N)
