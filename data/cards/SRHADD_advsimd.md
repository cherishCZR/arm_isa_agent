...
**Title**: SRHADD -- A64 | **Class**: `advsimd` | **XML ID**: `SRHADD_advsimd`
...
|-----------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  00010 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SRHADD_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.SRHADD_asimdsame_only)
