...
**Title**: SRSHL -- A64 | **Class**: `advsimd` | **XML ID**: `SRSHL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed rounding shift left (register)
...
For a truncating shift, see SSHL.
...
### Variant: `Scalar`
- **Assembly**: `SRSHL  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  12 11 10  9   4  |
|--------------------------------------------|
| 01  0   1   111 0   11  1   Rm  010 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.SRSHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.SRSHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  010 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SRSHL_asimdsame_only)
