...
**Title**: SRSRA -- A64 | **Class**: `advsimd` | **XML ID**: `SRSRA_advsimd`
...
### Variant: `Scalar`
- **Assembly**: `SRSRA  D<d>, D<n>, #<shift>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24  22  18  15  13 12 11 10  9   4  |
|--------------------------------------------|
| 01  0   1   111 10  1xxx immb 00  1   1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.SRSRA_asisdshf_R)
...
#### Execute (A64.simd_dp.asisdshf.SRSRA_asisdshf_R)
...
|-----------------------------------------------|
| 0   Q   0   0   111 10  ?   immb 00  1   1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.SRSRA_asimdshf_R)
