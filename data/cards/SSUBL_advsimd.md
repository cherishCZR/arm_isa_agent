...
**Title**: SSUBL, SSUBL2 -- A64 | **Class**: `advsimd` | **XML ID**: `SSUBL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Signed subtract long

**Description**:
This instruction subtracts each
vector element in the lower or upper half of the second source SIMD&FP
register from the corresponding vector element
...
The SSUBL instruction extracts
each source vector from the lower half
of each source register. The SSUBL2 instruction extracts
...
- **Assembly**: `SSUBL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   0   0   111 0   size 1   Rm  00  1   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.SSUBL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.SSUBL_asimddiff_L)
