...
**Title**: ST1 (single structure) -- A64 | **Class**: `advsimd` | **XML ID**: `ST1_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Store a single-element structure from one lane of one register
...
### Variant: `No offset (ST1_asisdlso_B1_1b)` (8-bit)
...
|--------------------------------------|
| 0   Q   0011010 0   0   0000 0   xx0 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.ST1_asisdlso_B1_1b)
...
#### Postdecode (A64.ldst.asisdlso.ST1_asisdlso_B1_1b)
...
#### Execute (A64.ldst.asisdlso.ST1_asisdlso_B1_1b)
...
### Variant: `No offset (ST1_asisdlso_H1_1h)` (16-bit)
...
### Variant: `No offset (ST1_asisdlso_S1_1s)` (32-bit)
...
### Variant: `No offset (ST1_asisdlso_D1_1d)` (64-bit)
...
### Variant: `Post-index (ST1_asisdlsop_B1_i1b)` (8-bit, immediate offset)
...
|-----------------------------------|
| 0   Q   0011011 0   0   Rm  xx0 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.ST1_asisdlsop_B1_i1b)
...
### Variant: `Post-index (ST1_asisdlsop_BX1_r1b)` (8-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 000`
...
### Variant: `Post-index (ST1_asisdlsop_H1_i1h)` (16-bit, immediate offset)
...
### Variant: `Post-index (ST1_asisdlsop_HX1_r1h)` (16-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 010 && size == x0`
...
### Variant: `Post-index (ST1_asisdlsop_S1_i1s)` (32-bit, immediate offset)
...
### Variant: `Post-index (ST1_asisdlsop_SX1_r1s)` (32-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 100 && size == 00`
...
### Variant: `Post-index (ST1_asisdlsop_D1_i1d)` (64-bit, immediate offset)
...
### Variant: `Post-index (ST1_asisdlsop_DX1_r1d)` (64-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 100 && S == 0 && size == 01`
