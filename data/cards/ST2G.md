...
**Title**: ST2G -- A64 | **Class**: `general` | **XML ID**: `ST2G`

**Architecture**: `FEAT_MTE` (ARMv8.5)

**Summary**: Store Allocation Tags

**Description**:
This instruction stores an Allocation Tag to two Tag Granules of memory.
...
### Variant: `Post-index`
- **Assembly**: `ST2G  <Xt|SP>, [<Xn|SP>], #<simm>`
**Encoding Diagram (32-bit)**:

```text
| 31  27 26 25 24 23  21 20  11   9   4  |
|-----------------------------------|
| 1101 1   0   0   1   10  1   imm9 01  Rn  Rt  |
```

#### Decode (A64.ldst.ldsttags.ST2G_64Spost_ldsttags)
...
#### Execute (A64.ldst.ldsttags.ST2G_64Spost_ldsttags)
...
| 31  27 26 25 24 23  21 20  11   9   4  |
|-----------------------------------|
| 1101 1   0   0   1   10  1   imm9 11  Rn  Rt  |
```

#### Decode (A64.ldst.ldsttags.ST2G_64Spre_ldsttags)
...
| 31  27 26 25 24 23  21 20  11   9   4  |
|-----------------------------------|
| 1101 1   0   0   1   10  1   imm9 10  Rn  Rt  |
```

#### Decode (A64.ldst.ldsttags.ST2G_64Soffset_ldsttags)
