...
**Title**: ST2 (single structure) -- A64 | **Class**: `advsimd` | **XML ID**: `ST2_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Store single 2-element structure from one lane of two registers

**Description**:
This instruction stores a 2-element structure to memory from
corresponding elements of two SIMD&FP registers.
...
### Variant: `No offset (ST2_asisdlso_B2_2b)` (8-bit)
...
|--------------------------------------|
| 0   Q   0011010 0   1   0000 0   xx0 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.ST2_asisdlso_B2_2b)
...
#### Postdecode (A64.ldst.asisdlso.ST2_asisdlso_B2_2b)
...
#### Execute (A64.ldst.asisdlso.ST2_asisdlso_B2_2b)
...
### Variant: `No offset (ST2_asisdlso_H2_2h)` (16-bit)
...
### Variant: `No offset (ST2_asisdlso_S2_2s)` (32-bit)
...
### Variant: `No offset (ST2_asisdlso_D2_2d)` (64-bit)
...
### Variant: `Post-index (ST2_asisdlsop_B2_i2b)` (8-bit, immediate offset)
...
|-----------------------------------|
| 0   Q   0011011 0   1   Rm  xx0 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.ST2_asisdlsop_B2_i2b)
...
### Variant: `Post-index (ST2_asisdlsop_BX2_r2b)` (8-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 000`
...
### Variant: `Post-index (ST2_asisdlsop_H2_i2h)` (16-bit, immediate offset)
...
### Variant: `Post-index (ST2_asisdlsop_HX2_r2h)` (16-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 010 && size == x0`
...
### Variant: `Post-index (ST2_asisdlsop_S2_i2s)` (32-bit, immediate offset)
...
### Variant: `Post-index (ST2_asisdlsop_SX2_r2s)` (32-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 100 && size == 00`
...
### Variant: `Post-index (ST2_asisdlsop_D2_i2d)` (64-bit, immediate offset)
...
### Variant: `Post-index (ST2_asisdlsop_DX2_r2d)` (64-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 100 && S == 0 && size == 01`
