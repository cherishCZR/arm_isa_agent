...
**Title**: ST3 (multiple structures) -- A64 | **Class**: `advsimd` | **XML ID**: `ST3_advsimd_mult`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Store multiple 3-element structures from three registers

**Description**:
This instruction stores multiple 3-element structures to memory from three
SIMD&FP registers, with interleaving. Every element of each register is stored.
...
|-----------------------------------------|
| 0   Q   00  1   1   0   00  0   000000 0100 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlse.ST3_asisdlse_R3)
...
#### Postdecode (A64.ldst.asisdlse.ST3_asisdlse_R3)
...
### Variant: `Post-index (ST3_asisdlsep_I3_i)` (Immediate offset)
- **Condition**: `Rm == 11111`
...
|--------------------------------|
| 0   Q   0011001 0   0   Rm  0100 size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsep.ST3_asisdlsep_I3_i)
...
### Variant: `Post-index (ST3_asisdlsep_R3_r)` (Register offset)
- **Condition**: `Rm != 11111`
