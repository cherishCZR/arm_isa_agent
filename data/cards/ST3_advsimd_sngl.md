...
**Title**: ST3 (single structure) -- A64 | **Class**: `advsimd` | **XML ID**: `ST3_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Store single 3-element structure from one lane of three registers

**Description**:
This instruction stores a 3-element structure to memory from
corresponding elements of three SIMD&FP registers.
...
### Variant: `No offset (ST3_asisdlso_B3_3b)` (8-bit)
...
|--------------------------------------|
| 0   Q   0011010 0   0   0000 0   xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.ST3_asisdlso_B3_3b)
...
#### Postdecode (A64.ldst.asisdlso.ST3_asisdlso_B3_3b)
...
#### Execute (A64.ldst.asisdlso.ST3_asisdlso_B3_3b)
...
### Variant: `No offset (ST3_asisdlso_H3_3h)` (16-bit)
...
### Variant: `No offset (ST3_asisdlso_S3_3s)` (32-bit)
...
### Variant: `No offset (ST3_asisdlso_D3_3d)` (64-bit)
...
### Variant: `Post-index (ST3_asisdlsop_B3_i3b)` (8-bit, immediate offset)
...
|-----------------------------------|
| 0   Q   0011011 0   0   Rm  xx1 S   size Rn  Rt  |
```

#### Decode (A64.ldst.asisdlsop.ST3_asisdlsop_B3_i3b)
...
### Variant: `Post-index (ST3_asisdlsop_BX3_r3b)` (8-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 001`
...
### Variant: `Post-index (ST3_asisdlsop_H3_i3h)` (16-bit, immediate offset)
...
### Variant: `Post-index (ST3_asisdlsop_HX3_r3h)` (16-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 011 && size == x0`
...
### Variant: `Post-index (ST3_asisdlsop_S3_i3s)` (32-bit, immediate offset)
...
### Variant: `Post-index (ST3_asisdlsop_SX3_r3s)` (32-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && size == 00`
...
### Variant: `Post-index (ST3_asisdlsop_D3_i3d)` (64-bit, immediate offset)
...
### Variant: `Post-index (ST3_asisdlsop_DX3_r3d)` (64-bit, register offset)
- **Condition**: `Rm != 11111 && opcode == 101 && S == 0 && size == 01`
