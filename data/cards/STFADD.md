...
**Title**: STFADD, STFADDL -- A64 | **Class**: `advsimd` | **XML ID**: `STFADD`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic add in memory, without return
...
### Variant: `Floating-point (STFADD_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && R == 0`
- **Assembly**: `STFADD  <Hs>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  0   R   1   Rs  1   000 00  Rn  11111 |
```

#### Decode (A64.ldst.memop.STFADD_16)
...
#### Execute (A64.ldst.memop.STFADD_16)
...
### Variant: `Floating-point (STFADDL_16)` (Half-precision release)
- **Condition**: `size == 01 && R == 1`
- **Assembly**: `STFADDL  <Hs>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFADD_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && R == 0`
- **Assembly**: `STFADD  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFADDL_32)` (Single-precision release)
- **Condition**: `size == 10 && R == 1`
- **Assembly**: `STFADDL  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFADD_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && R == 0`
- **Assembly**: `STFADD  <Ds>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFADDL_64)` (Double-precision release)
- **Condition**: `size == 11 && R == 1`
- **Assembly**: `STFADDL  <Ds>, [<Xn|SP>]`
