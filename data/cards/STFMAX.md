...
**Title**: STFMAX, STFMAXL -- A64 | **Class**: `advsimd` | **XML ID**: `STFMAX`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic maximum in memory, without return
...
### Variant: `Floating-point (STFMAX_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && R == 0`
- **Assembly**: `STFMAX  <Hs>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  0   R   1   Rs  1   100 00  Rn  11111 |
```

#### Decode (A64.ldst.memop.STFMAX_16)
...
#### Execute (A64.ldst.memop.STFMAX_16)
...
### Variant: `Floating-point (STFMAXL_16)` (Half-precision release)
- **Condition**: `size == 01 && R == 1`
- **Assembly**: `STFMAXL  <Hs>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMAX_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && R == 0`
- **Assembly**: `STFMAX  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMAXL_32)` (Single-precision release)
- **Condition**: `size == 10 && R == 1`
- **Assembly**: `STFMAXL  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMAX_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && R == 0`
- **Assembly**: `STFMAX  <Ds>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMAXL_64)` (Double-precision release)
- **Condition**: `size == 11 && R == 1`
- **Assembly**: `STFMAXL  <Ds>, [<Xn|SP>]`
