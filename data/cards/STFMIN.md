...
**Title**: STFMIN, STFMINL -- A64 | **Class**: `advsimd` | **XML ID**: `STFMIN`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic minimum in memory, without return
...
### Variant: `Floating-point (STFMIN_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && R == 0`
- **Assembly**: `STFMIN  <Hs>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  0   R   1   Rs  1   101 00  Rn  11111 |
```

#### Decode (A64.ldst.memop.STFMIN_16)
...
#### Execute (A64.ldst.memop.STFMIN_16)
...
### Variant: `Floating-point (STFMINL_16)` (Half-precision release)
- **Condition**: `size == 01 && R == 1`
- **Assembly**: `STFMINL  <Hs>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMIN_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && R == 0`
- **Assembly**: `STFMIN  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINL_32)` (Single-precision release)
- **Condition**: `size == 10 && R == 1`
- **Assembly**: `STFMINL  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMIN_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && R == 0`
- **Assembly**: `STFMIN  <Ds>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINL_64)` (Double-precision release)
- **Condition**: `size == 11 && R == 1`
- **Assembly**: `STFMINL  <Ds>, [<Xn|SP>]`
