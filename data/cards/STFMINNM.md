...
**Title**: STFMINNM, STFMINNML -- A64 | **Class**: `advsimd` | **XML ID**: `STFMINNM`

**Architecture**: `FEAT_LSFE` (ARMv9.6)

**Summary**: Floating-point atomic minimum number in memory, without return
...
### Variant: `Floating-point (STFMINNM_16)` (Half-precision no memory ordering)
- **Condition**: `size == 01 && R == 0`
- **Assembly**: `STFMINNM  <Hs>, [<Xn|SP>]`
...
|-----------------------------------------|
| size 111 1   00  0   R   1   Rs  1   111 00  Rn  11111 |
```

#### Decode (A64.ldst.memop.STFMINNM_16)
...
#### Execute (A64.ldst.memop.STFMINNM_16)
...
### Variant: `Floating-point (STFMINNML_16)` (Half-precision release)
- **Condition**: `size == 01 && R == 1`
- **Assembly**: `STFMINNML  <Hs>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINNM_32)` (Single-precision no memory ordering)
- **Condition**: `size == 10 && R == 0`
- **Assembly**: `STFMINNM  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINNML_32)` (Single-precision release)
- **Condition**: `size == 10 && R == 1`
- **Assembly**: `STFMINNML  <Ss>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINNM_64)` (Double-precision no memory ordering)
- **Condition**: `size == 11 && R == 0`
- **Assembly**: `STFMINNM  <Ds>, [<Xn|SP>]`
...
### Variant: `Floating-point (STFMINNML_64)` (Double-precision release)
- **Condition**: `size == 11 && R == 1`
- **Assembly**: `STFMINNML  <Ds>, [<Xn|SP>]`
