...
**Title**: STL1 (SIMD&FP) -- A64 | **Class**: `advsimd` | **XML ID**: `STL1_advsimd_sngl`

**Architecture**: `FEAT_AdvSIMD && FEAT_LRCPC3` (FEAT_AdvSIMD && FEAT_LRCPC3)

**Summary**: Store-release a single-element structure from one lane of one register

**Description**:
This instruction stores the specified element of a SIMD&FP register
to memory.
...
### Variant: `64-bit`
- **Assembly**: `STL1  { <Vt>.D }[<index>], [<Xn|SP>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29  27 26 25 24  22 21 20  16 15  12 11   9   4  |
|--------------------------------------------------|
| 0   Q   00  1   1   0   10  0   0   0000 1   100 0   01  Rn  Rt  |
```

#### Decode (A64.ldst.asisdlso.STL1_asisdlso_D1)
...
#### Postdecode (A64.ldst.asisdlso.STL1_asisdlso_D1)
...
#### Execute (A64.ldst.asisdlso.STL1_asisdlso_D1)
