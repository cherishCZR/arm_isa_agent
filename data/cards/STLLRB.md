...
**Title**: STLLRB -- A64 | **Class**: `general` | **XML ID**: `STLLRB`

**Architecture**: `FEAT_LOR` (PROFILE_A)

**Summary**: Store LORelease register byte
...
### Variant: `No offset`
- **Assembly**: `STLLRB  <Wt>, [<Xn|SP>{, #0}]`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24  22 21 20  15 14   9   4  |
|-----------------------------------------|
| 00  00  1   0   0   01  0   0   (1)(1)(1)(1)(1) 0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstord.STLLRB_SL32_ldstord)
...
#### Execute (A64.ldst.ldstord.STLLRB_SL32_ldstord)
