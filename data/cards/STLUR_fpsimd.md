...
**Title**: STLUR (SIMD&FP) -- A64 | **Class**: `fpsimd` | **XML ID**: `STLUR_fpsimd`

**Architecture**: `FEAT_FP && FEAT_LRCPC3` (FEAT_FP && FEAT_LRCPC3)

**Summary**: Store-release SIMD&FP register (unscaled offset)

**Description**:
This instruction stores a single SIMD&FP register to memory. The address that is used for the store is
...
### Variant: `Unscaled offset (STLUR_B_ldapstl_simd)` (8-bit)
- **Condition**: `size == 00 && opc == 00`
- **Assembly**: `STLUR  <Bt>, [<Xn|SP>{, #<simm>}]`
...
|--------------------------|
| size 011101 x0  0   imm9 10  Rn  Rt  |
```

#### Decode (A64.ldst.ldapstl_simd.STLUR_B_ldapstl_simd)
...
#### Postdecode (A64.ldst.ldapstl_simd.STLUR_B_ldapstl_simd)
...
#### Execute (A64.ldst.ldapstl_simd.STLUR_B_ldapstl_simd)
...
### Variant: `Unscaled offset (STLUR_H_ldapstl_simd)` (16-bit)
- **Condition**: `size == 01 && opc == 00`
- **Assembly**: `STLUR  <Ht>, [<Xn|SP>{, #<simm>}]`
...
### Variant: `Unscaled offset (STLUR_S_ldapstl_simd)` (32-bit)
- **Condition**: `size == 10 && opc == 00`
- **Assembly**: `STLUR  <St>, [<Xn|SP>{, #<simm>}]`
...
### Variant: `Unscaled offset (STLUR_D_ldapstl_simd)` (64-bit)
- **Condition**: `size == 11 && opc == 00`
- **Assembly**: `STLUR  <Dt>, [<Xn|SP>{, #<simm>}]`
...
### Variant: `Unscaled offset (STLUR_Q_ldapstl_simd)` (128-bit)
- **Condition**: `size == 00 && opc == 10`
- **Assembly**: `STLUR  <Qt>, [<Xn|SP>{, #<simm>}]`
