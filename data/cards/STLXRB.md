...
**Title**: STLXRB -- A64 | **Class**: `general` | **XML ID**: `STLXRB`

**Summary**: Store-release exclusive register byte

**Description**:
This instruction
stores a byte from a 32-bit register
...
|-----------------------------------------|
| 00  00  1   0   0   00  0   0   Rs  1   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.STLXRB_SR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.STLXRB_SR32_ldstexclr)
