...
**Title**: STLXRH -- A64 | **Class**: `general` | **XML ID**: `STLXRH`

**Summary**: Store-release exclusive register halfword

**Description**:
This instruction
stores a halfword from a 32-bit register
to memory if the PE has
...
|-----------------------------------------|
| 01  00  1   0   0   00  0   0   Rs  1   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.STLXRH_SR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.STLXRH_SR32_ldstexclr)
