...
**Title**: STNP (SIMD&FP) -- A64 | **Class**: `fpsimd` | **XML ID**: `STNP_fpsimd`

**Architecture**: `FEAT_FP` (ARMv8.0)

**Summary**: Store pair of SIMD&FP registers, with non-temporal hint
...
### Variant: `Signed offset (STNP_S_ldstnapair_offs)` (32-bit)
- **Condition**: `opc == 00`
...
|-----------------------------|
| opc 101 1   000 0   imm7 Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstnapair_offs.STNP_S_ldstnapair_offs)

```
// Empty.
```

#### Postdecode (A64.ldst.ldstnapair_offs.STNP_S_ldstnapair_offs)
...
#### Execute (A64.ldst.ldstnapair_offs.STNP_S_ldstnapair_offs)
...
### Variant: `Signed offset (STNP_D_ldstnapair_offs)` (64-bit)
- **Condition**: `opc == 01`
...
### Variant: `Signed offset (STNP_Q_ldstnapair_offs)` (128-bit)
- **Condition**: `opc == 10`
