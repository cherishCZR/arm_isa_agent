...
**Title**: STTP -- A64 | **Class**: `general` | **XML ID**: `STTP_gen`

**Architecture**: `FEAT_LSUI` (ARMv9.6)

**Summary**: Store unprivileged pair of registers
...
### Variant: `Post-index`
- **Assembly**: `STTP  <Xt1>, <Xt2>, [<Xn|SP>], #<imm>`
**Encoding Diagram (32-bit)**:

```text
| 31  29  27 26 25 24  22 21  14   9   4  |
|-----------------------------------|
| 11  10  1   0   0   01  0   imm7 Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstpair_post.STTP_64_ldstpair_post)
...
#### Postdecode (A64.ldst.ldstpair_post.STTP_64_ldstpair_post)
...
#### Execute (A64.ldst.ldstpair_post.STTP_64_ldstpair_post)
...
| 31  29  27 26 25 24  22 21  14   9   4  |
|-----------------------------------|
| 11  10  1   0   0   11  0   imm7 Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstpair_pre.STTP_64_ldstpair_pre)
...
| 31  29  27 26 25 24  22 21  14   9   4  |
|-----------------------------------|
| 11  10  1   0   0   10  0   imm7 Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstpair_off.STTP_64_ldstpair_off)
