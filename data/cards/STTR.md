...
**Title**: STTR -- A64 | **Class**: `general` | **XML ID**: `STTR`

**Summary**: Store register (unprivileged)

**Description**:
This instruction stores a word or doubleword from a register to memory.
...
### Variant: `Unscaled offset (STTR_32_ldst_unpriv)` (32-bit)
- **Condition**: `size == 10`
...
|--------------------------------|
| 1x  111 0   00  00  0   imm9 10  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unpriv.STTR_32_ldst_unpriv)
...
#### Postdecode (A64.ldst.ldst_unpriv.STTR_32_ldst_unpriv)
...
#### Execute (A64.ldst.ldst_unpriv.STTR_32_ldst_unpriv)
...
### Variant: `Unscaled offset (STTR_64_ldst_unpriv)` (64-bit)
- **Condition**: `size == 11`
