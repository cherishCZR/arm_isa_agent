...
**Title**: STURB -- A64 | **Class**: `general` | **XML ID**: `STURB`

**Summary**: Store register byte (unscaled)
...
|--------------------------------------|
| 00  11  1   0   0   0   00  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unscaled.STURB_32_ldst_unscaled)

```
constant bits(64) offset = SignExtend(imm9, 64);
```

#### Postdecode (A64.ldst.ldst_unscaled.STURB_32_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.STURB_32_ldst_unscaled)
