...
**Title**: STUR (SIMD&FP) -- A64 | **Class**: `fpsimd` | **XML ID**: `STUR_fpsimd`

**Architecture**: `FEAT_FP` (ARMv8.0)

**Summary**: Store SIMD&FP register (unscaled offset)
...
### Variant: `Unscaled offset (STUR_B_ldst_unscaled)` (8-bit)
...
|--------------------------------|
| size 111 1   00  x0  0   imm9 00  Rn  Rt  |
```

#### Decode (A64.ldst.ldst_unscaled.STUR_B_ldst_unscaled)
...
#### Postdecode (A64.ldst.ldst_unscaled.STUR_B_ldst_unscaled)
...
#### Execute (A64.ldst.ldst_unscaled.STUR_B_ldst_unscaled)
...
### Variant: `Unscaled offset (STUR_H_ldst_unscaled)` (16-bit)
...
### Variant: `Unscaled offset (STUR_S_ldst_unscaled)` (32-bit)
...
### Variant: `Unscaled offset (STUR_D_ldst_unscaled)` (64-bit)
...
### Variant: `Unscaled offset (STUR_Q_ldst_unscaled)` (128-bit)
