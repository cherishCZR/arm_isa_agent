...
**Title**: STXP -- A64 | **Class**: `general` | **XML ID**: `STXP`

**Summary**: Store exclusive pair of registers
...
### Variant: `No offset (STXP_SP32_ldstexclp)` (32-bit)
- **Condition**: `sz == 0`
...
|--------------------------------|
| 1   sz  0010000 0   1   Rs  0   Rt2 Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclp.STXP_SP32_ldstexclp)
...
#### Execute (A64.ldst.ldstexclp.STXP_SP32_ldstexclp)
...
### Variant: `No offset (STXP_SP64_ldstexclp)` (64-bit)
- **Condition**: `sz == 1`
