...
**Title**: STXR -- A64 | **Class**: `general` | **XML ID**: `STXR`

**Summary**: Store exclusive register
...
### Variant: `No offset (STXR_SR32_ldstexclr)` (32-bit)
- **Condition**: `size == 10`
...
|-----------------------------|
| 1x  0010000 0   0   Rs  0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.STXR_SR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.STXR_SR32_ldstexclr)
...
### Variant: `No offset (STXR_SR64_ldstexclr)` (64-bit)
- **Condition**: `size == 11`
