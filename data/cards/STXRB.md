...
**Title**: STXRB -- A64 | **Class**: `general` | **XML ID**: `STXRB`

**Summary**: Store exclusive register byte

**Description**:
This instruction
stores a byte from a register to memory if the PE has
...
|-----------------------------------------|
| 00  00  1   0   0   00  0   0   Rs  0   (1)(1)(1)(1)(1) Rn  Rt  |
```

#### Decode (A64.ldst.ldstexclr.STXRB_SR32_ldstexclr)
...
#### Execute (A64.ldst.ldstexclr.STXRB_SR32_ldstexclr)
