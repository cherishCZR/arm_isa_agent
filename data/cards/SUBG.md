...
**Title**: SUBG -- A64 | **Class**: `general` | **XML ID**: `SUBG`

**Architecture**: `FEAT_MTE` (ARMv8.5)

**Summary**: Subtract with tag

**Description**:
This instruction subtracts an immediate value scaled by the Tag Granule from
...
### Variant: `Integer`
- **Assembly**: `SUBG  <Xd|SP>, <Xn|SP>, #<uimm6>, #<uimm4>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28  25  21  15  13   9   4  |
|--------------------------------|
| 1   1   0   100 0110 imm6 (0)(0) imm4 Rn  Rd  |
```

#### Decode (A64.dpimm.addsub_immtags.SUBG_64_addsub_immtags)
...
#### Execute (A64.dpimm.addsub_immtags.SUBG_64_addsub_immtags)
