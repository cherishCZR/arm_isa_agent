...
**Title**: SUBPS -- A64 | **Class**: `general` | **XML ID**: `SUBPS`

**Architecture**: `FEAT_MTE` (ARMv8.5)

**Summary**: Subtract pointer, setting flags
...
### Variant: `Integer`
- **Assembly**: `SUBPS  <Xd>, <Xn|SP>, <Xm|SP>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24  20  15   9   4  |
|--------------------------------|
| 1   0   1   1   101 0110 Rm  000000 Rn  Rd  |
```

#### Decode (A64.dpreg.dp_2src.SUBPS_64S_dp_2src)
...
#### Execute (A64.dpreg.dp_2src.SUBPS_64S_dp_2src)
