...
**Title**: SUBPT -- A64 | **Class**: `general` | **XML ID**: `SUBPT`

**Architecture**: `FEAT_CPA` (ARMv9.5)

**Summary**: Subtract checked pointer
...
### Variant: `Integer`
- **Assembly**: `SUBPT  <Xd|SP>, <Xn|SP>, <Xm>{, LSL #<amount>}`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24  20  15  12   9   4  |
|-----------------------------------|
| 1   1   0   1   101 0000 Rm  001 imm3 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_pt.SUBPT_64_addsub_pt)
...
#### Execute (A64.dpreg.addsub_pt.SUBPT_64_addsub_pt)
