...
**Title**: SUBS (extended register) -- A64 | **Class**: `general` | **XML ID**: `SUBS_addsub_ext`

**Summary**: Subtract extended and scaled register, setting flags
...
### Variant: `Setting the condition flags (SUBS_32S_addsub_ext)` (32-bit)
- **Condition**: `sf == 0`
...
|-----------------------------------|
| sf  1   1   01011 00  1   Rm  option imm3 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_ext.SUBS_32S_addsub_ext)
...
#### Execute (A64.dpreg.addsub_ext.SUBS_32S_addsub_ext)
...
### Variant: `Setting the condition flags (SUBS_64S_addsub_ext)` (64-bit)
- **Condition**: `sf == 1`
