...
**Title**: SUBS (shifted register) -- A64 | **Class**: `general` | **XML ID**: `SUBS_addsub_shift`

**Summary**: Subtract optionally-shifted register, setting flags
...
### Variant: `Setting the condition flags (SUBS_32_addsub_shift)` (32-bit)
- **Condition**: `sf == 0`
...
|--------------------------------|
| sf  1   1   01011 shift 0   Rm  imm6 Rn  Rd  |
```

#### Decode (A64.dpreg.addsub_shift.SUBS_32_addsub_shift)
...
#### Execute (A64.dpreg.addsub_shift.SUBS_32_addsub_shift)
...
### Variant: `Setting the condition flags (SUBS_64_addsub_shift)` (64-bit)
- **Condition**: `sf == 1`
