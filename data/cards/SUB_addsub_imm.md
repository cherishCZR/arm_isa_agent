...
**Title**: SUB (immediate) -- A64 | **Class**: `general` | **XML ID**: `SUB_addsub_imm`

**Summary**: Subtract immediate value
...
### Variant: `Not setting the condition flags (SUB_32_addsub_imm)` (32-bit)
- **Condition**: `sf == 0`
...
#### Decode (A64.dpimm.addsub_imm.SUB_32_addsub_imm)
...
#### Execute (A64.dpimm.addsub_imm.SUB_32_addsub_imm)
...
### Variant: `Not setting the condition flags (SUB_64_addsub_imm)` (64-bit)
- **Condition**: `sf == 1`
