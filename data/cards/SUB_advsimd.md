...
**Title**: SUB (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `SUB_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Subtract (vector)
...
### Variant: `Scalar`
- **Assembly**: `SUB  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  10  9   4  |
|--------------------------------------|
| 01  1   1   111 0   11  1   Rm  10000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.SUB_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.SUB_asisdsame_only)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  10000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.SUB_asimdsame_only)
