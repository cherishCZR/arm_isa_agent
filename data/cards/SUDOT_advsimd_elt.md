...
**Title**: SUDOT (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `SUDOT_advsimd_elt`

**Architecture**: `FEAT_I8MM` (PROFILE_A)

**Summary**: Dot product with signed and unsigned integers (vector, by element)
...
accumulating the result into the corresponding 32-bit element of the destination vector.
...
### Variant: `Vector`
- **Assembly**: `SUDOT  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.4B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23 22 21 20 19  15  11 10  9   4  |
|--------------------------------------------------|
| 0   Q   0   0   111 1   0   0   L   M   Rm  1111 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.SUDOT_asimdelem_D)
...
#### Execute (A64.simd_dp.asimdelem.SUDOT_asimdelem_D)
...
for e = 0 to elements-1
    ...
    for b = 0 to 3
        constant integer element1 = SInt(Elem[operand1, 4 * e + b, 8]);
        constant integer element2 = UInt(Elem[operand2, 4 * i + b, 8]);
