...
**Title**: TBL -- A64 | **Class**: `advsimd` | **XML ID**: `TBL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Table vector lookup
...
### Variant: `Advanced SIMD (TBL_asimdtbl_L1_1)` (Single register table)
- **Condition**: `len == 00`
...
|--------------------------------------|
| 0   Q   001110 00  0   Rm  0   len 0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdtbl.TBL_asimdtbl_L1_1)
...
#### Execute (A64.simd_dp.asimdtbl.TBL_asimdtbl_L1_1)
...
### Variant: `Advanced SIMD (TBL_asimdtbl_L2_2)` (Two register table)
- **Condition**: `len == 01`
...
### Variant: `Advanced SIMD (TBL_asimdtbl_L3_3)` (Three register table)
- **Condition**: `len == 10`
...
### Variant: `Advanced SIMD (TBL_asimdtbl_L4_4)` (Four register table)
- **Condition**: `len == 11`
