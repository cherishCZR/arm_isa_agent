...
**Title**: TRN1 -- A64 | **Class**: `advsimd` | **XML ID**: `TRN1_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Transpose vectors (primary)
...
|--------------------------------------------|
| 0   Q   00  111 0   size 0   Rm  0   0   10  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdperm.TRN1_asimdperm_only)
...
#### Execute (A64.simd_dp.asimdperm.TRN1_asimdperm_only)
