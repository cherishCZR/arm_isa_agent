...
**Title**: UABAL, UABAL2 -- A64 | **Class**: `advsimd` | **XML ID**: `UABAL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned absolute difference and accumulate long
...
- **Assembly**: `UABAL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  01  0   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.UABAL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.UABAL_asimddiff_L)
