...
**Title**: UABA -- A64 | **Class**: `advsimd` | **XML ID**: `UABA_advsimd`
...
of the results into the elements of the vector of the destination
SIMD&FP register.
...
|--------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  0111 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UABA_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.UABA_asimdsame_only)
