...
**Title**: UADDW, UADDW2 -- A64 | **Class**: `advsimd` | **XML ID**: `UADDW_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned add wide

**Description**:
This instruction adds the vector elements of the
...
The UADDW instruction extracts
vector elements
from the lower half
of the second source register. The UADDW2 instruction extracts
...
- **Assembly**: `UADDW{2}  <Vd>.<Ta>, <Vn>.<Ta>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  00  0   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.UADDW_asimddiff_W)
...
#### Execute (A64.simd_dp.asimddiff.UADDW_asimddiff_W)
