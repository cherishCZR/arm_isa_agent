...
**Title**: UHADD -- A64 | **Class**: `advsimd` | **XML ID**: `UHADD_advsimd`
...
The results are
truncated. For rounded results, see URHADD.
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  00000 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UHADD_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.UHADD_asimdsame_only)
