...
**Title**: UMAXV -- A64 | **Class**: `advsimd` | **XML ID**: `UMAXV_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned maximum across vector
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 11000 0   1010 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdall.UMAXV_asimdall_only)
...
#### Execute (A64.simd_dp.asimdall.UMAXV_asimdall_only)
