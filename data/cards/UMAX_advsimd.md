...
**Title**: UMAX -- A64 | **Class**: `advsimd` | **XML ID**: `UMAX_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned maximum (vector)

**Description**:
This instruction compares corresponding elements in the
vectors in the two source SIMD&FP registers,
places the larger of each pair of unsigned
integer values
...
|--------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  0110 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UMAX_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.UMAX_asimdsame_only)
