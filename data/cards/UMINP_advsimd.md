...
**Title**: UMINP -- A64 | **Class**: `advsimd` | **XML ID**: `UMINP_advsimd`
...
writes the smallest of each pair of unsigned integer values
...
|--------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  1010 1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UMINP_asimdsame_only)
...
#### Execute (A64.simd_dp.asimdsame.UMINP_asimdsame_only)
