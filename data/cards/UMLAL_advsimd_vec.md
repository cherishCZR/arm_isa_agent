...
**Title**: UMLAL, UMLAL2 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `UMLAL_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned multiply-add long (vector)

**Description**:
This instruction multiplies
the vector elements in the lower or upper half of the
first source SIMD&FP register by the corresponding vector elements
of the second source SIMD&FP register, and accumulates the results
...
The UMLAL instruction extracts
vector elements from the lower half
of the first source register. The UMLAL2 instruction extracts
...
- **Assembly**: `UMLAL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  10  0   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.UMLAL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.UMLAL_asimddiff_L)
