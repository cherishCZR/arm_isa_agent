...
**Title**: UMLSL, UMLSL2 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `UMLSL_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned multiply-subtract long (vector)
...
The UMLSL instruction extracts
each source vector from the lower half
of each source register. The UMLSL2 instruction extracts
...
- **Assembly**: `UMLSL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  10  1   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.UMLSL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.UMLSL_asimddiff_L)
