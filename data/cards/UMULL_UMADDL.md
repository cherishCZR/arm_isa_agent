## UMADDL `[ALIAS]`
_ARM A64 Instruction_ (Alias of umaddl.xml)

**Title**: UMULL -- A64 | **Class**: `general` | **XML ID**: `UMULL_UMADDL`

**Summary**: Unsigned multiply long
...
### Variant: `64-bit`
- **Assembly**: `UMULL  <Xd>, <Wn>, <Wm>`
- **Alias of**: `UMADDL  <Xd>, <Wn>, <Wm>, XZR`
...
|--------------------------------------|
| 1   00  1   101 1   1   01  Rm  0   11111 Rn  Rd  |
```
...
- alias_mnemonic: `UMULL`
- datatype: `64`
- isa: `A64`
- source: `umull_umaddl.xml`
</details>