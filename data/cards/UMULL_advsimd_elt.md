...
**Title**: UMULL, UMULL2 (by element) -- A64 | **Class**: `advsimd` | **XML ID**: `UMULL_advsimd_elt`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned multiply long (vector, by element)
...
second source SIMD&FP register, places the results in a vector, and
...
The UMULL instruction extracts
vector elements from the lower half
of the first source register. The UMULL2 instruction extracts
...
|-----------------------------------------------|
| 0   Q   1   0   111 1   size L   M   Rm  1010 H   0   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdelem.UMULL_asimdelem_L)
...
#### Execute (A64.simd_dp.asimdelem.UMULL_asimdelem_L)
...
integer element1;
constant integer element2 = UInt(Elem[operand2, index, esize]);
