...
**Title**: UMULL, UMULL2 (vector) -- A64 | **Class**: `advsimd` | **XML ID**: `UMULL_advsimd_vec`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned multiply long (vector)

**Description**:
This instruction multiplies corresponding vector elements
in the lower or upper half
of the two source SIMD&FP registers, places the result in a vector, and
...
of each source register. The UMULL2 instruction extracts
...
- **Assembly**: `UMULL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  11   9   4  |
|-----------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  1100 00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.UMULL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.UMULL_asimddiff_L)
