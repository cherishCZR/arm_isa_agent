...
**Title**: UQSHL (register) -- A64 | **Class**: `advsimd` | **XML ID**: `UQSHL_advsimd_reg`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned saturating shift left (register)

**Description**:
This instruction takes each element in the vector of the first
source SIMD&FP register, shifts the element by a value from the least
...
|--------------------------------------------|
| 01  1   1   111 0   size 1   Rm  010 0   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.UQSHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.UQSHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  010 0   1   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UQSHL_asimdsame_only)
