...
**Title**: UQSHRN, UQSHRN2 -- A64 | **Class**: `advsimd` | **XML ID**: `UQSHRN_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned saturating shift right narrow (immediate)
...
The UQSHRN instruction writes the vector
to the lower half of the
destination register and clears the upper half.
The UQSHRN2 instruction writes the vector
...
|--------------------------------------|
| 01  1   1   111 10  ?   immb 1001 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.UQSHRN_asisdshf_N)
...
#### Execute (A64.simd_dp.asisdshf.UQSHRN_asisdshf_N)
...
|-----------------------------------------|
| 0   Q   1   0   111 10  ?   immb 1001 0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.UQSHRN_asimdshf_N)
