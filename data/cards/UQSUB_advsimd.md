...
**Title**: UQSUB -- A64 | **Class**: `advsimd` | **XML ID**: `UQSUB_advsimd`
...
**Description**:
This instruction subtracts the element values of the second source SIMD&FP register
from the corresponding element values of the first source SIMD&FP register,
...
|--------------------------------------|
| 01  1   1   111 0   size 1   Rm  00101 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.UQSUB_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.UQSUB_asisdsame_only)
...
|-----------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  00101 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.UQSUB_asimdsame_only)
