...
**Title**: URSHL -- A64 | **Class**: `advsimd` | **XML ID**: `URSHL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned rounding shift left (register)
...
### Variant: `Scalar`
- **Assembly**: `URSHL  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  12 11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 0   11  1   Rm  010 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.URSHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.URSHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  010 1   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.URSHL_asimdsame_only)
