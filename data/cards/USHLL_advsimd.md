...
**Title**: USHLL, USHLL2 -- A64 | **Class**: `advsimd` | **XML ID**: `USHLL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned shift left long (immediate)
...
The USHLL instruction extracts
vector elements from the lower half
of the source register. The USHLL2 instruction extracts
...
|--------------------------------------|
| 0   Q   1   0   111 10  ?   immb 10100 1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.USHLL_asimdshf_L)
...
#### Execute (A64.simd_dp.asimdshf.USHLL_asimdshf_L)
