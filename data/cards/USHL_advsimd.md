...
**Title**: USHL -- A64 | **Class**: `advsimd` | **XML ID**: `USHL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned shift left (register)
...
For a rounding shift, see URSHL.
...
### Variant: `Scalar`
- **Assembly**: `USHL  D<d>, D<n>, D<m>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24 23  21 20  15  12 11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 0   11  1   Rm  010 0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdsame.USHL_asisdsame_only)
...
#### Execute (A64.simd_dp.asisdsame.USHL_asisdsame_only)
...
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  010 0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdsame.USHL_asimdsame_only)
