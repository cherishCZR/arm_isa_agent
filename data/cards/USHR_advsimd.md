...
**Title**: USHR -- A64 | **Class**: `advsimd` | **XML ID**: `USHR_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned shift right (immediate)
...
### Variant: `Scalar`
- **Assembly**: `USHR  D<d>, D<n>, #<shift>`
**Encoding Diagram (32-bit)**:

```text
| 31  29 28 27  24  22  18  15  13 12 11 10  9   4  |
|--------------------------------------------|
| 01  1   1   111 10  1xxx immb 00  0   0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdshf.USHR_asisdshf_R)
...
#### Execute (A64.simd_dp.asisdshf.USHR_asisdshf_R)
...
|-----------------------------------------------|
| 0   Q   1   0   111 10  ?   immb 00  0   0   0   1   Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdshf.USHR_asimdshf_R)
