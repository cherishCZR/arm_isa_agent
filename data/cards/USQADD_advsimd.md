...
**Title**: USQADD -- A64 | **Class**: `advsimd` | **XML ID**: `USQADD_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned saturating accumulate of signed value

**Description**:
This instruction adds the signed integer values
of the vector elements in the source SIMD&FP register to corresponding
unsigned integer values of the vector elements in the
destination SIMD&FP register, and accumulates the resulting unsigned integer values
with the vector elements of
...
|-----------------------------------|
| 01  1   1   111 0   size 10000 00011 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asisdmisc.USQADD_asisdmisc_R)
...
#### Execute (A64.simd_dp.asisdmisc.USQADD_asisdmisc_R)
...
for e = 0 to elements-1
    op1 = SInt(Elem[operand, e, esize]);
    op2 = UInt(Elem[operand2, e, esize]);
...
|--------------------------------------|
| 0   Q   1   0   111 0   size 10000 00011 10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdmisc.USQADD_asimdmisc_R)
