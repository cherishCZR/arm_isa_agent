...
**Title**: USUBL, USUBL2 -- A64 | **Class**: `advsimd` | **XML ID**: `USUBL_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned subtract long

**Description**:
This instruction subtracts each vector element
in the lower or upper half of the second source SIMD&FP
...
The USUBL instruction extracts
each source vector from the lower half
of each source register. The USUBL2 instruction extracts
...
- **Assembly**: `USUBL{2}  <Vd>.<Ta>, <Vn>.<Tb>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  00  1   0   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.USUBL_asimddiff_L)
...
#### Execute (A64.simd_dp.asimddiff.USUBL_asimddiff_L)
