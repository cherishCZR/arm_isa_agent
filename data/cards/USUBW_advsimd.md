...
**Title**: USUBW, USUBW2 -- A64 | **Class**: `advsimd` | **XML ID**: `USUBW_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unsigned subtract wide

**Description**:
This instruction subtracts each vector element in the lower or upper half
of the second source SIMD&FP register from the corresponding vector element
in the first source SIMD&FP register, places the result in a vector,
...
The USUBW instruction extracts
vector elements from the lower half of the second source register.
The USUBW2 instruction extracts
vector elements from the upper half of the second source register.
...
- **Assembly**: `USUBW{2}  <Vd>.<Ta>, <Vn>.<Ta>, <Vm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28 27  24 23  21 20  15  13 12 11   9   4  |
|-----------------------------------------------|
| 0   Q   1   0   111 0   size 1   Rm  00  1   1   00  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimddiff.USUBW_asimddiff_W)
...
#### Execute (A64.simd_dp.asimddiff.USUBW_asimddiff_W)
