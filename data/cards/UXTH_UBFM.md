...
**Title**: UXTH -- A64 | **Class**: `general` | **XML ID**: `UXTH_UBFM`

**Summary**: Unsigned extend halfword

**Description**:
This instruction extracts a 16-bit value from a register,
zero-extends it to the size of the register, and writes the result to the destination register.

### Variant: `With zeros to left and right` (32-bit)
- **Assembly**: `UXTH  <Wd>, <Wn>`
- **Alias of**: `UBFM  <Wd>, <Wn>, #0, #15`
...
|-----------------------------|
| 0   10  100 110 0   000000 001111 Rn  Rd  |
```
