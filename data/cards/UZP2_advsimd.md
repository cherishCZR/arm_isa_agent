...
**Title**: UZP2 -- A64 | **Class**: `advsimd` | **XML ID**: `UZP2_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Unzip vectors (secondary)
...
|--------------------------------------------|
| 0   Q   00  111 0   size 0   Rm  0   1   01  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdperm.UZP2_asimdperm_only)
...
#### Execute (A64.simd_dp.asimdperm.UZP2_asimdperm_only)
