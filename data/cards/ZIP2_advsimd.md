...
**Title**: ZIP2 -- A64 | **Class**: `advsimd` | **XML ID**: `ZIP2_advsimd`

**Architecture**: `FEAT_AdvSIMD` (ARMv8.0)

**Summary**: Zip vectors (secondary)

**Description**:
This instruction reads
adjacent
vector elements from the upper half
of two source SIMD&FP registers
as pairs,
...
|--------------------------------------------|
| 0   Q   00  111 0   size 0   Rm  0   1   11  10  Rn  Rd  |
```

#### Decode (A64.simd_dp.asimdperm.ZIP2_asimdperm_only)
...
#### Execute (A64.simd_dp.asimdperm.ZIP2_asimdperm_only)
