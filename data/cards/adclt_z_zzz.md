...
**Title**: ADCLT -- A64 | **Class**: `sve2` | **XML ID**: `adclt_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Add with carry long (top)

**Description**:
Add the odd-numbered elements of the first
...
### Variant: `SVE2`
- **Assembly**: `ADCLT  <Zda>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  13  10  9   4  |
|--------------------------------------|
| 010 0010 1   0   sz  0   Zm  11  010 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_adc_long.adclt_z_zzz_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_adc_long.adclt_z_zzz_)
