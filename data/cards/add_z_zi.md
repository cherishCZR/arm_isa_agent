...
**Title**: ADD (immediate) -- A64 | **Class**: `sve` | **XML ID**: `add_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Add immediate (unpredicated)

**Description**:
Add an unsigned immediate to
...
### Variant: `SVE`
- **Assembly**: `ADD  <Zdn>.<T>, <Zdn>.<T>, #<imm>{, <shift>}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  13 12   4  |
|-----------------------------------|
| 001 0010 1   size 1   00  000 11  sh  imm8 Zdn |
```

#### Decode (A64.sve.sve_wideimm_unpred.sve_int_arith_imm0.add_z_zi_)
...
#### Execute (A64.sve.sve_wideimm_unpred.sve_int_arith_imm0.add_z_zi_)
