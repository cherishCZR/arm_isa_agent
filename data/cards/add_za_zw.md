...
**Title**: ADD (array accumulators) -- A64 | **Class**: `mortlach2` | **XML ID**: `add_za_zw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Add multi-vector to ZA array vector accumulators

**Description**:
This instruction destructively adds all elements of the two or four source vectors to
...
- **Assembly**: `ADD  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zm1>.<T>-<Zm2>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  18  16  14  12   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  sz  1   00  00  00  Rv  111 Zm  0   1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_int_mm.add_za_zw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_int_mm.add_za_zw_2x2)
...
- **Assembly**: `ADD  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zm1>.<T>-<Zm4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  18  16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  sz  1   00  00  10  Rv  111 Zm  00  1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_int_mm.add_za_zw_4x4)
