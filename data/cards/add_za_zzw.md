...
**Title**: ADD (array results, multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `add_za_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Add multi-vector to multi-vector with ZA array vector results

**Description**:
This instruction adds all corresponding elements of the two or four second
source vectors and
...
- **Assembly**: `ADD  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zn1>.<T>-<Zn2>.<T> }, { <Zm1>.<T>-<Zm2>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  |
|-----------------------------------------------|
| 1   10  0000 11  sz  1   Zm  00  Rv  110 Zn  0   1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_int_mm.add_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_int_mm.add_za_zzw_2x2)
...
- **Assembly**: `ADD  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zn1>.<T>-<Zn4>.<T> }, { <Zm1>.<T>-<Zm4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  sz  1   Zm  0   10  Rv  110 Zn  00  1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_int_mm.add_za_zzw_4x4)
