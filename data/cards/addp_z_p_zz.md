...
**Title**: ADDP -- A64 | **Class**: `sve2` | **XML ID**: `addp_z_p_zz`
...
**Description**:
This instruction adds pairs of adjacent elements within each source vector,
and destructively places the interleaved results in the first source vector.

**Attributes**: Predicated; DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE2`
- **Assembly**: `ADDP  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  13 12   9   4  |
|-----------------------------------------|
| 010 0010 0   size 0   10  00  1   10  1   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_arith_binary_pairs.addp_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_arith_binary_pairs.addp_z_p_zz_)
