...
**Title**: ADDPT (unpredicated) -- A64 | **Class**: `sve2` | **XML ID**: `addpt_z_zz`

**Architecture**: `FEAT_SVE && FEAT_CPA` (FEAT_SVE && FEAT_CPA)

**Summary**: Add checked pointer vectors (unpredicated)

**Description**:
Add with pointer check all elements of the second source vector to
corresponding elements of the first source vector and place the results
in the corresponding elements of the destination vector. This
...
### Variant: `SVE2`
- **Assembly**: `ADDPT  <Zd>.D, <Zn>.D, <Zm>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12   9   4  |
|--------------------------------|
| 000 0010 0   11  1   Zm  000 010 Zn  Zd  |
```

#### Decode (A64.sve.sve_int_unpred_arit.sve_int_bin_cons_arit_0.addpt_z_zz_)
...
#### Execute (A64.sve.sve_int_unpred_arit.sve_int_bin_cons_arit_0.addpt_z_zz_)
