...
**Title**: ADDQV -- A64 | **Class**: `sve2` | **XML ID**: `addqv_z_p_z`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Add reduction of quadword vector segments

**Description**:
Addition of the same element numbers from each 128-bit source vector segment,
...
### Variant: `SVE2`
- **Assembly**: `ADDQV  <Vd>.<T>, <Pg>, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  17 16 15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   001 0   1   001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_int_pred_red.sve_int_reduce_0q.addqv_z_p_z_)
...
#### Execute (A64.sve.sve_int_pred_red.sve_int_reduce_0q.addqv_z_p_z_)
...
for e = 0 to elempersegment-1
    ...
    for s = 0 to segments-1
        if ActivePredicateElement(mask, s * elempersegment + e, esize) then
            ...
            dtmp = dtmp + UInt(Elem[stmp, e, esize]);
