...
**Title**: ADDSVL -- A64 | **Class**: `mortlach` | **XML ID**: `addsvl_r_ri`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Add multiple of Streaming SVE vector register size to scalar register

**Description**:
This instruction adds the Streaming SVE vector register size in bytes multiplied by
...
### Variant: `SME`
- **Assembly**: `ADDSVL  <Xd|SP>, <Xn|SP>, #<imm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  11 10   4  |
|-----------------------------------|
| 000 0010 0   0   0   1   Rn  0101 1   imm6 Rd  |
```

#### Decode (A64.sve.sve_alloca.sve_int_arith_svl.addsvl_r_ri_)
...
#### Execute (A64.sve.sve_alloca.sve_int_arith_svl.addsvl_r_ri_)
