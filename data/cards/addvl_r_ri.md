...
**Title**: ADDVL -- A64 | **Class**: `sve` | **XML ID**: `addvl_r_ri`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Add multiple of vector register size to scalar register

**Description**:
Add the current vector register size in bytes multiplied by
an immediate in the range -32 to 31 to the 64-bit
source general-purpose register or current stack pointer, and
place the result in the 64-bit destination general-purpose
register or current stack pointer.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE`
- **Assembly**: `ADDVL  <Xd|SP>, <Xn|SP>, #<imm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  11 10   4  |
|-----------------------------------|
| 000 0010 0   0   0   1   Rn  0101 0   imm6 Rd  |
```

#### Decode (A64.sve.sve_alloca.sve_int_arith_vl.addvl_r_ri_)
...
#### Execute (A64.sve.sve_alloca.sve_int_arith_vl.addvl_r_ri_)
