...
**Title**: AND (predicates) -- A64 | **Class**: `sve` | **XML ID**: `and_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise AND predicates
...
- **Assembly**: `AND  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.and_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.and_p_p_pp_z)
