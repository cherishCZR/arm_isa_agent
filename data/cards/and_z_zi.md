...
**Title**: AND (immediate) -- A64 | **Class**: `sve` | **XML ID**: `and_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise AND with immediate (unpredicated)

**Description**:
Bitwise AND an immediate with
...
### Variant: `SVE`
- **Assembly**: `AND  <Zdn>.<T>, <Zdn>.<T>, #<const>`
...
#### Decode (A64.sve.sve_maskimm.sve_int_log_imm.and_z_zi_)
...
#### Execute (A64.sve.sve_maskimm.sve_int_log_imm.and_z_zi_)
