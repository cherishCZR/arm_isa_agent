...
**Title**: ANDS -- A64 | **Class**: `sve` | **XML ID**: `ands_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise AND predicates, setting the condition flags

**Description**:
Bitwise AND active elements of the second source predicate with
...
- **Assembly**: `ANDS  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.ands_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.ands_p_p_pp_z)
