...
**Title**: ASR (wide elements, predicated) -- A64 | **Class**: `sve` | **XML ID**: `asr_z_p_zw`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Arithmetic shift right by 64-bit wide elements (predicated)
...
### Variant: `SVE`
- **Assembly**: `ASR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   11  0   0   0   100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_2.asr_z_p_zw_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_2.asr_z_p_zw_)
