...
**Title**: BF1CVTL, BF2CVTL -- A64 | **Class**: `mortlach2` | **XML ID**: `bf1cvtl_mz2_z8`

**Architecture**: `FEAT_SME2 && FEAT_FP8` (FEAT_SME2 && FEAT_FP8)

**Summary**: Multi-vector convert from 8-bit floating-point to deinterleaved BFloat16
...
of the destination vectors. BF1CVTL scales the values by 2-UInt(FPMR.LSCALE[5:0]).
BF2CVTL scales the values by 2-UInt(FPMR.LSCALE2[5:0]).
...
### Variant: `BF1CVTL`
- **Assembly**: `BF1CVTL  { <Zd1>.H-<Zd2>.H }, <Zn>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   01  1   001 10  111000 Zn  Zd  1   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.bf1cvtl_mz2_z8_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.bf1cvtl_mz2_z8_)
...
for p = 0 to pairs-1
    ...
    Elem[result1, p, 16] = FP8ConvertBF(element1, issrc2, FPCR, FPMR);
    Elem[result2, p, 16] = FP8ConvertBF(element2, issrc2, FPCR, FPMR);
...
### Variant: `BF2CVTL`
- **Assembly**: `BF2CVTL  { <Zd1>.H-<Zd2>.H }, <Zn>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   11  1   001 10  111000 Zn  Zd  1   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.bf2cvtl_mz2_z8_)
