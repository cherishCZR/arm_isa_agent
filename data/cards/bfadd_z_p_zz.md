...
**Title**: BFADD (predicated) -- A64 | **Class**: `sve2` | **XML ID**: `bfadd_z_p_zz`

**Architecture**: `FEAT_SVE_B16B16` (ARMv9.4)

**Summary**: BFloat16 add vectors (predicated)

**Description**:
Add active BFloat16 elements of the second source vector to
...
### Variant: `SVE2`
- **Assembly**: `BFADD  <Zdn>.H, <Pg>/M, <Zdn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   00  0   0   0000 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfadd_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfadd_z_p_zz_)
