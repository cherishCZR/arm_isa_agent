...
**Title**: BFADD (unpredicated) -- A64 | **Class**: `sve2` | **XML ID**: `bfadd_z_zz`

**Architecture**: `FEAT_SVE_B16B16` (ARMv9.4)

**Summary**: BFloat16 add vectors (unpredicated)

**Description**:
Add all BFloat16 elements of the second source vector to corresponding
...
### Variant: `SVE2`
- **Assembly**: `BFADD  <Zd>.H, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12   9   4  |
|--------------------------------|
| 011 0010 1   00  0   Zm  000 000 Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unpred.sve_fp_3op_u_zd.bfadd_z_zz_)
...
#### Execute (A64.sve.sve_fp_unpred.sve_fp_3op_u_zd.bfadd_z_zz_)
