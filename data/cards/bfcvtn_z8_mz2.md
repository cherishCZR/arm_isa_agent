...
**Title**: BFCVTN -- A64 | **Class**: `sve2` | **XML ID**: `bfcvtn_z8_mz2`

**Architecture**: `(FEAT_SVE2 || FEAT_SME2) && FEAT_FP8` ((FEAT_SVE2 || FEAT_SME2) && FEAT_FP8)

**Summary**: BFloat16 convert, narrow and interleave to 8-bit floating-point

**Description**:
Convert each BFloat16 element of the group of two source vectors to 8-bit
...
### Variant: `SVE2`
- **Assembly**: `BFCVTN  <Zd>.B, { <Zn1>.H-<Zn2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  11   9   5  4  |
|-----------------------------------|
| 011 0010 1   00  001 010 0011 10  Zn  0   Zd  |
```

#### Decode (A64.sve.sve_fp_unary_unpred.sve_fp8_fcvt_narrow.bfcvtn_z8_mz2_bf2b)
...
#### Execute (A64.sve.sve_fp_unary_unpred.sve_fp8_fcvt_narrow.bfcvtn_z8_mz2_bf2b)
...
for e = 0 to elements-1
    ...
    Elem[result, 2*e + 0, 8] = BFConvertFP8(element1, FPCR, FPMR);
    Elem[result, 2*e + 1, 8] = BFConvertFP8(element2, FPCR, FPMR);
