...
**Title**: BFCVTN -- A64 | **Class**: `mortlach2` | **XML ID**: `bfcvtn_z_mz2`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector convert from single-precision to interleaved BFloat16 format

**Description**:
This instruction converts each element of the
two source vectors from single-precision to BFloat16 floating-point, and places the two-way interleaved results
...
### Variant: `SME2`
- **Assembly**: `BFCVTN  <Zd>.H, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   5  4  |
|-----------------------------------------|
| 1   10  0000 1   0   1   1   000 00  111000 Zn  1   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp_cvrt.bfcvtn_z_mz2_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp_cvrt.bfcvtn_z_mz2_)
