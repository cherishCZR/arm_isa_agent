...
**Title**: BFDOT (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfdot_za_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector BFloat16 dot-product

**Description**:
This instruction computes the dot product of a pair of BF16 values held in the corresponding 32-bit
elements of the two or four first and second
source vectors. The single-precision dot product
...
- **Assembly**: `BFDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5   3  2  |
|--------------------------------------------|
| 1   10  0000 11  0   1   Zm  00  Rv  100 Zn  01  0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_fpdot_mm.bfdot_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_fpdot_mm.bfdot_za_zzw_2x2)
...
- **Assembly**: `BFDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6  5   3  2  |
|--------------------------------------------------|
| 1   10  0000 11  0   1   Zm  0   10  Rv  100 Zn  0   01  0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_fpdot_mm.bfdot_za_zzw_4x4)
