...
**Title**: BFMAX (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmax_mz_zzv`

**Architecture**: `FEAT_SME2 && FEAT_SVE_B16B16` (FEAT_SME2 && FEAT_SVE_B16B16)

**Summary**: Multi-vector BFloat16 maximum by vector

**Description**:
This instruction determines the maximum  of
...
- **Assembly**: `BFMAX  { <Zdn1>.H-<Zdn2>.H }, { <Zdn1>.H-<Zdn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   0 |
|--------------------------------------------|
| 1   10  0000 1   00  10  Zm  10100 0   01  00  0   Zdn 0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.bfmax_mz_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.bfmax_mz_zzv_2x1)
...
for r = 0 to nreg-1
    ...
    for e = 0 to elements-1
        ...
        Elem[results[r], e, 16] = BFMax(element1, element2, FPCR);
...
- **Assembly**: `BFMAX  { <Zdn1>.H-<Zdn4>.H }, { <Zdn1>.H-<Zdn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 1   00  10  Zm  10101 0   01  00  0   Zdn 0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2b.mortlach_multi4_z_z_fminmax_sm.bfmax_mz_zzv_4x1)
