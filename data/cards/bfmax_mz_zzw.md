...
**Title**: BFMAX (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmax_mz_zzw`

**Architecture**: `FEAT_SME2 && FEAT_SVE_B16B16` (FEAT_SME2 && FEAT_SVE_B16B16)

**Summary**: Multi-vector BFloat16 maximum
...
- **Assembly**: `BFMAX  { <Zdn1>.H-<Zdn2>.H }, { <Zdn1>.H-<Zdn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16   9   6   4   0 |
|--------------------------------------|
| 1   10  0000 1   00  1   Zm  0101100 010 00  Zdn 0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_fminmax_mm.bfmax_mz_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_fminmax_mm.bfmax_mz_zzw_2x2)
...
- **Assembly**: `BFMAX  { <Zdn1>.H-<Zdn4>.H }, { <Zdn1>.H-<Zdn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17   9   6   4   1  0 |
|-----------------------------------------|
| 1   10  0000 1   00  1   Zm  00101110 010 00  Zdn 0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2d0.mortlach_multi4_z_z_fminmax_mm.bfmax_mz_zzw_4x4)
