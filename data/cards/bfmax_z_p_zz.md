...
**Title**: BFMAX -- A64 | **Class**: `sve2` | **XML ID**: `bfmax_z_p_zz`

**Architecture**: `FEAT_SVE_B16B16` (ARMv9.4)

**Summary**: BFloat16 maximum (predicated)

**Description**:
Determine the maximum of active BFloat16 elements of the second source vector and
...
### Variant: `SVE2`
- **Assembly**: `BFMAX  <Zdn>.H, <Pg>/M, <Zdn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   00  0   0   0110 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfmax_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfmax_z_p_zz_)
