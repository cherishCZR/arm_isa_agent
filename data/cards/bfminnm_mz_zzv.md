...
**Title**: BFMINNM (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfminnm_mz_zzv`

**Architecture**: `FEAT_SME2 && FEAT_SVE_B16B16` (FEAT_SME2 && FEAT_SVE_B16B16)

**Summary**: Multi-vector BFloat16 minimum number by vector

**Description**:
This instruction determines the minimum number value of
...
- **Assembly**: `BFMINNM  { <Zdn1>.H-<Zdn2>.H }, { <Zdn1>.H-<Zdn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   0 |
|--------------------------------------------|
| 1   10  0000 1   00  10  Zm  10100 0   01  00  1   Zdn 1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.bfminnm_mz_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.bfminnm_mz_zzv_2x1)
...
- **Assembly**: `BFMINNM  { <Zdn1>.H-<Zdn4>.H }, { <Zdn1>.H-<Zdn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 1   00  10  Zm  10101 0   01  00  1   Zdn 0   1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2b.mortlach_multi4_z_z_fminmax_sm.bfminnm_mz_zzv_4x1)
