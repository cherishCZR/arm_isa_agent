...
**Title**: BFMLALB (indexed) -- A64 | **Class**: `sve` | **XML ID**: `bfmlalb_z_zzzi`

**Architecture**: `(FEAT_SVE || FEAT_SME) && FEAT_BF16` ((FEAT_SVE || FEAT_SME) && FEAT_BF16)

**Summary**: BFloat16 multiply-add long to single-precision (bottom, indexed)
...
### Variant: `SVE`
- **Assembly**: `BFMLALB  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  13 12 11 10  9   4  |
|-----------------------------------------------|
| 011 0010 0   1   1   1   i3h Zm  01  0   0   i3l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.bfmlalb_z_zzzi_)
...
#### Execute (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.bfmlalb_z_zzzi_)
