...
**Title**: BFMLALT (vectors) -- A64 | **Class**: `sve` | **XML ID**: `bfmlalt_z_zzz`

**Architecture**: `(FEAT_SVE || FEAT_SME) && FEAT_BF16` ((FEAT_SVE || FEAT_SME) && FEAT_BF16)

**Summary**: BFloat16 multiply-add long to single-precision (top)
...
### Variant: `SVE`
- **Assembly**: `BFMLALT  <Zda>.S, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  13 12  10  9   4  |
|-----------------------------------------|
| 011 0010 0   1   1   1   Zm  10  0   00  1   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w.sve_fp_fma_long.bfmlalt_z_zzz_)
...
#### Execute (A64.sve.sve_fp_fma_w.sve_fp_fma_long.bfmlalt_z_zzz_)
