...
**Title**: BFMLS (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `bfmls_z_p_zzz`

**Architecture**: `FEAT_SVE_B16B16` (ARMv9.4)

**Summary**: BFloat16 fused multiply-subtract vectors
...
### Variant: `SVE2`
- **Assembly**: `BFMLS  <Zda>.H, <Pg>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 011 0010 1   00  1   Zm  0   0   1   Pg  Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_a.bfmls_z_p_zzz_)
...
#### Execute (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_a.bfmls_z_p_zzz_)
