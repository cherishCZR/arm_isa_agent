...
**Title**: BFMLS (multiple and indexed vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmls_za_zzi`

**Architecture**: `FEAT_SME_B16B16` (ARMv9.4)

**Summary**: Multi-vector BFloat16 fused multiply-subtract by indexed element
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   00  01  Zm  0   Rv  1   i3h Zn  1   1   i3l off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_h.bfmls_za_zzi_h2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_h.bfmls_za_zzi_h2xi)
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   00  01  Zm  1   Rv  1   i3h Zn  0   1   1   i3l off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_h.bfmls_za_zzi_h4xi)
