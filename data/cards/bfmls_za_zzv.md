...
**Title**: BFMLS (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmls_za_zzv`

**Architecture**: `FEAT_SME_B16B16` (ARMv9.4)

**Summary**: Multi-vector BFloat16 fused multiply-subtract by vector
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  1   10  Zm  0   Rv  111 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_f16_sm.bfmls_za_zzv_2x1_16)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_f16_sm.bfmls_za_zzv_2x1_16)
...
for r = 0 to nreg-1
    ...
    for e = 0 to elements-1
        constant bits(16) elem1 = BFNeg(Elem[op1, e, 16]);
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  1   11  Zm  0   Rv  111 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_f16_sm.bfmls_za_zzv_4x1_16)
