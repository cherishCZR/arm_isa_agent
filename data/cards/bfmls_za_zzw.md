...
**Title**: BFMLS (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmls_za_zzw`

**Architecture**: `FEAT_SME_B16B16` (ARMv9.4)

**Summary**: Multi-vector BFloat16 fused multiply-subtract
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  |
|-----------------------------------------------|
| 1   10  0000 11  1   1   Zm  00  Rv  100 Zn  0   1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_f16_mm.bfmls_za_zzw_2x2_16)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_f16_mm.bfmls_za_zzw_2x2_16)
...
- **Assembly**: `BFMLS  ZA.H[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  1   1   Zm  0   10  Rv  100 Zn  00  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_f16_mm.bfmls_za_zzw_4x4_16)
