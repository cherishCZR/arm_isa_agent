...
**Title**: BFMLSLB (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `bfmlslb_z_zzz`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: BFloat16 multiply-subtract long from single-precision (bottom)
...
### Variant: `SVE2`
- **Assembly**: `BFMLSLB  <Zda>.S, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  13 12  10  9   4  |
|-----------------------------------------|
| 011 0010 0   1   1   1   Zm  10  1   00  0   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w.sve_fp_fma_long.bfmlslb_z_zzz_)
...
#### Execute (A64.sve.sve_fp_fma_w.sve_fp_fma_long.bfmlslb_z_zzz_)
