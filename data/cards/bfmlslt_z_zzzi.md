...
**Title**: BFMLSLT (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `bfmlslt_z_zzzi`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: BFloat16 multiply-subtract long from single-precision (top, indexed)
...
### Variant: `SVE2`
- **Assembly**: `BFMLSLT  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  13 12 11 10  9   4  |
|-----------------------------------------------|
| 011 0010 0   1   1   1   i3h Zm  01  1   0   i3l 1   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.bfmlslt_z_zzzi_)
...
#### Execute (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.bfmlslt_z_zzzi_)
