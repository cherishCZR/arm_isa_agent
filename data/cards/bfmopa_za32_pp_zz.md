...
**Title**: BFMOPA (widening) -- A64 | **Class**: `mortlach` | **XML ID**: `bfmopa_za32_pp_zz`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: BFloat16 sum of outer products and accumulate
...
### Variant: `SME`
- **Assembly**: `BFMOPA  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3   1  |
|-----------------------------------------|
| 1   00  0000 1   10  0   Zm  Pm  Pn  Zn  0   00  ZAda |
```

#### Decode (A64.sme.mortlach_32bit_fp_prod.mortlach_b16f32_prod.bfmopa_za32_pp_zz_)
...
#### Execute (A64.sme.mortlach_32bit_fp_prod.mortlach_b16f32_prod.bfmopa_za32_pp_zz_)
