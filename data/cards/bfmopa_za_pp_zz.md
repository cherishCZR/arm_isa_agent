...
**Title**: BFMOPA (non-widening) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmopa_za_pp_zz`

**Architecture**: `FEAT_SME_B16B16` (ARMv9.4)

**Summary**: BFloat16 outer product and accumulate
...
### Variant: `SME2`
- **Assembly**: `BFMOPA  <ZAda>.H, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3   1  0 |
|--------------------------------------------|
| 1   00  0000 1   10  1   Zm  Pm  Pn  Zn  0   10  0   ZAda |
```

#### Decode (A64.sme.mortlach2_misc_prod.mortlach_b16b16_prod.bfmopa_za_pp_zz_16)
...
#### Execute (A64.sme.mortlach2_misc_prod.mortlach_b16b16_prod.bfmopa_za_pp_zz_16)
...
for row = 0 to dim-1
    for col = 0 to dim-1
        ...
        if ActivePredicateElement(mask1, row, 16) && ActivePredicateElement(mask2, col, 16) then
            constant bits(16) elem1 = Elem[op1, row, 16];
