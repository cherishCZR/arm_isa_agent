...
**Title**: BFMUL (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `bfmul_mz_zzv`

**Architecture**: `FEAT_SME2 && FEAT_SVE_BFSCALE` (FEAT_SME2 && FEAT_SVE_BFSCALE)

**Summary**: Multi-vector BFloat16 multiply by vector
...
- **Assembly**: `BFMUL  { <Zd1>.H-<Zd2>.H }, { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16 15   9   5  4   0 |
|-----------------------------------------|
| 1   10  0000 1   00  1   Zm  0   111010 Zn  0   Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_5b.mortlach_multi2_fmul_sm.bfmul_mz_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_sve_5b.mortlach_multi2_fmul_sm.bfmul_mz_zzv_2x1)
...
- **Assembly**: `BFMUL  { <Zd1>.H-<Zd4>.H }, { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16 15   9   6  5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 1   00  1   Zm  1   111010 Zn  0   0   Zd  0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_5b.mortlach_multi4_fmul_sm.bfmul_mz_zzv_4x1)
