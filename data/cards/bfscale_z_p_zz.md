...
**Title**: BFSCALE -- A64 | **Class**: `sve2` | **XML ID**: `bfscale_z_p_zz`

**Architecture**: `FEAT_SVE_BFSCALE` (ARMv9.6)

**Summary**: BFloat16 adjust exponent by vector (predicated)

**Description**:
Multiply the active BFloat16 elements of the first
source vector by 2.0 to the power of the signed integer values
in the corresponding elements of the second source vector
...
### Variant: `SVE2`
- **Assembly**: `BFSCALE  <Zdn>.H, <Pg>/M, <Zdn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   00  0   0   1001 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfscale_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.bfscale_z_p_zz_)
...
| Type | Condition |
|---|---|
| 🔒 FEATURE_GATE | `IsFeatureImplemented(FEAT_SVE_BFSCALE)` |
