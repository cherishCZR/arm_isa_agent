...
**Title**: BFSUB -- A64 | **Class**: `mortlach2` | **XML ID**: `bfsub_za_zw`

**Architecture**: `FEAT_SME_B16B16` (ARMv9.4)

**Summary**: BFloat16 subtract multi-vector from ZA array vector accumulators
...
- **Assembly**: `BFSUB  ZA.H[<Wv>, <offs>{, VGx2}], { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  18  16  14  12   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  1   1   00  10  00  Rv  111 Zm  0   0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_f16_mm.bfsub_za_zw_2x2_16)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_f16_mm.bfsub_za_zw_2x2_16)
...
- **Assembly**: `BFSUB  ZA.H[<Wv>, <offs>{, VGx4}], { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  18  16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  1   1   00  10  10  Rv  111 Zm  00  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_f16_mm.bfsub_za_zw_4x4_16)
