## AND `[ALIAS]`
_ARM A64 Instruction_ (Alias of and_z_zi.xml)

**Title**: BIC (immediate) -- A64 | **Class**: `sve` | **XML ID**: `bic_and_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise clear bits using immediate (unpredicated)

**Description**:
Bitwise clear bits using immediate with
...
### Variant: `SVE`
- **Assembly**: `BIC  <Zdn>.<T>, <Zdn>.<T>, #<const>`
- **Alias of**: `AND  <Zdn>.<T>, <Zdn>.<T>, #(-<const> - 1)`
  Condition: Never
