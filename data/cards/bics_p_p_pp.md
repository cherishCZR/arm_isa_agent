...
**Title**: BICS -- A64 | **Class**: `sve` | **XML ID**: `bics_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise clear predicates, setting the condition flags
...
- **Assembly**: `BICS  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21  19  15  13   9  8   4  3  |
|-----------------------------------------|
| 001 0010 1   0   1   00  Pm  01  Pg  0   Pn  1   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.bics_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.bics_p_p_pp_z)
...
for e = 0 to elements-1
    ...
    if ActivePredicateElement(mask, e, esize) then
        Elem[result, e, psize] = ZeroExtend(element1 AND (NOT element2), psize);
    else
