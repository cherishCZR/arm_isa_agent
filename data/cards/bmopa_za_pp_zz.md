...
**Title**: BMOPA -- A64 | **Class**: `mortlach2` | **XML ID**: `bmopa_za_pp_zz`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Bitwise exclusive NOR population count outer product and accumulate
...
### Variant: `SME2`
- **Assembly**: `BMOPA  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.S, <Zm>.S`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3   1  |
|-----------------------------------------|
| 1   00  0000 0   10  0   Zm  Pm  Pn  Zn  0   10  ZAda |
```

#### Decode (A64.sme.mortlach2_misc_prod.mortlach_bini32_prod.bmopa_za_pp_zz_32)
...
#### Execute (A64.sme.mortlach2_misc_prod.mortlach_bini32_prod.bmopa_za_pp_zz_32)
