...
**Title**: BRKA -- A64 | **Class**: `sve` | **XML ID**: `brka_p_p_p`
...
- **Assembly**: `BRKA  <Pd>.B, <Pg>/<ZM>, <Pn>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21  19  15  13   9  8   4  3  |
|-----------------------------------------|
| 001 0010 1   0   0   01  0000 01  Pg  0   Pn  M   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_c.sve_int_break.brka_p_p_p_)
...
#### Execute (A64.sve.sve_pred_gen_c.sve_int_break.brka_p_p_p_)
