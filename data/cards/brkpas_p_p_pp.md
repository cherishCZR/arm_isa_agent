...
**Title**: BRKPAS -- A64 | **Class**: `sve` | **XML ID**: `brkpas_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Break after first true condition, propagating from previous partition and setting the condition flags
...
- **Assembly**: `BRKPAS  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21  19  15  13   9  8   4  3  |
|-----------------------------------------|
| 001 0010 1   0   1   00  Pm  11  Pg  0   Pn  0   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_b.sve_int_brkp.brkpas_p_p_pp_)
...
#### Execute (A64.sve.sve_pred_gen_b.sve_int_brkp.brkpas_p_p_pp_)
