...
**Title**: BRKPB -- A64 | **Class**: `sve` | **XML ID**: `brkpb_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Break before first true condition, propagating from previous partition
...
then sets subsequent elements to false. Inactive elements in the destination predicate register are set to zero. Does not set the condition flags.

**Attributes**: Predicated

### Variant: `Not setting the condition flags`
- **Assembly**: `BRKPB  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21  19  15  13   9  8   4  3  |
|-----------------------------------------|
| 001 0010 1   0   0   00  Pm  11  Pg  0   Pn  1   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_b.sve_int_brkp.brkpb_p_p_pp_)
...
#### Execute (A64.sve.sve_pred_gen_b.sve_int_brkp.brkpb_p_p_pp_)
