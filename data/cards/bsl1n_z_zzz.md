...
**Title**: BSL1N -- A64 | **Class**: `sve2` | **XML ID**: `bsl1n_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Bitwise select with first input inverted

**Description**:
Selects bits from the inverted first source vector where the
...
### Variant: `SVE2`
- **Assembly**: `BSL1N  <Zdn>.D, <Zdn>.D, <Zm>.D, <Zk>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 0   01  1   Zm  001 11  1   Zk  Zdn |
```

#### Decode (A64.sve.sve_int_unpred_logical.sve_int_tern_log.bsl1n_z_zzz_)
...
#### Execute (A64.sve.sve_int_unpred_logical.sve_int_tern_log.bsl1n_z_zzz_)
