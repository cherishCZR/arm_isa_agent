...
**Title**: BSL2N -- A64 | **Class**: `sve2` | **XML ID**: `bsl2n_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Bitwise select with second input inverted

**Description**:
Selects bits from the  first source vector where the
corresponding bit in the third source vector is '1', and from
the inverted second source vector where the corresponding bit in the
...
### Variant: `SVE2`
- **Assembly**: `BSL2N  <Zdn>.D, <Zdn>.D, <Zm>.D, <Zk>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 0   10  1   Zm  001 11  1   Zk  Zdn |
```

#### Decode (A64.sve.sve_int_unpred_logical.sve_int_tern_log.bsl2n_z_zzz_)
...
#### Execute (A64.sve.sve_int_unpred_logical.sve_int_tern_log.bsl2n_z_zzz_)
