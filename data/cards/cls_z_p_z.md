...
**Title**: CLS -- A64 | **Class**: `sve` | **XML ID**: `cls_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Count leading sign bits (predicated)

**Description**:
Count the number of consecutive sign bits, starting from the most significant bit in
...
### Variant: `Merging`
- **Assembly**: `CLS  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   1   1   000 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.cls_z_p_z_m)
...
#### Execute (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.cls_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `CLS  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   0   1   000 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.cls_z_p_z_z)
