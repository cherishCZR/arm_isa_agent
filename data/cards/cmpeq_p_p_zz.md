...
**Title**: CMP<cc> (vectors) -- A64 | **Class**: `sve` | **XML ID**: `cmpeq_p_p_zz`
...
### Variant: `Equal`
- **Assembly**: `CMPEQ  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  3  |
|-----------------------------------------|
| 001 0010 0   size 0   Zm  1   0   1   Pg  Zn  0   Pd  |
```

#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmpeq_p_p_zz_)
...
#### Execute (A64.sve.sve_cmpvec.sve_int_cmp_0.cmpeq_p_p_zz_)
...
- **Assembly**: `CMPGT  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  3  |
|-----------------------------------------|
| 001 0010 0   size 0   Zm  1   0   0   Pg  Zn  1   Pd  |
```

#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmpgt_p_p_zz_)
...
- **Assembly**: `CMPGE  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  3  |
|-----------------------------------------|
| 001 0010 0   size 0   Zm  1   0   0   Pg  Zn  0   Pd  |
```

#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmpge_p_p_zz_)
...
### Variant: `Higher`
- **Assembly**: `CMPHI  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmphi_p_p_zz_)
...
- **Assembly**: `CMPHS  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  3  |
|-----------------------------------------|
| 001 0010 0   size 0   Zm  0   0   0   Pg  Zn  0   Pd  |
```

#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmphs_p_p_zz_)
...
### Variant: `Not equal`
- **Assembly**: `CMPNE  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  3  |
|-----------------------------------------|
| 001 0010 0   size 0   Zm  1   0   1   Pg  Zn  1   Pd  |
```

#### Decode (A64.sve.sve_cmpvec.sve_int_cmp_0.cmpne_p_p_zz_)
