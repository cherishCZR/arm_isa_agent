...
**Title**: CMPLE (vectors) -- A64 | **Class**: `sve` | **XML ID**: `cmple_cmpeq_p_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Compare signed less than or equal to vector, setting the condition flags

**Description**:
Compare active signed integer elements in the
first source vector being less than or equal to corresponding signed elements in the second source vector, and
...
- **Assembly**: `CMPLE  <Pd>.<T>, <Pg>/Z, <Zm>.<T>, <Zn>.<T>`
- **Alias of**: `CMPGE  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
  Condition: Never
...
- alias_mnemonic: `CMPLE`
- isa: `A64`
- sve-compare-type: `ge`
- source: `cmple_cmpeq_p_p_zz.xml`
</details>