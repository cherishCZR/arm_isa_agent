...
**Title**: CMPLS (vectors) -- A64 | **Class**: `sve` | **XML ID**: `cmpls_cmpeq_p_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Compare unsigned lower or same as vector, setting the condition flags
...
- **Assembly**: `CMPLS  <Pd>.<T>, <Pg>/Z, <Zm>.<T>, <Zn>.<T>`
- **Alias of**: `CMPHS  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
  Condition: Never
...
- alias_mnemonic: `CMPLS`
- isa: `A64`
- sve-compare-type: `hs`
- source: `cmpls_cmpeq_p_p_zz.xml`
</details>