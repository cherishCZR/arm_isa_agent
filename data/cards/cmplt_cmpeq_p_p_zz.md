...
**Title**: CMPLT (vectors) -- A64 | **Class**: `sve` | **XML ID**: `cmplt_cmpeq_p_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Compare signed less than vector, setting the condition flags

**Description**:
Compare active signed integer elements in the
first source vector being less than corresponding signed elements in the second source vector, and
...
- **Assembly**: `CMPLT  <Pd>.<T>, <Pg>/Z, <Zm>.<T>, <Zn>.<T>`
- **Alias of**: `CMPGT  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
  Condition: Never
...
- alias_mnemonic: `CMPLT`
- isa: `A64`
- sve-compare-type: `gt`
- source: `cmplt_cmpeq_p_p_zz.xml`
</details>