...
**Title**: DECB, DECD, DECH, DECW (scalar) -- A64 | **Class**: `sve` | **XML ID**: `decb_r_rs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Decrement scalar by multiple of predicate constraint element count
...
### Variant: `Byte`
- **Assembly**: `DECB  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   00  1   1   imm4 11  100 1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_a.decb_r_rs_)
...
#### Execute (A64.sve.sve_countelt.sve_int_pred_pattern_a.decb_r_rs_)
...
### Variant: `Doubleword`
- **Assembly**: `DECD  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   11  1   1   imm4 11  100 1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_a.decd_r_rs_)
...
### Variant: `Halfword`
- **Assembly**: `DECH  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   01  1   1   imm4 11  100 1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_a.dech_r_rs_)
...
### Variant: `Word`
- **Assembly**: `DECW  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   10  1   1   imm4 11  100 1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_a.decw_r_rs_)
