...
**Title**: DUP (immediate) -- A64 | **Class**: `sve` | **XML ID**: `dup_z_i`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Broadcast signed immediate to vector elements (unpredicated)
...
#### Decode (A64.sve.sve_wideimm_unpred.sve_int_dup_imm.dup_z_i_)
...
#### Execute (A64.sve.sve_wideimm_unpred.sve_int_dup_imm.dup_z_i_)

```
CheckSVEEnabled();
constant integer VL = CurrentVL;
constant bits(VL) result = Replicate(imm<esize-1:0>, VL DIV esize);
Z[d, VL] = result;
```
