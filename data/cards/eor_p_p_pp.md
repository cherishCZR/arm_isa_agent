...
**Title**: EOR (predicates) -- A64 | **Class**: `sve` | **XML ID**: `eor_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise exclusive-OR predicates
...
- **Assembly**: `EOR  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.eor_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.eor_p_p_pp_z)
