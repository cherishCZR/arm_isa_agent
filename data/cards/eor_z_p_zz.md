...
**Title**: EOR (vectors, predicated) -- A64 | **Class**: `sve` | **XML ID**: `eor_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise exclusive-OR vectors (predicated)
...
### Variant: `SVE`
- **Assembly**: `EOR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  12   9   4  |
|-----------------------------------|
| 000 0010 0   size 0   11  001 000 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_bin.sve_int_bin_pred_log.eor_z_p_zz_)
...
#### Execute (A64.sve.sve_int_pred_bin.sve_int_bin_pred_log.eor_z_p_zz_)
