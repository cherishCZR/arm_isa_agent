...
**Title**: EOR (immediate) -- A64 | **Class**: `sve` | **XML ID**: `eor_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise exclusive-OR with immediate (unpredicated)

**Description**:
Bitwise exclusive-OR an immediate with
...
### Variant: `SVE`
- **Assembly**: `EOR  <Zdn>.<T>, <Zdn>.<T>, #<const>`
...
#### Decode (A64.sve.sve_maskimm.sve_int_log_imm.eor_z_zi_)
...
#### Execute (A64.sve.sve_maskimm.sve_int_log_imm.eor_z_zi_)
