...
**Title**: EORS -- A64 | **Class**: `sve` | **XML ID**: `eors_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise exclusive-OR predicates, setting the condition flags
...
- **Assembly**: `EORS  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.eors_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.eors_p_p_pp_z)
...
for e = 0 to elements-1
    ...
    if ActivePredicateElement(mask, e, esize) then
        Elem[result, e, psize] = ZeroExtend(element1 EOR element2, psize);
    else
