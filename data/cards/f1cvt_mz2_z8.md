...
**Title**: F1CVT, F2CVT -- A64 | **Class**: `mortlach2` | **XML ID**: `f1cvt_mz2_z8`

**Architecture**: `FEAT_SME2 && FEAT_FP8` (FEAT_SME2 && FEAT_FP8)

**Summary**: Multi-vector convert from 8-bit floating-point to half-precision (in-order)
...
of the destination vectors. F1CVT scales the values by 2-UInt(FPMR.LSCALE[3:0]).
...
### Variant: `F1CVT`
- **Assembly**: `F1CVT  { <Zd1>.H-<Zd2>.H }, <Zn>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   00  1   001 10  111000 Zn  Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.f1cvt_mz2_z8_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.f1cvt_mz2_z8_)
...
for e = 0 to elements-1
    ...
    Elem[result, e, 16] = FP8ConvertFP(element, issrc2, FPCR, FPMR);
...
### Variant: `F2CVT`
- **Assembly**: `F2CVT  { <Zd1>.H-<Zd2>.H }, <Zn>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   10  1   001 10  111000 Zn  Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_fp8_cvrt.f2cvt_mz2_z8_)
