...
This clears the sign bit and cannot signal a
...
### Variant: `Merging`
- **Assembly**: `FABS  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   1   1   100 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.fabs_z_p_z_m)
...
#### Execute (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.fabs_z_p_z_m)
...
for e = 0 to elements-1
    if ActivePredicateElement(mask, e, esize) then
        ...
        Elem[result, e, esize] = FPAbs(element, FPCR);
...
### Variant: `Zeroing`
- **Assembly**: `FABS  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   0   1   100 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.fabs_z_p_z_z)
