...
**Title**: FADD (vectors, unpredicated) -- A64 | **Class**: `sve` | **XML ID**: `fadd_z_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point add vector (unpredicated)
...
### Variant: `SVE`
- **Assembly**: `FADD  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12   9   4  |
|--------------------------------|
| 011 0010 1   ?   0   Zm  000 000 Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unpred.sve_fp_3op_u_zd.fadd_z_zz_)
...
#### Execute (A64.sve.sve_fp_unpred.sve_fp_3op_u_zd.fadd_z_zz_)
