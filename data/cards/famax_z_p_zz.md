...
**Title**: FAMAX -- A64 | **Class**: `sve2` | **XML ID**: `famax_z_p_zz`

**Architecture**: `(FEAT_SVE2 || FEAT_SME2) && FEAT_FAMINMAX` ((FEAT_SVE2 || FEAT_SME2) && FEAT_FAMINMAX)

**Summary**: Floating-point absolute maximum (predicated)

**Description**:
Determine the maximum  absolute value from active floating-point elements of the second source vector and
...
### Variant: `SVE2`
- **Assembly**: `FAMAX  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   size 0   0   1110 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.famax_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.famax_z_p_zz_)
