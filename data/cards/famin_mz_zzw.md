...
**Title**: FAMIN -- A64 | **Class**: `mortlach2` | **XML ID**: `famin_mz_zzw`

**Architecture**: `FEAT_SME2 && FEAT_FAMINMAX` (FEAT_SME2 && FEAT_FAMINMAX)

**Summary**: Multi-vector floating-point absolute minimum

**Description**:
This instruction determines the minimum absolute value from floating-point elements of the
...
- **Assembly**: `FAMIN  { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zm1>.<T>-<Zm2>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16   9   6   4   0 |
|--------------------------------------|
| 1   10  0000 1   size 1   Zm  0101100 010 10  Zdn 1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_fminmax_mm.famin_mz_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_fminmax_mm.famin_mz_zzw_2x2)
...
- **Assembly**: `FAMIN  { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zm1>.<T>-<Zm4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17   9   6   4   1  0 |
|-----------------------------------------|
| 1   10  0000 1   size 1   Zm  00101110 010 10  Zdn 0   1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2d0.mortlach_multi4_z_z_fminmax_mm.famin_mz_zzw_4x4)
