...
**Title**: FCMLT (vectors) -- A64 | **Class**: `sve` | **XML ID**: `fcmlt_fcmeq_p_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point compare less than vector

**Description**:
Compare active floating-point elements in the
first source vector being less than corresponding elements in the second source vector, and
...
- **Assembly**: `FCMLT  <Pd>.<T>, <Pg>/Z, <Zm>.<T>, <Zn>.<T>`
- **Alias of**: `FCMGT  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
  Condition: Never
...
- alias_mnemonic: `FCMLT`
- isa: `A64`
- sve-compare-type: `gt`
- source: `fcmlt_fcmeq_p_p_zz.xml`
</details>