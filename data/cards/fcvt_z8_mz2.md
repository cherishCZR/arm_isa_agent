...
**Title**: FCVT (narrowing, FP16 to FP8) -- A64 | **Class**: `mortlach2` | **XML ID**: `fcvt_z8_mz2`

**Architecture**: `FEAT_SME2 && FEAT_FP8` (FEAT_SME2 && FEAT_FP8)

**Summary**: Multi-vector convert from half-precision to packed 8-bit floating-point format

**Description**:
This instruction converts each half-precision element of the two source vectors to 8-bit floating-point while
scaling the value by 2SInt(FPMR.NSCALE[4:0]), and places the  results in the half-width
...
### Variant: `SME2`
- **Assembly**: `FCVT  <Zd>.B, { <Zn1>.H-<Zn2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   5  4  |
|-----------------------------------------|
| 1   10  0000 1   0   0   1   001 00  111000 Zn  0   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp8_cvrt.fcvt_z8_mz2_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp8_cvrt.fcvt_z8_mz2_)
