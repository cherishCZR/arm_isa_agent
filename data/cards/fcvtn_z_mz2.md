...
**Title**: FCVTN (FP32 to FP16) -- A64 | **Class**: `mortlach2` | **XML ID**: `fcvtn_z_mz2`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector convert from single-precision to interleaved half-precision

**Description**:
This instruction converts each element of the
two source vectors from single-precision to half-precision floating-point, and places the two-way interleaved results
...
### Variant: `SME2`
- **Assembly**: `FCVTN  <Zd>.H, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   5  4  |
|-----------------------------------------|
| 1   10  0000 1   0   0   1   000 00  111000 Zn  1   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp_cvrt.fcvtn_z_mz2_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_narrow_fp_cvrt.fcvtn_z_mz2_)
...
for e = 0 to elements-1
    ...
    constant bits(16) res1 = FPConvertSVE(element1, FPCR, 16);
    constant bits(16) res2 = FPConvertSVE(element2, FPCR, 16);
