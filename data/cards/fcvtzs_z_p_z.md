...
**Title**: FCVTZS -- A64 | **Class**: `sve` | **XML ID**: `fcvtzs_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Floating-point convert to signed integer, rounding toward zero (predicated)

**Description**:
Convert to the signed integer nearer to zero
from each active floating-point element of the source vector,
...
- **Assembly**: `FCVTZS  <Zd>.H, <Pg>/M, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   11  01  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_fp162h)
...
#### Execute (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_fp162h)
...
- **Assembly**: `FCVTZS  <Zd>.H, <Pg>/Z, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 11  0   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_fp162hz)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/M, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   11  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_fp162w)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/Z, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 11  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_fp162wz)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/M, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   11  11  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_fp162x)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/Z, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 11  1   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_fp162xz)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   10  0   11  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_s2w)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   10  011 11  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_s2wz)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   11  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_s2x)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 11  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_s2xz)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   11  00  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_d2w)
...
- **Assembly**: `FCVTZS  <Zd>.S, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 11  0   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_d2wz)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   11  11  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_d.fcvtzs_z_p_z_d2x)
...
- **Assembly**: `FCVTZS  <Zd>.D, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 11  1   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_d.fcvtzs_z_p_z_d2xz)
