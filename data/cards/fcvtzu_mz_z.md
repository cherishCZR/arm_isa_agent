...
**Title**: FCVTZU -- A64 | **Class**: `mortlach2` | **XML ID**: `fcvtzu_mz_z`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point convert to unsigned integer, rounding toward zero

**Description**:
This instruction converts each element of the two or four source vectors from
single-precision floating-point to the unsigned 32-bit integer nearer to zero, and places the results
...
- **Assembly**: `FCVTZU  { <Zd1>.S-<Zd2>.S }, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   5  4   0 |
|-----------------------------------------|
| 1   10  0000 1   00  1   000 01  111000 Zn  1   Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_fpint_cvrt.fcvtzu_mz_z_2)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_fpint_cvrt.fcvtzu_mz_z_2)
...
for r = 0 to nreg-1
    ...
    for e = 0 to elements-1
        ...
        Elem[results[r], e, 32] = FPToFixed(element, 0, unsigned, FPCR, rounding, 32);
...
- **Assembly**: `FCVTZU  { <Zd1>.S-<Zd4>.S }, { <Zn1>.S-<Zn4>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   6  5  4   1  |
|--------------------------------------------|
| 1   10  0000 1   00  1   100 01  111000 Zn  0   1   Zd  00  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_fpint_cvrt.fcvtzu_mz_z_4)
