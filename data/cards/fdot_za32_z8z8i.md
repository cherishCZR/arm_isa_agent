...
**Title**: FDOT (4-way, multiple and indexed vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `fdot_za32_z8z8i`

**Architecture**: `FEAT_SME_F8F32` (ARMv9.5)

**Summary**: Multi-vector 8-bit floating-point dot-product by indexed element to single-precision

**Description**:
This instruction computes the fused sum-of-products of a group of four 8-bit floating-point values
held in the corresponding 32-bit elements of the two or four first source vectors and the indexed 32-bit element of the second source vector.
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.B-<Zn2>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5   2  |
|--------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  0   i2  Zn  111 off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.fdot_za32_z8z8i_2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.fdot_za32_z8z8i_2xi)
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5   2  |
|-----------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  0   i2  Zn  0   001 off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.fdot_za32_z8z8i_4xi)
