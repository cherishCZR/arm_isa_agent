...
**Title**: FDOT (4-way, multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `fdot_za32_z8z8w`

**Architecture**: `FEAT_SME_F8F32` (ARMv9.5)

**Summary**: Multi-vector 8-bit floating-point dot-product to single-precision
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.B-<Zn2>.B }, { <Zm1>.B-<Zm2>.B }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5   3  2  |
|--------------------------------------------|
| 1   10  0000 11  0   1   Zm  00  Rv  100 Zn  11  0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_fpdot_mm.fdot_za32_z8z8w_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_fpdot_mm.fdot_za32_z8z8w_2x2)
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, { <Zm1>.B-<Zm4>.B }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6  5   3  2  |
|--------------------------------------------------|
| 1   10  0000 11  0   1   Zm  0   10  Rv  100 Zn  0   11  0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_fpdot_mm.fdot_za32_z8z8w_4x4)
