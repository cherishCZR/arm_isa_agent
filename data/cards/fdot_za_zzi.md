...
**Title**: FDOT (2-way, multiple and indexed vector, FP16 to FP32) -- A64 | **Class**: `mortlach2` | **XML ID**: `fdot_za_zzi`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector half-precision dot-product by indexed element
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5   2  |
|--------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  1   i2  Zn  001 off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.fdot_za_zzi_2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.fdot_za_zzi_2xi)
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5   2  |
|-----------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  1   i2  Zn  0   001 off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.fdot_za_zzi_4xi)
