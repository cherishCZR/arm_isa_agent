...
**Title**: FDOT (2-way, multiple and single vector, FP16 to FP32) -- A64 | **Class**: `mortlach2` | **XML ID**: `fdot_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector half-precision dot-product by vector
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4   2  |
|-----------------------------------------|
| 1   10  0000 10  0   10  Zm  0   Rv  100 Zn  00  off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_fpdot_sm.fdot_za_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_fpdot_sm.fdot_za_zzv_2x1)
...
- **Assembly**: `FDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4   2  |
|-----------------------------------------|
| 1   10  0000 10  0   11  Zm  0   Rv  100 Zn  00  off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_z_za_fpdot_sm.fdot_za_zzv_4x1)
