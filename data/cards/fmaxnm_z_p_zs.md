...
**Title**: FMAXNM (immediate) -- A64 | **Class**: `sve` | **XML ID**: `fmaxnm_z_p_zs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point maximum number with immediate (predicated)

**Description**:
Determine the maximum number value of an immediate and
...
### Variant: `SVE`
- **Assembly**: `FMAXNM  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  12   9   5  4  |
|--------------------------------------|
| 011 0010 1   size 0   11  100 100 Pg  0000 i1  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_i_p_zds.fmaxnm_z_p_zs_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_i_p_zds.fmaxnm_z_p_zs_)
