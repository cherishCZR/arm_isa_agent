...
**Title**: FMAXNMP -- A64 | **Class**: `sve2` | **XML ID**: `fmaxnmp_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Floating-point maximum number pairwise

**Description**:
Compute the maximum value of each pair of adjacent floating-point
...
### Variant: `SVE2`
- **Assembly**: `FMAXNMP  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 0   size 010 100 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fmaxnmp_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fmaxnmp_z_p_zz_)
