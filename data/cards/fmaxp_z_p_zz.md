...
**Title**: FMAXP -- A64 | **Class**: `sve2` | **XML ID**: `fmaxp_z_p_zz`
...
### Variant: `SVE2`
- **Assembly**: `FMAXP  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 0   size 010 110 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fmaxp_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fmaxp_z_p_zz_)
