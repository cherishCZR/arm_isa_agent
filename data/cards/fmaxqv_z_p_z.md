...
**Title**: FMAXQV -- A64 | **Class**: `sve2` | **XML ID**: `fmaxqv_z_p_z`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Floating-point maximum reduction of quadword vector segments

**Description**:
Floating-point maximum of the same element numbers from each 128-bit source vector segment
...
### Variant: `SVE2`
- **Assembly**: `FMAXQV  <Vd>.<T>, <Pg>, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 0   size 010 110 101 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_fp_fastreduceq.sve_fp_fast_redq.fmaxqv_z_p_z_)
...
#### Execute (A64.sve.sve_fp_fastreduceq.sve_fp_fast_redq.fmaxqv_z_p_z_)
