...
**Title**: FMAXV -- A64 | **Class**: `sve` | **XML ID**: `fmaxv_v_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point maximum recursive reduction to scalar

**Description**:
Floating-point maximum horizontally over all lanes of a vector using a recursive pairwise reduction,
...
### Variant: `SVE`
- **Assembly**: `FMAXV  <V><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 1   size 000 110 001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_fp_fastreduce.sve_fp_fast_red.fmaxv_v_p_z_)
...
#### Execute (A64.sve.sve_fp_fastreduce.sve_fp_fast_red.fmaxv_v_p_z_)
