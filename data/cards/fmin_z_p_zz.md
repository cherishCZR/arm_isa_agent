...
**Title**: FMIN (vectors) -- A64 | **Class**: `sve` | **XML ID**: `fmin_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point minimum (predicated)

**Description**:
Determine the minimum of active floating-point elements of the second source vector and
...
### Variant: `SVE`
- **Assembly**: `FMIN  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   ?   0   0   0111 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.fmin_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.fmin_z_p_zz_)
