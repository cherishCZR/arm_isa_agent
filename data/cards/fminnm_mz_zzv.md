...
**Title**: FMINNM (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `fminnm_mz_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point minimum number by vector
...
- **Assembly**: `FMINNM  { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zdn1>.<T>-<Zdn2>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   0 |
|--------------------------------------------|
| 1   10  0000 1   ?   10  Zm  10100 0   01  00  1   Zdn 1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.fminnm_mz_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_fminmax_sm.fminnm_mz_zzv_2x1)
...
- **Assembly**: `FMINNM  { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zdn1>.<T>-<Zdn4>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 1   ?   10  Zm  10101 0   01  00  1   Zdn 0   1   |
```

#### Decode (A64.sme.mortlach_multi_sve_2b.mortlach_multi4_z_z_fminmax_sm.fminnm_mz_zzv_4x1)
