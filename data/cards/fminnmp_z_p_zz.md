...
**Title**: FMINNMP -- A64 | **Class**: `sve2` | **XML ID**: `fminnmp_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Floating-point minimum number pairwise

**Description**:
Compute the minimum value of each pair of adjacent floating-point
...
### Variant: `SVE2`
- **Assembly**: `FMINNMP  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 0   size 010 101 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fminnmp_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pairwise.sve_fp_pairwise.fminnmp_z_p_zz_)
