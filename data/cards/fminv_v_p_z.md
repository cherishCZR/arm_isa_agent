...
**Title**: FMINV -- A64 | **Class**: `sve` | **XML ID**: `fminv_v_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point minimum recursive reduction to scalar

**Description**:
Floating-point minimum horizontally over all lanes of a vector using a recursive pairwise reduction,
...
### Variant: `SVE`
- **Assembly**: `FMINV  <V><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  12   9   4  |
|--------------------------------|
| 011 0010 1   size 000 111 001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_fp_fastreduce.sve_fp_fast_red.fminv_v_p_z_)
...
#### Execute (A64.sve.sve_fp_fastreduce.sve_fp_fast_red.fminv_v_p_z_)
