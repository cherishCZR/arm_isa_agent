...
**Title**: FMLAL (multiple and indexed vector, FP16 to FP32) -- A64 | **Class**: `mortlach2` | **XML ID**: `fmlal_za_zzi`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point multiply-add long by indexed element
...
- **Assembly**: `FMLAL  ZA.S[<Wv>, <offs1>:<offs2>], <Zn>.H, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   4  3  2  |
|-----------------------------------------------|
| 1   10  0000 1   10  00  Zm  i3h Rv  1   i3l Zn  0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_1.mortlach_multi1_fma_long_idx.fmlal_za_zzi_1)
...
#### Execute (A64.sme.mortlach_multi_indexed_1.mortlach_multi1_fma_long_idx.fmlal_za_zzi_1)
...
- **Assembly**: `FMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  1  |
|-----------------------------------------------------|
| 1   10  0000 1   10  01  Zm  0   Rv  1   i3h Zn  0   0   0   i3l off2 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_fma_long_idx.fmlal_za_zzi_2xi)
...
- **Assembly**: `FMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6   4  3  2  1  |
|-----------------------------------------------------|
| 1   10  0000 1   10  01  Zm  1   Rv  1   i3h Zn  00  0   0   i3l off2 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_fma_long_idx.fmlal_za_zzi_4xi)
