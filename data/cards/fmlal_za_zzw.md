...
**Title**: FMLAL (multiple vectors, FP16 to FP32) -- A64 | **Class**: `mortlach2` | **XML ID**: `fmlal_za_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point multiply-add long
...
- **Assembly**: `FMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx2}], { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  1  |
|--------------------------------------------------|
| 1   10  0000 11  0   1   Zm  00  Rv  010 Zn  0   0   0   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_fma_long_mm.fmlal_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_fma_long_mm.fmlal_za_zzw_2x2)
...
- **Assembly**: `FMLAL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  1  |
|-----------------------------------------------------|
| 1   10  0000 11  0   1   Zm  0   10  Rv  010 Zn  00  0   0   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_fma_long_mm.fmlal_za_zzw_4x4)
