...
**Title**: FMLALB (indexed, FP8 to FP16) -- A64 | **Class**: `sve2` | **XML ID**: `fmlalb_z_z8z8z8i`

**Architecture**: `(FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA` ((FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA)

**Summary**: 8-bit floating-point multiply-add long to half-precision (bottom, indexed)

**Description**:
This 8-bit floating-point multiply-add long instruction widens the even 8-bit elements
...
### Variant: `SVE2`
- **Assembly**: `FMLALB  <Zda>.H, <Zn>.B, <Zm>.B[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22  20  18  15  11   9   4  |
|-----------------------------------|
| 011 0010 0   0   01  i4h Zm  0101 i4l Zn  Zda |
```

#### Decode (A64.sve.sve_fp8_fma_w_by_indexed_elem.sve_fp8_fma_long_by_indexed_elem.fmlalb_z_z8z8z8i_)
...
#### Execute (A64.sve.sve_fp8_fma_w_by_indexed_elem.sve_fp8_fma_long_by_indexed_elem.fmlalb_z_z8z8z8i_)
