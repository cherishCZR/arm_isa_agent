...
**Title**: FMLALB (vectors, FP16 to FP32) -- A64 | **Class**: `sve2` | **XML ID**: `fmlalb_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Half-precision multiply-add long to single-precision (bottom)
...
### Variant: `SVE2`
- **Assembly**: `FMLALB  <Zda>.S, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  15  13 12  10  9   4  |
|-----------------------------------------|
| 011 0010 0   1   0   1   Zm  10  0   00  0   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w.sve_fp_fma_long.fmlalb_z_zzz_)
...
#### Execute (A64.sve.sve_fp_fma_w.sve_fp_fma_long.fmlalb_z_zzz_)
