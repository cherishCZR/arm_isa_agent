...
**Title**: FMLALB (indexed, FP16 to FP32) -- A64 | **Class**: `sve2` | **XML ID**: `fmlalb_z_zzzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Half-precision multiply-add long to single-precision (bottom, indexed)

**Description**:
This half-precision multiply-add long instruction
...
- **Assembly**: `FMLALB  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  13 12 11 10  9   4  |
|-----------------------------------------------|
| 011 0010 0   1   0   1   i3h Zm  01  0   0   i3l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.fmlalb_z_zzzi_s)
...
#### Execute (A64.sve.sve_fp_fma_w_by_indexed_elem.sve_fp_fma_long_by_indexed_elem.fmlalb_z_zzzi_s)
