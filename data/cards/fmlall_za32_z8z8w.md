...
**Title**: FMLALL (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `fmlall_za32_z8z8w`

**Architecture**: `FEAT_SME_F8F32` (ARMv9.5)

**Summary**: Multi-vector 8-bit floating-point multiply-add long-long to single-precision
...
- **Assembly**: `FMLALL  ZA.S[<Wv>, <offs1>:<offs4>{, VGx2}], { <Zn1>.B-<Zn2>.B }, { <Zm1>.B-<Zm2>.B }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 11  0   1   Zm  00  Rv  000 Zn  1   000 0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_fp8_fma_long_long_mm.fmlall_za32_z8z8w_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_fp8_fma_long_long_mm.fmlall_za32_z8z8w_2x2)
...
- **Assembly**: `FMLALL  ZA.S[<Wv>, <offs1>:<offs4>{, VGx4}], { <Zn1>.B-<Zn4>.B }, { <Zm1>.B-<Zm4>.B }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4   1  0 |
|--------------------------------------------------|
| 1   10  0000 11  0   1   Zm  0   10  Rv  000 Zn  01  000 0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_fp8_fma_long_long_mm.fmlall_za32_z8z8w_4x4)
