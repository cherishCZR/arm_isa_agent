...
**Title**: FMLALLBT (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `fmlallbt_z32_z8z8z8`

**Architecture**: `(FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA` ((FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA)

**Summary**: 8-bit floating-point multiply-add long long to single-precision (bottom top)
...
### Variant: `SVE2`
- **Assembly**: `FMLALLBT  <Zda>.S, <Zn>.B, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22  20  15  13  11   9   4  |
|-----------------------------------|
| 011 0010 0   0   01  Zm  10  01  10  Zn  Zda |
```

#### Decode (A64.sve.sve_fp8_fma_w.sve_fp8_fma_long_long.fmlallbt_z32_z8z8z8_)
...
#### Execute (A64.sve.sve_fp8_fma_w.sve_fp8_fma_long_long.fmlallbt_z32_z8z8z8_)
...
for e = 0 to elements-1
    ...
    constant bits(8) element2 = Elem[operand2, 4 * e + 1, 8];
...
- isa: `A64`
- source: `fmlallbt_z32_z8z8z8.xml`
</details>