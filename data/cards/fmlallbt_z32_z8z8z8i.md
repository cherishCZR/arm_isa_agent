...
**Title**: FMLALLBT (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `fmlallbt_z32_z8z8z8i`

**Architecture**: `(FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA` ((FEAT_SVE2 && FEAT_FP8FMA) || FEAT_SSVE_FP8FMA)

**Summary**: 8-bit floating-point multiply-add long long to single-precision (bottom top, indexed)

**Description**:
This 8-bit floating-point multiply-add long-long instruction widens the second 8-bit element of each 32-bit container
...
### Variant: `SVE2`
- **Assembly**: `FMLALLBT  <Zda>.S, <Zn>.B, <Zm>.B[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  11   9   4  |
|-----------------------------------|
| 011 0010 0   01  1   i4h Zm  1100 i4l Zn  Zda |
```

#### Decode (A64.sve.sve_fp8_fma_ww_by_indexed_elem.sve_fp8_fma_long_long_by_indexed_elem.fmlallbt_z32_z8z8z8i_)
...
#### Execute (A64.sve.sve_fp8_fma_ww_by_indexed_elem.sve_fp8_fma_long_long_by_indexed_elem.fmlallbt_z32_z8z8z8i_)
...
for e = 0 to elements-1
    ...
    constant bits(8) element1 = Elem[operand1, 4 * e + 1, 8];
...
- isa: `A64`
- source: `fmlallbt_z32_z8z8z8i.xml`
</details>