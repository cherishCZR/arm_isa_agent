...
**Title**: FMLS (vectors) -- A64 | **Class**: `sve` | **XML ID**: `fmls_z_p_zzz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point fused multiply-subtract vectors (predicated), writing addend [Zda = Zda + -Zn * Zm]
...
### Variant: `SVE`
- **Assembly**: `FMLS  <Zda>.<T>, <Pg>/M, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 011 0010 1   ?   1   Zm  0   0   1   Pg  Zn  Zda |
```

#### Decode (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_a.fmls_z_p_zzz_)
...
#### Execute (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_a.fmls_z_p_zzz_)
