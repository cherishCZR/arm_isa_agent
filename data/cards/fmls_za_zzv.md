...
**Title**: FMLS (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `fmls_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3), `FEAT_SME_F16F16` (ARMv9.4)

**Summary**: Multi-vector floating-point fused multiply-subtract by vector

**Description**:
This instruction multiplies the corresponding floating-point elements of the two or four first source vector
with corresponding elements of the second source vector and destructively subtracts these values without intermediate rounding from the corresponding elements of the ZA single-vector groups.
...
- **Assembly**: `FMLS  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zn1>.<T>-<Zn2>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  10  Zm  0   Rv  110 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_float_sm.fmls_za_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_float_sm.fmls_za_zzv_2x1)
...
- **Assembly**: `FMLS  ZA.H[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  0   10  Zm  0   Rv  111 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_f16_sm.fmls_za_zzv_2x1_16)
...
- **Assembly**: `FMLS  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zn1>.<T>-<Zn4>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  11  Zm  0   Rv  110 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_float_sm.fmls_za_zzv_4x1)
...
- **Assembly**: `FMLS  ZA.H[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  0   11  Zm  0   Rv  111 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_f16_sm.fmls_za_zzv_4x1_16)
