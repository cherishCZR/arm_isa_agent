...
**Title**: FMOPA (widening, 2-way, FP16 to FP32) -- A64 | **Class**: `mortlach` | **XML ID**: `fmopa_za32_pp_zz`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Half-precision sum of outer products and accumulate
...
products is then destructively added to the single-precision
destination tile.
...
### Variant: `SME`
- **Assembly**: `FMOPA  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3   1  |
|-----------------------------------------|
| 1   00  0000 1   10  1   Zm  Pm  Pn  Zn  0   00  ZAda |
```

#### Decode (A64.sme.mortlach_32bit_fp_prod.mortlach_f16f32_prod.fmopa_za32_pp_zz_16)
...
#### Execute (A64.sme.mortlach_32bit_fp_prod.mortlach_f16f32_prod.fmopa_za32_pp_zz_16)
