...
**Title**: FMUL (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `fmul_mz_zzw`
...
- **Assembly**: `FMUL  { <Zd1>.<T>-<Zd2>.<T> }, { <Zn1>.<T>-<Zn2>.<T> }, { <Zm1>.<T>-<Zm2>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16 15   9   5  4   0 |
|-----------------------------------------|
| 1   10  0000 1   ?   1   Zm  0   111001 Zn  0   Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_5a.mortlach_multi2_fmul_mm.fmul_mz_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_sve_5a.mortlach_multi2_fmul_mm.fmul_mz_zzw_2x2)
...
- **Assembly**: `FMUL  { <Zd1>.<T>-<Zd4>.<T> }, { <Zn1>.<T>-<Zn4>.<T> }, { <Zm1>.<T>-<Zm4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   6  5  4   1  0 |
|-----------------------------------------------|
| 1   10  0000 1   ?   1   Zm  01  111001 Zn  0   0   Zd  0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_5a.mortlach_multi4_fmul_mm.fmul_mz_zzw_4x4)
