...
**Title**: FNMAD -- A64 | **Class**: `sve` | **XML ID**: `fnmad_z_p_zzz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point negated fused multiply-add vectors (predicated), writing multiplicand [Zdn = -Za + -Zdn * Zm]
...
### Variant: `SVE`
- **Assembly**: `FNMAD  <Zdn>.<T>, <Pg>/M, <Zm>.<T>, <Za>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 011 0010 1   size 1   Za  1   1   0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_b.fnmad_z_p_zzz_)
...
#### Execute (A64.sve.sve_fp_fma.sve_fp_3op_p_zds_b.fnmad_z_p_zzz_)
