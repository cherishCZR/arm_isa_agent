...
**Title**: FRINT64Z -- A64 | **Class**: `sve2` | **XML ID**: `frint64z_z_p_z`

**Architecture**: `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Floating-point round to 64-bit integer, toward zero (predicated)
...
### Variant: `Merging`
- **Assembly**: `FRINT64Z  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  12   9   4  |
|-----------------------------------------|
| 011 0010 1   00  0   10  1   sz  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.frint64z_z_p_z_m)
...
#### Execute (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.frint64z_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `FRINT64Z  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   00  011 10  1   1   sz  0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.frint64z_z_p_z_z)
