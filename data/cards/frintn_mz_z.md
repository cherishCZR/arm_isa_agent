...
**Title**: FRINTN -- A64 | **Class**: `mortlach2` | **XML ID**: `frintn_mz_z`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point round to integral value, to nearest with ties to even
...
- **Assembly**: `FRINTN  { <Zd1>.S-<Zd2>.S }, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  18  15   9   5  4   0 |
|-----------------------------------------|
| 1   10  0000 1   10  1   01  000 111000 Zn  0   Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_frint.frintn_mz_z_2)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_frint.frintn_mz_z_2)
...
- **Assembly**: `FRINTN  { <Zd1>.S-<Zd4>.S }, { <Zn1>.S-<Zn4>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  18  15   9   6   4   1  |
|-----------------------------------------|
| 1   10  0000 1   10  1   11  000 111000 Zn  00  Zd  00  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_frint.frintn_mz_z_4)
