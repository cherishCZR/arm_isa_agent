...
**Title**: FRINTP -- A64 | **Class**: `mortlach2` | **XML ID**: `frintp_mz_z`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector floating-point round to integral value, toward plus Infinity

**Description**:
This instruction rounds up each element of the two or four source vectors to an integral floating-point value,
...
- **Assembly**: `FRINTP  { <Zd1>.S-<Zd2>.S }, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  18  15   9   5  4   0 |
|-----------------------------------------|
| 1   10  0000 1   10  1   01  001 111000 Zn  0   Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_frint.frintp_mz_z_2)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_frint.frintp_mz_z_2)
...
- **Assembly**: `FRINTP  { <Zd1>.S-<Zd4>.S }, { <Zn1>.S-<Zn4>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  18  15   9   6   4   1  |
|-----------------------------------------|
| 1   10  0000 1   10  1   11  001 111000 Zn  00  Zd  00  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_frint.frintp_mz_z_4)
