...
**Title**: FSQRT -- A64 | **Class**: `sve` | **XML ID**: `fsqrt_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Floating-point square root (predicated)

**Description**:
Calculate the square root
of each active floating-point element of the source vector,
...
### Variant: `Merging`
- **Assembly**: `FSQRT  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  17  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   size 0   011 01  101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_b_1.fsqrt_z_p_z_m)
...
#### Execute (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_b_1.fsqrt_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `FSQRT  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15 14  12   9   4  |
|-----------------------------------|
| 011 0010 0   size 011 011 1   01  Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_b_1.fsqrt_z_p_z_z)
