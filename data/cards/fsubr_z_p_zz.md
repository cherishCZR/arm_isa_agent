...
**Title**: FSUBR (vectors) -- A64 | **Class**: `sve` | **XML ID**: `fsubr_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Floating-point reversed subtract vectors (predicated)

**Description**:
Reversed subtract active floating-point elements of the first source vector from
...
### Variant: `SVE`
- **Assembly**: `FSUBR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12   9   4  |
|-----------------------------------|
| 011 0010 1   size 0   0   0011 100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.fsubr_z_p_zz_)
...
#### Execute (A64.sve.sve_fp_pred.sve_fp_2op_p_zds.fsubr_z_p_zz_)
