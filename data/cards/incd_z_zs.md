...
**Title**: INCD, INCH, INCW (vector) -- A64 | **Class**: `sve` | **XML ID**: `incd_z_zs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Increment vector by multiple of predicate constraint element count
...
### Variant: `Doubleword`
- **Assembly**: `INCD  <Zdn>.D{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   11  1   1   imm4 11  000 0   pattern Zdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_countvlv1.incd_z_zs_)
...
#### Execute (A64.sve.sve_countelt.sve_int_countvlv1.incd_z_zs_)
...
### Variant: `Halfword`
- **Assembly**: `INCH  <Zdn>.H{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   01  1   1   imm4 11  000 0   pattern Zdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_countvlv1.inch_z_zs_)
...
### Variant: `Word`
- **Assembly**: `INCW  <Zdn>.S{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  10  9   4  |
|--------------------------------------|
| 000 0010 0   10  1   1   imm4 11  000 0   pattern Zdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_countvlv1.incw_z_zs_)
