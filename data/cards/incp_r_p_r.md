...
**Title**: INCP (scalar) -- A64 | **Class**: `sve` | **XML ID**: `incp_r_p_r`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Increment scalar by count of true predicate elements
...
### Variant: `SVE`
- **Assembly**: `INCP  <Xdn>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18 17 16 15  11 10   8   4  |
|-----------------------------------------|
| 001 0010 1   size 101 1   0   0   1000 1   00  Pm  Rdn |
```

#### Decode (A64.sve.sve_pred_count_b.sve_int_count_r.incp_r_p_r_)
...
#### Execute (A64.sve.sve_pred_count_b.sve_int_count_r.incp_r_p_r_)
