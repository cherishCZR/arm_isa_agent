...
**Title**: LASTA (scalar) -- A64 | **Class**: `sve` | **XML ID**: `lasta_r_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Extract element after last to general-purpose register
...
### Variant: `SVE`
- **Assembly**: `LASTA  <R><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  16 15  13 12   9   4  |
|-----------------------------------------|
| 000 0010 1   size 1   0   000 0   10  1   Pg  Zn  Rd  |
```

#### Decode (A64.sve.sve_perm_pred.sve_int_perm_last_r.lasta_r_p_z_)
...
#### Execute (A64.sve.sve_perm_pred.sve_int_perm_last_r.lasta_r_p_z_)
