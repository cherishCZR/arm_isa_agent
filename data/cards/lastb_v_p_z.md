...
**Title**: LASTB (SIMD&FP scalar) -- A64 | **Class**: `sve` | **XML ID**: `lastb_v_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Extract last element to SIMD&FP scalar register
...
### Variant: `SVE`
- **Assembly**: `LASTB  <V><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  16 15  13 12   9   4  |
|-----------------------------------------|
| 000 0010 1   size 1   0   001 1   10  0   Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_perm_pred.sve_int_perm_last_v.lastb_v_p_z_)
...
#### Execute (A64.sve.sve_perm_pred.sve_int_perm_last_v.lastb_v_p_z_)
