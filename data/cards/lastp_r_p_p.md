...
**Title**: LASTP -- A64 | **Class**: `sve2` | **XML ID**: `lastp_r_p_p`

**Architecture**: `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Scalar index of last true predicate element (predicated)

**Description**:
Determines the index of the last active and true element of the source
...
### Variant: `SVE2`
- **Assembly**: `LASTP  <Xd>, <Pg>, <Pn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  15  13   9  8   4  |
|-----------------------------------|
| 001 0010 1   size 100 010 10  Pg  0   Pn  Rd  |
```

#### Decode (A64.sve.sve_pred_count_a.sve_int_pcount_pred.lastp_r_p_p_)
...
#### Execute (A64.sve.sve_pred_count_a.sve_int_pcount_pred.lastp_r_p_p_)
