...
**Title**: LD1H (scalar plus scalar, tile slice) -- A64 | **Class**: `mortlach` | **XML ID**: `ld1h_za_p_rrr`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Contiguous load of halfwords to 16-bit element ZA tile slice

**Description**:
This instruction performs a contiguous load of halfwords to a 16-bit element ZA tile slice. The slice number within the tile is selected by
...
### Variant: `SME`
- **Assembly**: `LD1H  { <ZAt><HV>.H[<Ws>, <offs>] }, <Pg>/Z, [<Xn|SP>{, <Xm>, LSL #1}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   11  0000 0   01  0   Rm  V   Rs  Pg  Rn  0   ZAt off3 |
```

#### Decode (A64.sme.mortlach_mem.mortlach_contig_load.ld1h_za_p_rrr_)
...
#### Execute (A64.sme.mortlach_mem.mortlach_contig_load.ld1h_za_p_rrr_)
