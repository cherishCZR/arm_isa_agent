...
**Title**: LD1Q -- A64 | **Class**: `mortlach` | **XML ID**: `ld1q_za_p_rrr`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Contiguous load of quadwords to 128-bit element ZA tile slice

**Description**:
This instruction performs a contiguous load of quadwords to a 128-bit element ZA tile slice.
The slice number in the tile is selected by the slice index register,
...
### Variant: `SME`
- **Assembly**: `LD1Q  { <ZAt><HV>.Q[<Ws>, <offs>] }, <Pg>/Z, [<Xn|SP>{, <Xm>, LSL #4}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  20  15 14  12   9   4  3  |
|-----------------------------------|
| 1   11  0000 1110 Rm  V   Rs  Pg  Rn  0   ZAt |
```

#### Decode (A64.sme.mortlach_mem.mortlach_contig_qload.ld1q_za_p_rrr_)
...
#### Execute (A64.sme.mortlach_mem.mortlach_contig_qload.ld1q_za_p_rrr_)
