...
**Title**: LD1RB -- A64 | **Class**: `sve` | **XML ID**: `ld1rb_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Load and broadcast unsigned byte to vector

**Description**:
Load a single unsigned byte from a
...
- **Assembly**: `LD1RB  { <Zt>.B }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 00  1   imm6 1   00  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rb_z_p_bi_u8)
...
#### Execute (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rb_z_p_bi_u8)
...
- **Assembly**: `LD1RB  { <Zt>.H }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 00  1   imm6 1   01  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rb_z_p_bi_u16)
...
- **Assembly**: `LD1RB  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 00  1   imm6 1   10  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rb_z_p_bi_u32)
...
- **Assembly**: `LD1RB  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 00  1   imm6 1   11  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rb_z_p_bi_u64)
...
| `<imm>` | `immediate` | `imm6` | Is the optional unsigned immediate byte offset, in the range 0 to 63, defaulting to 0, encoded in the "imm6" field. |
