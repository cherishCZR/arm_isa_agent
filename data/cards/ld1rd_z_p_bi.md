...
**Title**: LD1RD -- A64 | **Class**: `sve` | **XML ID**: `ld1rd_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Load and broadcast doubleword to vector

**Description**:
Load a single  doubleword from a
memory address generated by a 64-bit scalar base
address plus an immediate offset which is
a multiple of 8 in the range 0 to 504.
...
### Variant: `SVE`
- **Assembly**: `LD1RD  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 11  1   imm6 1   11  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rd_z_p_bi_u64)
...
#### Execute (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rd_z_p_bi_u64)
...
| `<imm>` | `immediate` | `imm6` | Is the optional unsigned immediate byte offset, a multiple of 8 in the range 0 to 504, defaulting to 0, encoded in the "imm6" field. |
