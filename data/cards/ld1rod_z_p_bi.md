...
**Title**: LD1ROD (scalar plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ld1rod_z_p_bi`

**Architecture**: `FEAT_F64MM` (PROFILE_A)

**Summary**: Contiguous load and replicate four doublewords (immediate index)
...
### Variant: `SVE`
- **Assembly**: `LD1ROD  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 11  01  0   imm4 001 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1rod_z_p_bi_u64)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1rod_z_p_bi_u64)
