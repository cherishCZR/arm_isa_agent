...
**Title**: LD1ROH (scalar plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ld1roh_z_p_bi`

**Architecture**: `FEAT_F64MM` (PROFILE_A)

**Summary**: Contiguous load and replicate sixteen halfwords (immediate index)

**Description**:
Load sixteen contiguous  halfwords to elements of a
...
### Variant: `SVE`
- **Assembly**: `LD1ROH  { <Zt>.H }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 01  01  0   imm4 001 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1roh_z_p_bi_u16)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1roh_z_p_bi_u16)
