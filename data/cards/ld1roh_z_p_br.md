...
**Title**: LD1ROH (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld1roh_z_p_br`

**Architecture**: `FEAT_F64MM` (PROFILE_A)

**Summary**: Contiguous load and replicate sixteen halfwords (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD1ROH  { <Zt>.H }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 01  01  ?   000 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1roh_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1roh_z_p_br_contiguous)
