...
**Title**: LD1ROW (scalar plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ld1row_z_p_bi`

**Architecture**: `FEAT_F64MM` (PROFILE_A)

**Summary**: Contiguous load and replicate eight words (immediate index)

**Description**:
Load eight contiguous  words to elements of a
...
Only the first eight predicate elements are used and higher
...
### Variant: `SVE`
- **Assembly**: `LD1ROW  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 10  01  0   imm4 001 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1row_z_p_bi_u32)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_si.ld1row_z_p_bi_u32)
