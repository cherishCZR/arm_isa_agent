...
**Title**: LD1RQB (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld1rqb_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load and replicate sixteen bytes (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD1RQB  { <Zt>.B }, <Pg>/Z, [<Xn|SP>, <Xm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 00  00  ?   000 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqb_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqb_z_p_br_contiguous)
