...
**Title**: LD1RQD (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld1rqd_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load and replicate two doublewords (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD1RQD  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #3]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 11  00  ?   000 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqd_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqd_z_p_br_contiguous)
