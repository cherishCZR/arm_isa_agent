...
**Title**: LD1RQH (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld1rqh_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load and replicate eight halfwords (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD1RQH  { <Zt>.H }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 01  00  ?   000 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqh_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_ldqr_ss.ld1rqh_z_p_br_contiguous)
