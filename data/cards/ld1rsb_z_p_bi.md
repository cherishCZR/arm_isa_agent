...
**Title**: LD1RSB -- A64 | **Class**: `sve` | **XML ID**: `ld1rsb_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Load and broadcast signed byte to vector

**Description**:
Load a single signed byte from a
...
- **Assembly**: `LD1RSB  { <Zt>.H }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 11  1   imm6 1   10  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsb_z_p_bi_s16)
...
#### Execute (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsb_z_p_bi_s16)
...
- **Assembly**: `LD1RSB  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 11  1   imm6 1   01  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsb_z_p_bi_s32)
...
- **Assembly**: `LD1RSB  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 11  1   imm6 1   00  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsb_z_p_bi_s64)
