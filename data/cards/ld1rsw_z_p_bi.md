...
**Title**: LD1RSW -- A64 | **Class**: `sve` | **XML ID**: `ld1rsw_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Load and broadcast signed word to vector

**Description**:
Load a single signed word from a
...
### Variant: `SVE`
- **Assembly**: `LD1RSW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 01  1   imm6 1   00  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsw_z_p_bi_s64)
...
#### Execute (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rsw_z_p_bi_s64)
