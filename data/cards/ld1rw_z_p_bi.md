...
**Title**: LD1RW -- A64 | **Class**: `sve` | **XML ID**: `ld1rw_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Load and broadcast unsigned word to vector

**Description**:
Load a single unsigned word from a
memory address generated by a 64-bit scalar base
address plus an immediate offset which is
a multiple of 4 in the range 0 to 252.
...
- **Assembly**: `LD1RW  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 10  1   imm6 1   10  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rw_z_p_bi_u32)
...
#### Execute (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rw_z_p_bi_u32)
...
- **Assembly**: `LD1RW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  |
|--------------------------------|
| 100 0010 10  1   imm6 1   11  Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_ld_dup.ld1rw_z_p_bi_u64)
...
| `<imm>` | `immediate` | `imm6` | Is the optional unsigned immediate byte offset, a multiple of 4 in the range 0 to 252, defaulting to 0, encoded in the "imm6" field. |
