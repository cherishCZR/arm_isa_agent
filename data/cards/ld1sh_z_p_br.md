...
**Title**: LD1SH (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld1sh_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load signed halfwords to vector (scalar index)

**Description**:
Contiguous load
   of signed halfwords to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
- **Assembly**: `LD1SH  { <Zt>.S }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1001 ?   010 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cld_ss.ld1sh_z_p_br_s32)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cld_ss.ld1sh_z_p_br_s32)
...
- **Assembly**: `LD1SH  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1000 ?   010 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cld_ss.ld1sh_z_p_br_s64)
