...
**Title**: LD1W (scalar plus scalar, single register) -- A64 | **Class**: `N/A` | **XML ID**: `ld1w_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p1` (ARMv9.4)

**Summary**: Contiguous load unsigned words to vector (scalar index)

**Description**:
Contiguous load
   of unsigned words to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
- **Assembly**: `LD1W  { <Zt>.S }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1010 ?   010 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cld_ss.ld1w_z_p_br_u32)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cld_ss.ld1w_z_p_br_u32)
...
- **Assembly**: `LD1W  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1011 ?   010 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cld_ss.ld1w_z_p_br_u64)
...
- **Assembly**: `LD1W  { <Zt>.Q }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 10  00  ?   100 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cld_ss_q.ld1w_z_p_br_u128)
