...
**Title**: LD1W (scalar plus scalar, tile slice) -- A64 | **Class**: `mortlach` | **XML ID**: `ld1w_za_p_rrr`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Contiguous load of words to 32-bit element ZA tile slice

**Description**:
This instruction performs a contiguous load of words to a 32-bit element ZA tile slice. The slice number within the tile is selected by
...
### Variant: `SME`
- **Assembly**: `LD1W  { <ZAt><HV>.S[<Ws>, <offs>] }, <Pg>/Z, [<Xn|SP>{, <Xm>, LSL #2}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14  12   9   4  3   1  |
|--------------------------------------------|
| 1   11  0000 0   10  0   Rm  V   Rs  Pg  Rn  0   ZAt off2 |
```

#### Decode (A64.sme.mortlach_mem.mortlach_contig_load.ld1w_za_p_rrr_)
...
#### Execute (A64.sme.mortlach_mem.mortlach_contig_load.ld1w_za_p_rrr_)
