...
**Title**: LD2B (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld2b_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load two-byte structures to two vectors (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD2B  { <Zt1>.B, <Zt2>.B }, <Pg>/Z, [<Xn|SP>, <Xm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 00  01  ?   110 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eld_ss.ld2b_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eld_ss.ld2b_z_p_br_contiguous)
