...
**Title**: LD2Q (scalar plus immediate) -- A64 | **Class**: `sve2` | **XML ID**: `ld2q_z_p_bi`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Contiguous load two-quadword structures to two vectors (immediate index)

**Description**:
Contiguous load two-quadword structures, each
...
### Variant: `SVE2`
- **Assembly**: `LD2Q  { <Zt1>.Q, <Zt2>.Q }, <Pg>/Z, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 01  00  1   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eldq_si.ld2q_z_p_bi_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eldq_si.ld2q_z_p_bi_contiguous)
