...
**Title**: LD3B (scalar plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ld3b_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load three-byte structures to three vectors (immediate index)

**Description**:
Contiguous load three-byte structures, each
...
### Variant: `SVE`
- **Assembly**: `LD3B  { <Zt1>.B, <Zt2>.B, <Zt3>.B }, <Pg>/Z, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 00  10  0   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eld_si.ld3b_z_p_bi_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eld_si.ld3b_z_p_bi_contiguous)
