...
**Title**: LD3B (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld3b_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load three-byte structures to three vectors (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD3B  { <Zt1>.B, <Zt2>.B, <Zt3>.B }, <Pg>/Z, [<Xn|SP>, <Xm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 00  10  ?   110 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eld_ss.ld3b_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eld_ss.ld3b_z_p_br_contiguous)
