...
**Title**: LD3D (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld3d_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load three-doubleword structures to three vectors (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD3D  { <Zt1>.D, <Zt2>.D, <Zt3>.D }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #3]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 11  10  ?   110 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eld_ss.ld3d_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eld_ss.ld3d_z_p_br_contiguous)
