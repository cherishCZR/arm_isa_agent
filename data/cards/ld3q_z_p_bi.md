...
**Title**: LD3Q (scalar plus immediate) -- A64 | **Class**: `sve2` | **XML ID**: `ld3q_z_p_bi`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Contiguous load three-quadword structures to three vectors (immediate index)

**Description**:
Contiguous load three-quadword structures, each
...
### Variant: `SVE2`
- **Assembly**: `LD3Q  { <Zt1>.Q, <Zt2>.Q, <Zt3>.Q }, <Pg>/Z, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 101 0010 10  00  1   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eldq_si.ld3q_z_p_bi_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eldq_si.ld3q_z_p_bi_contiguous)
