...
**Title**: LD3Q (scalar plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `ld3q_z_p_br`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Contiguous load three-quadword structures to three vectors (scalar index)
...
### Variant: `SVE2`
- **Assembly**: `LD3Q  { <Zt1>.Q, <Zt2>.Q, <Zt3>.Q }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #4]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 10  01  ?   100 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eldq_ss.ld3q_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eldq_ss.ld3q_z_p_br_contiguous)
