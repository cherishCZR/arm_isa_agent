...
**Title**: LD3W (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ld3w_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load three-word structures to three vectors (scalar index)
...
### Variant: `SVE`
- **Assembly**: `LD3W  { <Zt1>.S, <Zt2>.S, <Zt3>.S }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 10  10  ?   110 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_eld_ss.ld3w_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_eld_ss.ld3w_z_p_br_contiguous)
