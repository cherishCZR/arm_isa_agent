...
**Title**: LDFF1B (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ldff1b_z_p_br`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Contiguous load first-fault unsigned bytes to vector (scalar index)

**Description**:
Contiguous load
with first-faulting behavior   of unsigned bytes to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
- **Assembly**: `LDFF1B  { <Zt>.B }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 0000 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1b_z_p_br_u8)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1b_z_p_br_u8)
...
- **Assembly**: `LDFF1B  { <Zt>.H }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 0001 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1b_z_p_br_u16)
...
- **Assembly**: `LDFF1B  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 0010 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1b_z_p_br_u32)
...
- **Assembly**: `LDFF1B  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 0011 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1b_z_p_br_u64)
