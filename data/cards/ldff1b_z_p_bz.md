...
**Title**: LDFF1B (scalar plus vector) -- A64 | **Class**: `sve` | **XML ID**: `ldff1b_z_p_bz`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather load first-fault unsigned bytes to vector (vector index)

**Description**:
Gather load with first-faulting behavior
of unsigned bytes to active elements of a vector register
...
- **Assembly**: `LDFF1B  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 110 0010 00  xs  0   Zm  0   1   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vs.ldff1b_z_p_bz_d_x32_unscaled)
...
#### Execute (A64.sve.sve_mem64.sve_mem_64b_gld_vs.ldff1b_z_p_bz_d_x32_unscaled)
...
- **Assembly**: `LDFF1B  { <Zt>.S }, <Pg>/Z, [<Xn|SP>, <Zm>.S, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 100 0010 00  xs  0   Zm  0   1   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_32b_gld_vs.ldff1b_z_p_bz_s_x32_unscaled)
...
- **Assembly**: `LDFF1B  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 00  10  Zm  1   1   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vs2.ldff1b_z_p_bz_d_64_unscaled)
