...
**Title**: LDFF1D (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ldff1d_z_p_br`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Contiguous load first-fault doublewords to vector (scalar index)

**Description**:
Contiguous load
with first-faulting behavior   of  doublewords to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
### Variant: `SVE`
- **Assembly**: `LDFF1D  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, <Xm>, LSL #3}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1111 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1d_z_p_br_u64)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1d_z_p_br_u64)
