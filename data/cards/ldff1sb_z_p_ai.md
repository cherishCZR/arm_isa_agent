...
**Title**: LDFF1SB (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ldff1sb_z_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather load first-fault signed bytes to vector (immediate index)
...
- **Assembly**: `LDFF1SB  { <Zt>.S }, <Pg>/Z, [<Zn>.S{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 100 0010 00  01  imm5 1   0   1   Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_mem32.sve_mem_32b_gld_vi.ldff1sb_z_p_ai_s)
...
#### Execute (A64.sve.sve_mem32.sve_mem_32b_gld_vi.ldff1sb_z_p_ai_s)
...
- **Assembly**: `LDFF1SB  { <Zt>.D }, <Pg>/Z, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 00  01  imm5 1   0   1   Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vi.ldff1sb_z_p_ai_d)
