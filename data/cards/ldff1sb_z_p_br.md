...
**Title**: LDFF1SB (scalar plus scalar) -- A64 | **Class**: `sve` | **XML ID**: `ldff1sb_z_p_br`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Contiguous load first-fault signed bytes to vector (scalar index)

**Description**:
Contiguous load
with first-faulting behavior   of signed bytes to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
- **Assembly**: `LDFF1SB  { <Zt>.H }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1110 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1sb_z_p_br_s16)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1sb_z_p_br_s16)
...
- **Assembly**: `LDFF1SB  { <Zt>.S }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1101 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1sb_z_p_br_s32)
...
- **Assembly**: `LDFF1SB  { <Zt>.D }, <Pg>/Z, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  12   9   4  |
|--------------------------|
| 101 0010 1100 Rm  011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldff_ss.ldff1sb_z_p_br_s64)
