...
**Title**: LDFF1SW (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `ldff1sw_z_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather load first-fault signed words to vector (immediate index)
...
### Variant: `SVE`
- **Assembly**: `LDFF1SW  { <Zt>.D }, <Pg>/Z, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 10  01  imm5 1   0   1   Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vi.ldff1sw_z_p_ai_d)
...
#### Execute (A64.sve.sve_mem64.sve_mem_64b_gld_vi.ldff1sw_z_p_ai_d)
