...
**Title**: LDFF1SW (scalar plus vector) -- A64 | **Class**: `sve` | **XML ID**: `ldff1sw_z_p_bz`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather load first-fault signed words to vector (vector index)

**Description**:
Gather load with first-faulting behavior
of signed words to active elements of a vector register
...
- **Assembly**: `LDFF1SW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D, <mod> #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 110 0010 10  xs  1   Zm  0   0   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_sv.ldff1sw_z_p_bz_d_x32_scaled)
...
#### Execute (A64.sve.sve_mem64.sve_mem_64b_gld_sv.ldff1sw_z_p_bz_d_x32_scaled)
...
- **Assembly**: `LDFF1SW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 110 0010 10  xs  0   Zm  0   0   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vs.ldff1sw_z_p_bz_d_x32_unscaled)
...
- **Assembly**: `LDFF1SW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 10  11  Zm  1   0   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_sv2.ldff1sw_z_p_bz_d_64_scaled)
...
- **Assembly**: `LDFF1SW  { <Zt>.D }, <Pg>/Z, [<Xn|SP>, <Zm>.D]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 10  10  Zm  1   0   1   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gld_vs2.ldff1sw_z_p_bz_d_64_unscaled)
