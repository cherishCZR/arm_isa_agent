...
**Title**: LDNT1D (vector plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `ldnt1d_z_p_ar`

**Architecture**: `FEAT_SVE2` (ARMv9.0)

**Summary**: Gather load non-temporal unsigned doublewords

**Description**:
Gather load non-temporal of  doublewords to
...
### Variant: `SVE2`
- **Assembly**: `LDNT1D  { <Zt>.D }, <Pg>/Z, [<Zn>.D{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 110 0010 11  00  Rm  1   1   0   Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_gldnt_vs.ldnt1d_z_p_ar_d_64_unscaled)
...
#### Execute (A64.sve.sve_mem64.sve_mem_64b_gldnt_vs.ldnt1d_z_p_ar_d_64_unscaled)
