...
**Title**: LDNT1W (scalar plus scalar, single register) -- A64 | **Class**: `sve` | **XML ID**: `ldnt1w_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous load non-temporal words to vector (scalar index)

**Description**:
Contiguous load
  non-temporal of  words to elements of a vector register from the memory address generated by a 64-bit scalar base and scalar index which is
...
### Variant: `SVE`
- **Assembly**: `LDNT1W  { <Zt>.S }, <Pg>/Z, [<Xn|SP>, <Xm>, LSL #2]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 101 0010 10  00  ?   110 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcld.sve_mem_cldnt_ss.ldnt1w_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcld.sve_mem_cldnt_ss.ldnt1w_z_p_br_contiguous)
