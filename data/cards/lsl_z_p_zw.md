...
**Title**: LSL (wide elements, predicated) -- A64 | **Class**: `sve` | **XML ID**: `lsl_z_p_zw`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Logical shift left by 64-bit wide elements (predicated)

**Description**:
Shift left active elements of the first source vector by
corresponding overlapping 64-bit elements of the second source vector and destructively place the results in the corresponding elements of the first source vector.
...
### Variant: `SVE`
- **Assembly**: `LSL  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   11  0   1   1   100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_2.lsl_z_p_zw_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_2.lsl_z_p_zw_)
