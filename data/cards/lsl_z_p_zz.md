...
**Title**: LSL (vectors) -- A64 | **Class**: `sve` | **XML ID**: `lsl_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Logical shift left by vector (predicated)

**Description**:
Shift left active elements of the first source vector by
corresponding elements of the second source vector and destructively place the results in the corresponding elements of the first source vector.
The shift amount operand is a vector of unsigned elements in
...
### Variant: `SVE`
- **Assembly**: `LSL  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   10  0   1   1   100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_1.lsl_z_p_zz_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_1.lsl_z_p_zz_)
