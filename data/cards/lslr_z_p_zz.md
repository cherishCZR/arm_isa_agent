...
**Title**: LSLR -- A64 | **Class**: `sve` | **XML ID**: `lslr_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Reversed logical shift left by vector (predicated)

**Description**:
Reversed shift left active elements of the second source vector by
corresponding elements of the first source vector and destructively place the results in the corresponding elements of the first source vector.
...
### Variant: `SVE`
- **Assembly**: `LSLR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   10  1   1   1   100 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_1.lslr_z_p_zz_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_1.lslr_z_p_zz_)
