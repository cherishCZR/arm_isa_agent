...
**Title**: LSR (immediate, predicated) -- A64 | **Class**: `sve` | **XML ID**: `lsr_z_p_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Logical shift right by immediate (predicated)

**Description**:
Shift right by immediate, inserting zeroes, each active element of the source vector,
...
### Variant: `SVE`
- **Assembly**: `LSR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  17 16 15  12   9   7   4  |
|--------------------------------------------|
| 000 0010 0   tszh 0   0   00  0   1   100 Pg  tszl imm3 Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.lsr_z_p_zi_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.lsr_z_p_zi_)
