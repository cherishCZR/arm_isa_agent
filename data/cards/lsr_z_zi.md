...
**Title**: LSR (immediate, unpredicated) -- A64 | **Class**: `sve` | **XML ID**: `lsr_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Logical shift right by immediate (unpredicated)
...
### Variant: `SVE`
- **Assembly**: `LSR  <Zd>.<T>, <Zn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  12 11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   tszh 1   tszl imm3 100 1   0   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_int_unpred_shift.sve_int_bin_cons_shift_b.lsr_z_zi_)
...
#### Execute (A64.sve.sve_int_unpred_shift.sve_int_bin_cons_shift_b.lsr_z_zi_)
