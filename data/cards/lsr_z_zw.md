...
**Title**: LSR (wide elements, unpredicated) -- A64 | **Class**: `sve` | **XML ID**: `lsr_z_zw`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Logical shift right by 64-bit wide elements (unpredicated)
...
### Variant: `SVE`
- **Assembly**: `LSR  <Zd>.<T>, <Zn>.<T>, <Zm>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12 11 10  9   4  |
|--------------------------------------|
| 000 0010 0   size 1   Zm  100 0   0   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_int_unpred_shift.sve_int_bin_cons_shift_a.lsr_z_zw_)
...
#### Execute (A64.sve.sve_int_unpred_shift.sve_int_bin_cons_shift_a.lsr_z_zw_)
