...
**Title**: LUTI4 (two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `luti4_mz2_ztz`

**Architecture**: `FEAT_SME2` (ARMv9.3), `FEAT_SME2p1` (ARMv9.4)

**Summary**: Lookup table read with 4-bit indexes (two registers)
...
### Variant: `Consecutive`
- **Assembly**: `LUTI4  { <Zd1>.<T>-<Zd2>.<T> }, ZT0, <Zn>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  18  16  14 13  11   9   4   0 |
|--------------------------------------------|
| 1   10  0000 01  0   001 01  i2  1   size 00  Zn  Zd  0   |
```

#### Decode (A64.sme.mortlach_zt_expand_ctg.mortlach_expand_2dst_ctg.luti4_mz2_ztz_1)
...
#### Execute (A64.sme.mortlach_zt_expand_ctg.mortlach_expand_2dst_ctg.luti4_mz2_ztz_1)
...
```text
| 31 30  28  24  18  16  14 13  11   9   4  3  2  |
|-----------------------------------------|
| 1   10  0000 010011 01  i2  1   size 00  Zn  D   0   Zd  |
```

#### Decode (A64.sme.mortlach_zt_expand_nctg.mortlach_expand_2dst_nctg.luti4_mz2_ztz_8)
