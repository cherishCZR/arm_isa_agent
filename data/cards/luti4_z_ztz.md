...
**Title**: LUTI4 (single) -- A64 | **Class**: `mortlach2` | **XML ID**: `luti4_z_ztz`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Lookup table read with 4-bit indexes (single)

**Description**:
This instruction copies 8-bit, 16-bit or 32-bit elements from ZT0 to one destination
vector using packed 4-bit indices from a segment of the source vector register.
...
### Variant: `SME2`
- **Assembly**: `LUTI4  <Zd>.<T>, ZT0, <Zn>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  18  16  13  11   9   4  |
|--------------------------------------|
| 1   10  0000 01  1   001 01  i3  size 00  Zn  Zd  |
```

#### Decode (A64.sme.mortlach_zt_expand_ctg.mortlach_expand_1dst.luti4_z_ztz_)
...
#### Execute (A64.sme.mortlach_zt_expand_ctg.mortlach_expand_1dst.luti4_z_ztz_)
