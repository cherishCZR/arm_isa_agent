...
**Title**: MATCH -- A64 | **Class**: `sve2` | **XML ID**: `match_p_p_zz`

**Architecture**: `FEAT_SVE2` (ARMv9.0)

**Summary**: Detect any matching elements, setting the condition flags
...
### Variant: `SVE2`
- **Assembly**: `MATCH  <Pd>.<T>, <Pg>/Z, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12   9   4  3  |
|-----------------------------------|
| 010 0010 1   size 1   Zm  100 Pg  Zn  0   Pd  |
```

#### Decode (A64.sve.sve_intx_string.sve_intx_match.match_p_p_zz_)
...
#### Execute (A64.sve.sve_intx_string.sve_intx_match.match_p_p_zz_)
