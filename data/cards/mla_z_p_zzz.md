...
**Title**: MLA (vectors) -- A64 | **Class**: `sve` | **XML ID**: `mla_z_p_zzz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Multiply-add vectors (predicated), writing addend [Zda = Zda + Zn * Zm]
...
### Variant: `SVE`
- **Assembly**: `MLA  <Zda>.<T>, <Pg>/M, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   Zm  0   1   0   Pg  Zn  Zda |
```

#### Decode (A64.sve.sve_int_muladd_pred.sve_int_mlas_vvv_pred.mla_z_p_zzz_)
...
#### Execute (A64.sve.sve_int_muladd_pred.sve_int_mlas_vvv_pred.mla_z_p_zzz_)
