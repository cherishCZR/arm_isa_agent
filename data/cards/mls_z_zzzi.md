...
**Title**: MLS (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `mls_z_zzzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Multiply-subtract from accumulator (indexed)
...
### Variant: `16-bit`
- **Assembly**: `MLS  <Zda>.H, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  10  9   4  |
|--------------------------------------|
| 010 0010 0   0   i3h 1   i3l Zm  00001 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_by_indexed_elem.mls_z_zzzi_h)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_by_indexed_elem.mls_z_zzzi_h)
...
### Variant: `32-bit`
- **Assembly**: `MLS  <Zda>.S, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  00001 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_by_indexed_elem.mls_z_zzzi_s)
...
### Variant: `64-bit`
- **Assembly**: `MLS  <Zda>.D, <Zn>.D, <Zm>.D[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   11  1   i1  Zm  00001 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_by_indexed_elem.mls_z_zzzi_d)
