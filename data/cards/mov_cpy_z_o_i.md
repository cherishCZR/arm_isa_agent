## CPY `[ALIAS]`
_ARM A64 Instruction_ (Alias of cpy_z_o_i.xml)

**Title**: MOV (immediate, zeroing) -- A64 | **Class**: `sve` | **XML ID**: `mov_cpy_z_o_i`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Move signed integer immediate to vector elements (zeroing)

**Description**:
Move a signed integer immediate
...
### Variant: `SVE`
- **Assembly**: `MOV  <Zd>.<T>, <Pg>/Z, #<imm>{, <shift>}`
- **Alias of**: `CPY  <Zd>.<T>, <Pg>/Z, #<imm>{, <shift>}`
