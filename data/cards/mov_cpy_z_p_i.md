...
**Title**: MOV (immediate, merging) -- A64 | **Class**: `sve` | **XML ID**: `mov_cpy_z_p_i`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Move signed integer immediate to vector elements (merging)
...
### Variant: `SVE`
- **Assembly**: `MOV  <Zd>.<T>, <Pg>/M, #<imm>{, <shift>}`
- **Alias of**: `CPY  <Zd>.<T>, <Pg>/M, #<imm>{, <shift>}`
