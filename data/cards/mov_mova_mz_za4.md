## MOVA `[ALIAS]`
_ARM A64 Instruction_ (Alias of mova_mz_za4.xml)

**Title**: MOV (array to vector, four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mov_mova_mz_za4`
...
### Variant: `SME2`
- **Assembly**: `MOV  { <Zd1>.D-<Zd4>.D }, ZA.D[<Wv>, <offs>{, VGx4}]`
- **Alias of**: `MOVA  { <Zd1>.D-<Zd4>.D }, ZA.D[<Wv>, <offs>{, VGx4}]`
