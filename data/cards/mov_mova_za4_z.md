## MOVA `[ALIAS]`
_ARM A64 Instruction_ (Alias of mova_za4_z.xml)

**Title**: MOV (vector to tile, four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mov_mova_za4_z`
...
### Variant: `8-bit`
- **Assembly**: `MOV  ZA0<HV>.B[<Ws>, <offs1>:<offs4>], { <Zn1>.B-<Zn4>.B }`
- **Alias of**: `MOVA  ZA0<HV>.B[<Ws>, <offs1>:<offs4>], { <Zn1>.B-<Zn4>.B }`
...
### Variant: `16-bit`
- **Assembly**: `MOV  <ZAd><HV>.H[<Ws>, <offs1>:<offs4>], { <Zn1>.H-<Zn4>.H }`
- **Alias of**: `MOVA  <ZAd><HV>.H[<Ws>, <offs1>:<offs4>], { <Zn1>.H-<Zn4>.H }`
  Condition: Unconditionally
**Encoding Diagram (32-bit)**:
...
### Variant: `32-bit`
- **Assembly**: `MOV  <ZAd><HV>.S[<Ws>, <offs1>:<offs4>], { <Zn1>.S-<Zn4>.S }`
- **Alias of**: `MOVA  <ZAd><HV>.S[<Ws>, <offs1>:<offs4>], { <Zn1>.S-<Zn4>.S }`
  Condition: Unconditionally
**Encoding Diagram (32-bit)**:
...
### Variant: `64-bit`
- **Assembly**: `MOV  <ZAd><HV>.D[<Ws>, <offs1>:<offs4>], { <Zn1>.D-<Zn4>.D }`
- **Alias of**: `MOVA  <ZAd><HV>.D[<Ws>, <offs1>:<offs4>], { <Zn1>.D-<Zn4>.D }`
  Condition: Unconditionally
**Encoding Diagram (32-bit)**:
