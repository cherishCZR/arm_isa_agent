## SEL `[ALIAS]`
_ARM A64 Instruction_ (Alias of sel_p_p_pp.xml)

**Title**: MOV (predicate, merging) -- A64 | **Class**: `sve` | **XML ID**: `mov_sel_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Move predicates (merging)
...
### Variant: `SVE`
- **Assembly**: `MOV  <Pd>.B, <Pg>/M, <Pn>.B`
- **Alias of**: `SEL  <Pd>.B, <Pg>, <Pn>.B, <Pd>.B`
  Condition: Pd == Pm
