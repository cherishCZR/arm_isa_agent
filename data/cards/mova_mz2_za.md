...
**Title**: MOVA (tile to vector, two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_mz2_za`
...
### Variant: `8-bit`
- **Assembly**: `MOVA  { <Zd1>.B-<Zd2>.B }, ZA0<HV>.B[<Ws>, <offs1>:<offs2>]`
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi2_extract_ctg.mova_mz2_za_b1)
...
#### Execute (A64.sme.mortlach_ext.mortlach_multi2_extract_ctg.mova_mz2_za_b1)
...
### Variant: `16-bit`
- **Assembly**: `MOVA  { <Zd1>.H-<Zd2>.H }, <ZAn><HV>.H[<Ws>, <offs1>:<offs2>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi2_extract_ctg.mova_mz2_za_h1)
...
### Variant: `32-bit`
- **Assembly**: `MOVA  { <Zd1>.S-<Zd2>.S }, <ZAn><HV>.S[<Ws>, <offs1>:<offs2>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi2_extract_ctg.mova_mz2_za_w1)
...
### Variant: `64-bit`
- **Assembly**: `MOVA  { <Zd1>.D-<Zd2>.D }, <ZAn><HV>.D[<Ws>, <offs1>:<offs2>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi2_extract_ctg.mova_mz2_za_d1)
