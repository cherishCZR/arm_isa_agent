...
**Title**: MOVA (tile to vector, four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_mz4_za`
...
### Variant: `8-bit`
- **Assembly**: `MOVA  { <Zd1>.B-<Zd4>.B }, ZA0<HV>.B[<Ws>, <offs1>:<offs4>]`
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi4_extract_ctg.mova_mz4_za_b1)
...
#### Execute (A64.sme.mortlach_ext.mortlach_multi4_extract_ctg.mova_mz4_za_b1)
...
### Variant: `16-bit`
- **Assembly**: `MOVA  { <Zd1>.H-<Zd4>.H }, <ZAn><HV>.H[<Ws>, <offs1>:<offs4>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi4_extract_ctg.mova_mz4_za_h1)
...
### Variant: `32-bit`
- **Assembly**: `MOVA  { <Zd1>.S-<Zd4>.S }, <ZAn><HV>.S[<Ws>, <offs1>:<offs4>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi4_extract_ctg.mova_mz4_za_w1)
...
### Variant: `64-bit`
- **Assembly**: `MOVA  { <Zd1>.D-<Zd4>.D }, <ZAn><HV>.D[<Ws>, <offs1>:<offs4>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi4_extract_ctg.mova_mz4_za_d1)
