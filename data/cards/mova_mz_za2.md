...
**Title**: MOVA (array to vector, two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_mz_za2`
...
### Variant: `SME2`
- **Assembly**: `MOVA  { <Zd1>.D-<Zd2>.D }, ZA.D[<Wv>, <offs>{, VGx2}]`
...
#### Decode (A64.sme.mortlach_ext.mortlach_multi2_za_extract_ctg.mova_mz_za2_1)
...
#### Execute (A64.sme.mortlach_ext.mortlach_multi2_za_extract_ctg.mova_mz_za2_1)
