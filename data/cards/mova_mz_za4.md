...
**Title**: MOVA (array to vector, four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_mz_za4`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Move four ZA single-vector groups to four vector registers
...
### Variant: `SME2`
- **Assembly**: `MOVA  { <Zd1>.D-<Zd4>.D }, ZA.D[<Wv>, <offs>{, VGx4}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  18 17 16  14  12   9   7   4   1  |
|-----------------------------------------------|
| 1   10  0000 0   00  000 1   1   00  Rv  011 00  off3 Zd  00  |
```

#### Decode (A64.sme.mortlach_ext.mortlach_multi4_za_extract_ctg.mova_mz_za4_1)
...
#### Execute (A64.sme.mortlach_ext.mortlach_multi4_za_extract_ctg.mova_mz_za4_1)
