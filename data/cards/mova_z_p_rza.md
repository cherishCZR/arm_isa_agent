...
**Title**: MOVA (tile to vector, single) -- A64 | **Class**: `mortlach` | **XML ID**: `mova_z_p_rza`
...
### Variant: `8-bit`
- **Assembly**: `MOVA  <Zd>.B, <Pg>/M, ZA0<HV>.B[<Ws>, <offs>]`
...
#### Decode (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_b)
...
#### Execute (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_b)
...
### Variant: `16-bit`
- **Assembly**: `MOVA  <Zd>.H, <Pg>/M, <ZAn><HV>.H[<Ws>, <offs>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_h)
...
### Variant: `32-bit`
- **Assembly**: `MOVA  <Zd>.S, <Pg>/M, <ZAn><HV>.S[<Ws>, <offs>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_w)
...
### Variant: `64-bit`
- **Assembly**: `MOVA  <Zd>.D, <Pg>/M, <ZAn><HV>.D[<Ws>, <offs>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_d)
...
### Variant: `128-bit`
- **Assembly**: `MOVA  <Zd>.Q, <Pg>/M, <ZAn><HV>.Q[<Ws>, <offs>]`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ext.mortlach_extract_pred.mova_z_p_rza_q)
