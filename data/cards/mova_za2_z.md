...
**Title**: MOVA (vector to tile, two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_za2_z`
...
### Variant: `8-bit`
- **Assembly**: `MOVA  ZA0<HV>.B[<Ws>, <offs1>:<offs2>], { <Zn1>.B-<Zn2>.B }`
...
#### Decode (A64.sme.mortlach_ins.mortlach_multi2_insert_ctg.mova_za2_z_b1)
...
#### Execute (A64.sme.mortlach_ins.mortlach_multi2_insert_ctg.mova_za2_z_b1)
...
### Variant: `16-bit`
- **Assembly**: `MOVA  <ZAd><HV>.H[<Ws>, <offs1>:<offs2>], { <Zn1>.H-<Zn2>.H }`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ins.mortlach_multi2_insert_ctg.mova_za2_z_h1)
...
### Variant: `32-bit`
- **Assembly**: `MOVA  <ZAd><HV>.S[<Ws>, <offs1>:<offs2>], { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ins.mortlach_multi2_insert_ctg.mova_za2_z_w1)
...
### Variant: `64-bit`
- **Assembly**: `MOVA  <ZAd><HV>.D[<Ws>, <offs1>:<offs2>], { <Zn1>.D-<Zn2>.D }`
**Encoding Diagram (32-bit)**:
...
#### Decode (A64.sme.mortlach_ins.mortlach_multi2_insert_ctg.mova_za2_z_d1)
