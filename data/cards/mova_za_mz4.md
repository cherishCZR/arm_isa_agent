...
**Title**: MOVA (vector to array, four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `mova_za_mz4`
...
### Variant: `SME2`
- **Assembly**: `MOVA  ZA.D[<Wv>, <offs>{, VGx4}], { <Zn1>.D-<Zn4>.D }`
...
#### Decode (A64.sme.mortlach_ins.mortlach_multi4_za_insert_ctg.mova_za_mz4_1)
...
#### Execute (A64.sme.mortlach_ins.mortlach_multi4_za_insert_ctg.mova_za_mz4_1)
