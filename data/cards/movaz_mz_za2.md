...
**Title**: MOVAZ (array to vector, two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `movaz_mz_za2`

**Architecture**: `FEAT_SME2p1` (ARMv9.4)

**Summary**: Move and zero two ZA single-vector groups to vector registers
...
### Variant: `SME2`
- **Assembly**: `MOVAZ  { <Zd1>.D-<Zd2>.D }, ZA.D[<Wv>, <offs>{, VGx2}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  18 17 16  14  12   9   7   4   0 |
|-----------------------------------------------|
| 1   10  0000 0   00  000 1   1   00  Rv  010 10  off3 Zd  0   |
```

#### Decode (A64.sme.mortlach_ext.mortlach_multi2_za_extract_zero.movaz_mz_za2_1)
...
#### Execute (A64.sme.mortlach_ext.mortlach_multi2_za_extract_zero.movaz_mz_za2_1)
