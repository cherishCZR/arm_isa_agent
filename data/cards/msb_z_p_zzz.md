...
**Title**: MSB -- A64 | **Class**: `sve` | **XML ID**: `msb_z_p_zzz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Multiply-subtract vectors (predicated), writing multiplicand [Zdn = Za - Zdn * Zm]
...
### Variant: `SVE`
- **Assembly**: `MSB  <Zdn>.<T>, <Pg>/M, <Zm>.<T>, <Za>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   Zm  1   1   1   Pg  Za  Zdn |
```

#### Decode (A64.sve.sve_int_muladd_pred.sve_int_mladdsub_vvv_pred.msb_z_p_zzz_)
...
#### Execute (A64.sve.sve_int_muladd_pred.sve_int_mladdsub_vvv_pred.msb_z_p_zzz_)
