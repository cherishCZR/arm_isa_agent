...
**Title**: MUL (vectors, unpredicated) -- A64 | **Class**: `sve2` | **XML ID**: `mul_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Multiply vectors (unpredicated)
...
### Variant: `SVE2`
- **Assembly**: `MUL  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12 11   9   4  |
|-----------------------------------|
| 000 0010 0   size 1   Zm  011 0   00  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_unpred_arit_b.sve_int_mul_b.mul_z_zz_)
...
#### Execute (A64.sve.sve_int_unpred_arit_b.sve_int_mul_b.mul_z_zz_)
