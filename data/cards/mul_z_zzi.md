...
**Title**: MUL (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `mul_z_zzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Multiply (indexed)
...
### Variant: `16-bit`
- **Assembly**: `MUL  <Zd>.H, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15   9   4  |
|-----------------------------------|
| 010 0010 0   0   i3h 1   i3l Zm  111110 Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_by_indexed_elem.mul_z_zzi_h)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_by_indexed_elem.mul_z_zzi_h)
...
### Variant: `32-bit`
- **Assembly**: `MUL  <Zd>.S, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15   9   4  |
|--------------------------------|
| 010 0010 0   10  1   i2  Zm  111110 Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_by_indexed_elem.mul_z_zzi_s)
...
### Variant: `64-bit`
- **Assembly**: `MUL  <Zd>.D, <Zn>.D, <Zm>.D[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15   9   4  |
|--------------------------------|
| 010 0010 0   11  1   i1  Zm  111110 Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_by_indexed_elem.mul_z_zzi_d)
