...
**Title**: NAND -- A64 | **Class**: `sve` | **XML ID**: `nand_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise NAND predicates
...
- **Assembly**: `NAND  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21  19  15  13   9  8   4  3  |
|-----------------------------------------|
| 001 0010 1   1   0   00  Pm  01  Pg  1   Pn  1   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.nand_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.nand_p_p_pp_z)
