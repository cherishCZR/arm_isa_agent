...
### Variant: `Merging`
- **Assembly**: `NOT  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   1   1   110 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.not_z_p_z_m)
...
#### Execute (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.not_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `NOT  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   0   1   110 101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_1.not_z_p_z_z)
