...
**Title**: ORR (predicates) -- A64 | **Class**: `sve` | **XML ID**: `orr_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise inclusive OR predicates
...
- **Assembly**: `ORR  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.orr_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.orr_p_p_pp_z)
