...
**Title**: ORR (vectors, unpredicated) -- A64 | **Class**: `sve` | **XML ID**: `orr_z_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise inclusive OR vectors (unpredicated)
...
#### Decode (A64.sve.sve_int_unpred_logical.sve_int_bin_cons_log.orr_z_zz_)
...
#### Execute (A64.sve.sve_int_unpred_logical.sve_int_bin_cons_log.orr_z_zz_)
