...
**Title**: ORRS -- A64 | **Class**: `sve` | **XML ID**: `orrs_p_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Bitwise inclusive OR predicates, setting the condition flags
...
- **Assembly**: `ORRS  <Pd>.B, <Pg>/Z, <Pn>.B, <Pm>.B`
...
#### Decode (A64.sve.sve_pred_gen_a.sve_int_pred_log.orrs_p_p_pp_z)
...
#### Execute (A64.sve.sve_pred_gen_a.sve_int_pred_log.orrs_p_p_pp_z)
