...
**Title**: PMULLB -- A64 | **Class**: `sve2` | **XML ID**: `pmullb_z_zz`
...
- **Assembly**: `PMULLB  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   ?   0   Zm  0   11  0   1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_cons_widening.sve_intx_cons_mul_long.pmullb_z_zz_)
...
#### Execute (A64.sve.sve_intx_cons_widening.sve_intx_cons_mul_long.pmullb_z_zz_)
...
- **Assembly**: `PMULLB  <Zd>.Q, <Zn>.D, <Zm>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   00  0   Zm  0   11  0   1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_cons_widening.sve_intx_cons_mul_long.pmullb_z_zz_q)
