...
**Title**: PRFB (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `prfb_i_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather prefetch bytes (vector plus immediate)
...
- **Assembly**: `PRFB  <prfop>, <Pg>, [<Zn>.S{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  3  |
|--------------------------------|
| 100 0010 00  00  imm5 111 Pg  Zn  0   prfop |
```

#### Decode (A64.sve.sve_mem32.sve_mem_32b_prfm_vi.prfb_i_p_ai_s)
...
#### Execute (A64.sve.sve_mem32.sve_mem_32b_prfm_vi.prfb_i_p_ai_s)
...
- **Assembly**: `PRFB  <prfop>, <Pg>, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  3  |
|--------------------------------|
| 110 0010 00  00  imm5 111 Pg  Zn  0   prfop |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_prfm_vi.prfb_i_p_ai_d)
