...
**Title**: PRFB (scalar plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `prfb_i_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous prefetch bytes (immediate index)

**Description**:
Contiguous prefetch of byte elements
...
### Variant: `SVE`
- **Assembly**: `PRFB  <prfop>, <Pg>, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21  15 14  12   9   4  3  |
|-----------------------------------|
| 100 0010 11  1   imm6 0   00  Pg  Rn  0   prfop |
```

#### Decode (A64.sve.sve_mem32.sve_mem_prfm_si.prfb_i_p_bi_s)
...
#### Execute (A64.sve.sve_mem32.sve_mem_prfm_si.prfb_i_p_bi_s)
