...
**Title**: PRFD (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `prfd_i_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Gather prefetch doublewords (vector plus immediate)
...
- **Assembly**: `PRFD  <prfop>, <Pg>, [<Zn>.S{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  3  |
|--------------------------------|
| 100 0010 11  00  imm5 111 Pg  Zn  0   prfop |
```

#### Decode (A64.sve.sve_mem32.sve_mem_32b_prfm_vi.prfd_i_p_ai_s)
...
#### Execute (A64.sve.sve_mem32.sve_mem_32b_prfm_vi.prfd_i_p_ai_s)
...
- **Assembly**: `PRFD  <prfop>, <Pg>, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  3  |
|--------------------------------|
| 110 0010 11  00  imm5 111 Pg  Zn  0   prfop |
```

#### Decode (A64.sve.sve_mem64.sve_mem_64b_prfm_vi.prfd_i_p_ai_d)
...
| `<imm>` | `immediate` | `imm5` | Is the optional unsigned immediate byte offset, a multiple of 8 in the range 0 to 248, defaulting to 0, encoded in the "imm5" field. |
