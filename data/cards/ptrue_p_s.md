...
**Title**: PTRUE (predicate) -- A64 | **Class**: `sve` | **XML ID**: `ptrue_p_s`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Initialise predicate from named constraint
...
Instruction exception. Does not set the condition flags.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `Not setting the condition flags`
- **Assembly**: `PTRUE  <Pd>.<T>{, <pattern>}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  19  16 15  13  10  9   4  3  |
|-----------------------------------------|
| 001 0010 1   size 01  100 0   11  100 0   pattern 0   Pd  |
```

#### Decode (A64.sve.sve_pred_gen_d.sve_int_ptrue.ptrue_p_s_)
...
#### Execute (A64.sve.sve_pred_gen_d.sve_int_ptrue.ptrue_p_s_)
