...
**Title**: RADDHNB -- A64 | **Class**: `sve2` | **XML ID**: `raddhnb_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Rounding add narrow high part (bottom)
...
half-width destination elements, while setting the odd-numbered elements to zero.
This instruction is unpredicated.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE2`
- **Assembly**: `RADDHNB  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   size 1   Zm  0   11  0   1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.raddhnb_z_zz_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.raddhnb_z_zz_)
