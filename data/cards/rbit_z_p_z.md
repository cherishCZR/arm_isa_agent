...
### Variant: `Merging`
- **Assembly**: `RBIT  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  17  15  13 12   9   4  |
|-----------------------------------------|
| 000 0010 1   size 1   0   01  11  10  0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_pred.sve_int_perm_rev.rbit_z_p_z_m)
...
#### Execute (A64.sve.sve_perm_pred.sve_int_perm_rev.rbit_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `RBIT  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  17  15  13 12   9   4  |
|-----------------------------------------|
| 000 0010 1   size 1   0   01  11  10  1   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_pred.sve_int_perm_rev.rbit_z_p_z_z)
