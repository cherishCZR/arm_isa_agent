...
**Title**: RSUBHNB -- A64 | **Class**: `sve2` | **XML ID**: `rsubhnb_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Rounding subtract narrow high part (bottom)
...
the most significant rounded half of the result in the even-numbered
half-width destination elements, while setting the odd-numbered half-width
destination elements to zero.
This instruction is unpredicated.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE2`
- **Assembly**: `RSUBHNB  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   size 1   Zm  0   11  1   1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.rsubhnb_z_zz_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.rsubhnb_z_zz_)
...
for e = 0 to elements-1
    ...
    constant integer res = ((element1 - element2) + (1 << (halfesize - 1))) >> halfesize;
