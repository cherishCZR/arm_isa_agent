...
**Title**: RSUBHNT -- A64 | **Class**: `sve2` | **XML ID**: `rsubhnt_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Rounding subtract narrow high part (top)
...
the most significant rounded half of the result in the odd-numbered
...
### Variant: `SVE2`
- **Assembly**: `RSUBHNT  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   size 1   Zm  0   11  1   1   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.rsubhnt_z_zz_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_arith_narrow.rsubhnt_z_zz_)
