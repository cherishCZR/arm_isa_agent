...
**Title**: SABA -- A64 | **Class**: `sve2` | **XML ID**: `saba_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed absolute difference and accumulate

**Description**:
Compute the absolute difference between signed integer values in
...
### Variant: `SVE2`
- **Assembly**: `SABA  <Zda>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  10  9   4  |
|-----------------------------------|
| 010 0010 1   size 0   Zm  11  111 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_aba.saba_z_zzz_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_aba.saba_z_zzz_)
