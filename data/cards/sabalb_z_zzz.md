...
**Title**: SABALB -- A64 | **Class**: `sve2` | **XML ID**: `sabalb_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed absolute difference and accumulate long (bottom)
...
### Variant: `SVE2`
- **Assembly**: `SABALB  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11 10  9   4  |
|--------------------------------------|
| 010 0010 1   size 0   Zm  11  00  0   0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_aba_long.sabalb_z_zzz_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_aba_long.sabalb_z_zzz_)
