...
**Title**: SADDLB -- A64 | **Class**: `sve2` | **XML ID**: `saddlb_z_zz`
...
**Description**:
Add the corresponding even-numbered signed elements of the first and
...
### Variant: `SVE2`
- **Assembly**: `SADDLB  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12 11 10  9   4  |
|--------------------------------------------|
| 010 0010 1   size 0   Zm  0   0   0   0   0   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_cons_widening.sve_intx_cons_arith_long.saddlb_z_zz_)
...
#### Execute (A64.sve.sve_intx_cons_widening.sve_intx_cons_arith_long.saddlb_z_zz_)
