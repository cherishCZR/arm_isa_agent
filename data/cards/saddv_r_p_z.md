...
**Title**: SADDV -- A64 | **Class**: `sve` | **XML ID**: `saddv_r_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed add reduction to scalar

**Description**:
Signed add horizontally across all lanes of a vector, and place the result in the
...
### Variant: `SVE`
- **Assembly**: `SADDV  <Dd>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  17 16 15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   000 0   0   001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_int_pred_red.sve_int_reduce_0.saddv_r_p_z_)
...
#### Execute (A64.sve.sve_int_pred_red.sve_int_reduce_0.saddv_r_p_z_)
