...
**Title**: SCLAMP -- A64 | **Class**: `mortlach2` | **XML ID**: `sclamp_mz_zz`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed clamp to minimum/maximum vector

**Description**:
This instruction clamps each signed element in the two or four destination vectors to between
the signed minimum value in the corresponding element of the first source vector and
the signed maximum value in the corresponding element of the second source vector and
...
- **Assembly**: `SCLAMP  { <Zd1>.<T>-<Zd2>.<T> }, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   size 1   Zm  110 001 Zn  Zd  0   |
```

#### Decode (A64.sme.mortlach_multi_sve_3.mortlach_multi2_clamp_int.sclamp_mz_zz_2)
...
#### Execute (A64.sme.mortlach_multi_sve_3.mortlach_multi2_clamp_int.sclamp_mz_zz_2)
...
- **Assembly**: `SCLAMP  { <Zd1>.<T>-<Zd4>.<T> }, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4   1  0 |
|-----------------------------------------|
| 1   10  0000 1   size 1   Zm  110 011 Zn  Zd  0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_3.mortlach_multi4_clamp_int.sclamp_mz_zz_4)
