...
**Title**: SCVTF (predicated) -- A64 | **Class**: `sve` | **XML ID**: `scvtf_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Signed integer convert to floating-point (predicated)

**Description**:
Convert to floating-point from the signed integer in each active element of the source vector,
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/M, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   10  01  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_h2fp16)
...
#### Execute (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_h2fp16)
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/Z, <Zn>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 10  0   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_h2fp16z)
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   10  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_w2fp16)
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 10  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_w2fp16z)
...
- **Assembly**: `SCVTF  <Zd>.S, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   10  0   10  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_w2s)
...
- **Assembly**: `SCVTF  <Zd>.S, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   10  011 10  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_w2sz)
...
- **Assembly**: `SCVTF  <Zd>.D, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   10  00  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_w2d)
...
- **Assembly**: `SCVTF  <Zd>.D, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 10  0   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_w2dz)
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   01  0   10  11  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_x2fp16)
...
- **Assembly**: `SCVTF  <Zd>.H, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   01  011 10  1   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_x2fp16z)
...
- **Assembly**: `SCVTF  <Zd>.S, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   10  10  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_x2s)
...
- **Assembly**: `SCVTF  <Zd>.S, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 10  1   1   0   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_x2sz)
...
- **Assembly**: `SCVTF  <Zd>.D, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 011 0010 1   11  0   10  11  0   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_unary.sve_fp_2op_p_zd_c.scvtf_z_p_z_x2d)
...
- **Assembly**: `SCVTF  <Zd>.D, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18  16 15 14 13 12   9   4  |
|-----------------------------------------|
| 011 0010 0   11  011 10  1   1   1   0   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_fp_zeroing_unary.sve_fp_z2op_p_zd_c.scvtf_z_p_z_x2dz)
