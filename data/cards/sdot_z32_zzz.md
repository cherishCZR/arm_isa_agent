...
**Title**: SDOT (2-way, vectors) -- A64 | **Class**: `sve2` | **XML ID**: `sdot_z32_zzz`
...
- **Assembly**: `SDOT  <Zda>.S, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  15  10  9   4  |
|--------------------------|
| 010 0010 0000 Zm  11001 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_dot2.sve_intx_dot2.sdot_z32_zzz_)
...
#### Execute (A64.sve.sve_intx_dot2.sve_intx_dot2.sdot_z32_zzz_)
