...
**Title**: SDOT (2-way, indexed) -- A64 | **Class**: `sve2` | **XML ID**: `sdot_z32_zzzi`
...
product instruction computes the dot product of a group of two signed
16-bit integer values held in each 32-bit element of the first source
vector multiplied by a group of two signed 16-bit integer values in
...
- **Assembly**: `SDOT  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  20  18  15  10  9   4  |
|-----------------------------|
| 010 0010 0100 i2  Zm  11001 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_dot2_by_indexed_elem.sve_intx_dot2_by_indexed_elem.sdot_z32_zzzi_)
...
#### Execute (A64.sve.sve_intx_dot2_by_indexed_elem.sve_intx_dot2_by_indexed_elem.sdot_z32_zzzi_)
