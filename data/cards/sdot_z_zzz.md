...
**Title**: SDOT (4-way, vectors) -- A64 | **Class**: `sve` | **XML ID**: `sdot_z_zzz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed integer dot product

**Description**:
The signed  integer  dot
...
### Variant: `SVE`
- **Assembly**: `SDOT  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  10  9   4  |
|-----------------------------------|
| 010 0010 0   1x  0   Zm  0   0000 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_dot.sdot_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_dot.sdot_z_zzz_)
