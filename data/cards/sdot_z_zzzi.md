...
**Title**: SDOT (4-way, indexed) -- A64 | **Class**: `sve` | **XML ID**: `sdot_z_zzzi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed integer indexed dot product

**Description**:
The signed  integer indexed dot
product instruction computes the dot product of a group of four signed
8-bit or 16-bit integer values held in each 32-bit or 64-bit element of the first source
vector multiplied by a group of four signed 8-bit or 16-bit integer values in
...
one less than the number of groups per 128-bit segment.
...
- **Assembly**: `SDOT  <Zda>.S, <Zn>.B, <Zm>.B[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  00000 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.sdot_z_zzzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.sdot_z_zzzi_s)
...
- **Assembly**: `SDOT  <Zda>.D, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   11  1   i1  Zm  00000 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.sdot_z_zzzi_d)
