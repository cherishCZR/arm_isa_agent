...
**Title**: SDOT (2-way, multiple and indexed vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sdot_za32_zzi`
...
vectors and two signed 16-bit integer values in the corresponding indexed 32-bit
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  1   i2  Zn  0   0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.sdot_za32_zzi_2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.sdot_za32_zzi_2xi)
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  1   i2  Zn  0   0   0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.sdot_za32_zzi_4xi)
