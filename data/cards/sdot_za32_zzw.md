...
**Title**: SDOT (2-way, multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `sdot_za32_zzw`
...
vectors and two signed 16-bit integer values in the corresponding 32-bit element of the two or four second source vectors. The widened dot product result is destructively added to
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  |
|-----------------------------------------------|
| 1   10  0000 11  1   1   Zm  00  Rv  101 Zn  0   0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_2way_dot_mm.sdot_za32_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_2way_dot_mm.sdot_za32_zzw_2x2)
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  1   1   Zm  0   10  Rv  101 Zn  00  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_2way_dot_mm.sdot_za32_zzw_4x4)
