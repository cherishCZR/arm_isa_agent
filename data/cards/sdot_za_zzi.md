...
**Title**: SDOT (4-way, multiple and indexed vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sdot_za_zzi`

**Architecture**: `FEAT_SME2` (ARMv9.3), `FEAT_SME2 && FEAT_SME_I16I64` (FEAT_SME2 && FEAT_SME_I16I64)

**Summary**: Multi-vector signed integer dot-product by indexed element

**Description**:
This instruction computes the
dot product of four signed 8-bit or 16-bit integer values held in each 32-bit
or 64-bit element of the two or four first source vectors and four signed
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.B-<Zn2>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  1   i2  Zn  1   0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.sdot_za_zzi_s2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.sdot_za_zzi_s2xi)
...
- **Assembly**: `SDOT  ZA.D[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12  10  9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   11  01  Zm  0   Rv  00  i1  Zn  0   0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_d.sdot_za_zzi_d2xi)
...
- **Assembly**: `SDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  1   i2  Zn  0   1   0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.sdot_za_zzi_s4xi)
...
- **Assembly**: `SDOT  ZA.D[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11 10  9   6   4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   11  01  Zm  1   Rv  0   0   i1  Zn  00  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_d.sdot_za_zzi_d4xi)
