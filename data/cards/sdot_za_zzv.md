...
**Title**: SDOT (4-way, multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sdot_za_zzv`
...
8-bit or 16-bit integer values in the corresponding 32-bit or 64-bit element of the second source vector. The widened dot product result is destructively added to
...
- **Assembly**: `SDOT  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zn1>.<Tb>-<Zn2>.<Tb> }, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  10  Zm  0   Rv  101 Zn  0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_4way_dot_sm.sdot_za_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_4way_dot_sm.sdot_za_zzv_2x1)
...
- **Assembly**: `SDOT  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zn1>.<Tb>-<Zn4>.<Tb> }, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  11  Zm  0   Rv  101 Zn  0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_z_za_4way_dot_sm.sdot_za_zzv_4x1)
