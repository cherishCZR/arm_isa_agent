...
**Title**: SLI -- A64 | **Class**: `sve2` | **XML ID**: `sli_z_zzi`
...
**Description**:
Shift each source vector element left by an immediate value, and insert
...
### Variant: `SVE2`
- **Assembly**: `SLI  <Zd>.<T>, <Zn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  13  10  9   4  |
|--------------------------------------|
| 010 0010 1   tszh 0   tszl imm3 11  110 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_shift_insert.sli_z_zzi_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_shift_insert.sli_z_zzi_)
...
for e = 0 to elements-1
    ...
    constant bits(esize) shiftedval = LSL(element2, shift);
