...
**Title**: SMAX (vectors) -- A64 | **Class**: `sve` | **XML ID**: `smax_z_p_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed maximum vectors (predicated)
...
### Variant: `SVE`
- **Assembly**: `SMAX  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   01  00  0   000 Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_int_pred_bin.sve_int_bin_pred_arit_1.smax_z_p_zz_)
...
#### Execute (A64.sve.sve_int_pred_bin.sve_int_bin_pred_arit_1.smax_z_p_zz_)
