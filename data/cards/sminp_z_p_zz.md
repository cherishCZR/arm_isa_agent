...
**Title**: SMINP -- A64 | **Class**: `sve2` | **XML ID**: `sminp_z_p_zz`
...
**Description**:
Compute the minimum value of each pair of adjacent signed integer
...
### Variant: `SVE2`
- **Assembly**: `SMINP  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  13 12   9   4  |
|-----------------------------------------|
| 010 0010 0   size 0   10  11  0   10  1   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_arith_binary_pairs.sminp_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_arith_binary_pairs.sminp_z_p_zz_)
