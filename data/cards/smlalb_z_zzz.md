...
**Title**: SMLALB (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `smlalb_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed multiply-add long to accumulator (bottom)
...
### Variant: `SVE2`
- **Assembly**: `SMLALB  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   size 0   Zm  0   10  0   0   0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.smlalb_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.smlalb_z_zzz_)
