...
**Title**: SMLALL (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `smlall_za_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed integer multiply-add long-long
...
- **Assembly**: `SMLALL  ZA.<T>[<Wv>, <offs1>:<offs4>{, VGx2}], { <Zn1>.<Tb>-<Zn2>.<Tb> }, { <Zm1>.<Tb>-<Zm2>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  1  0 |
|-----------------------------------------------------|
| 1   10  0000 11  sz  1   Zm  00  Rv  000 Zn  0   0   0   0   0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_mla_long_long_mm.smlall_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_mla_long_long_mm.smlall_za_zzw_2x2)
...
- **Assembly**: `SMLALL  ZA.<T>[<Wv>, <offs1>:<offs4>{, VGx4}], { <Zn1>.<Tb>-<Zn4>.<Tb> }, { <Zm1>.<Tb>-<Zm4>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  1  0 |
|--------------------------------------------------------|
| 1   10  0000 11  sz  1   Zm  0   10  Rv  000 Zn  00  0   0   0   0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_mla_long_long_mm.smlall_za_zzw_4x4)
