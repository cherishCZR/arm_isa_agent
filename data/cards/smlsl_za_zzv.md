...
**Title**: SMLSL (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `smlsl_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed integer multiply-subtract long by vector

**Description**:
This instruction multiplies each signed 16-bit element
in the one, two, or four first source
vectors
with each signed 16-bit element in the second source vector, widens each product
...
- **Assembly**: `SMLSL  ZA.S[<Wv>, <offs1>:<offs2>], <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  1   10  Zm  0   Rv  011 Zn  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi1_zz_za_mla_long_sm.smlsl_za_zzv_1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi1_zz_za_mla_long_sm.smlsl_za_zzv_1)
...
- **Assembly**: `SMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  1  |
|-----------------------------------------------|
| 1   10  0000 10  1   10  Zm  0   Rv  010 Zn  0   1   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_mla_long_sm.smlsl_za_zzv_2x1)
...
- **Assembly**: `SMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  1  |
|-----------------------------------------------|
| 1   10  0000 10  1   11  Zm  0   Rv  010 Zn  0   1   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_mla_long_sm.smlsl_za_zzv_4x1)
