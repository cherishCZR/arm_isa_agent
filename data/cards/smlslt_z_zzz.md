...
**Title**: SMLSLT (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `smlslt_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed multiply-subtract long from accumulator (top)

**Description**:
Multiply the corresponding odd-numbered signed elements of the first and
second source vectors and destructively subtract from the overlapping double-width
...
### Variant: `SVE2`
- **Assembly**: `SMLSLT  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   size 0   Zm  0   10  1   0   1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.smlslt_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.smlslt_z_zzz_)
