...
**Title**: SMOPA (2-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `smopa_za32_pp_zz`
...
2×SVLS sub-matrix of signed 16-bit integer values.
...
is then destructively added to the 32-bit integer
destination tile.
...
### Variant: `SME2`
- **Assembly**: `SMOPA  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3  2  1  |
|--------------------------------------------|
| 1   01  0000 0   10  0   Zm  Pm  Pn  Zn  0   1   0   ZAda |
```

#### Decode (A64.sme.mortlach_32bit_int_prod.mortlach_i16i32_prod.smopa_za32_pp_zz_16)
...
#### Execute (A64.sme.mortlach_32bit_int_prod.mortlach_i16i32_prod.smopa_za32_pp_zz_16)
