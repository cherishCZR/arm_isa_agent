...
**Title**: SMOPS (2-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `smops_za32_pp_zz`
...
### Variant: `SME2`
- **Assembly**: `SMOPS  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3  2  1  |
|--------------------------------------------|
| 1   01  0000 0   10  0   Zm  Pm  Pn  Zn  1   1   0   ZAda |
```

#### Decode (A64.sme.mortlach_32bit_int_prod.mortlach_i16i32_prod.smops_za32_pp_zz_16)
...
#### Execute (A64.sme.mortlach_32bit_int_prod.mortlach_i16i32_prod.smops_za32_pp_zz_16)
