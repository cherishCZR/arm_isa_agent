...
**Title**: SMULLT (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `smullt_z_zzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed multiply long (top, indexed)

**Description**:
Multiply the odd-numbered signed elements within each 128-bit segment of
the first source vector by the specified element in the corresponding
...
### Variant: `32-bit`
- **Assembly**: `SMULLT  <Zd>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   10  1   i3h Zm  110 0   i3l 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_long_by_indexed_elem.smullt_z_zzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_long_by_indexed_elem.smullt_z_zzi_s)
...
### Variant: `64-bit`
- **Assembly**: `SMULLT  <Zd>.D, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   11  1   i2h Zm  110 0   i2l 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mul_long_by_indexed_elem.smullt_z_zzi_d)
