...
**Title**: SQCVTN -- A64 | **Class**: `sve2` | **XML ID**: `sqcvtn_z_mz2`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: Signed 32-bit integer saturating extract narrow and interleave to 16-bit integer
...
### Variant: `SVE2`
- **Assembly**: `SQCVTN  <Zd>.H, { <Zn1>.S-<Zn2>.S }`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  16 15 14  12 11 10  9   5  4  |
|-----------------------------------------------------|
| 010 0010 1   0   0   1   10  00  1   0   10  0   0   0   Zn  0   Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_multi_extract_narrow.sqcvtn_z_mz2_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_multi_extract_narrow.sqcvtn_z_mz2_)
...
for e = 0 to elements-1
    for i = 0 to 1
        ...
        Elem[result, 2*e + i, esize] = SignedSat(element, esize);
