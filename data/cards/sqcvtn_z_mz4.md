...
**Title**: SQCVTN -- A64 | **Class**: `mortlach2` | **XML ID**: `sqcvtn_z_mz4`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed saturating extract narrow and interleave
...
### Variant: `SME2`
- **Assembly**: `SQCVTN  <Zd>.<T>, { <Zn1>.<Tb>-<Zn4>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   6  5  4  |
|--------------------------------------------|
| 1   10  0000 1   sz  0   1   100 11  111000 Zn  1   0   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.sqcvtn_z_mz4_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.sqcvtn_z_mz4_)
