...
**Title**: SQCVTUN -- A64 | **Class**: `mortlach2` | **XML ID**: `sqcvtun_z_mz4`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed saturating unsigned extract narrow and interleave

**Description**:
This instruction saturates the signed integer value in each element of the four source
vectors to unsigned integer value that is quarter the original source element width, and places the four-way interleaved results in the quarter-width
...
### Variant: `SME2`
- **Assembly**: `SQCVTUN  <Zd>.<T>, { <Zn1>.<Tb>-<Zn4>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   6  5  4  |
|--------------------------------------------|
| 1   10  0000 1   sz  1   1   100 11  111000 Zn  1   0   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.sqcvtun_z_mz4_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.sqcvtun_z_mz4_)
