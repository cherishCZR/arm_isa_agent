...
**Title**: SQDECH (scalar) -- A64 | **Class**: `sve` | **XML ID**: `sqdech_r_rs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed saturating decrement scalar by multiple of 16-bit predicate constraint element count
...
### Variant: `32-bit`
- **Assembly**: `SQDECH  <Xdn>, <Wdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   01  1   0   imm4 11  11  1   0   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqdech_r_rs_sx)
...
#### Execute (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqdech_r_rs_sx)
...
### Variant: `64-bit`
- **Assembly**: `SQDECH  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   01  1   1   imm4 11  11  1   0   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqdech_r_rs_x)
