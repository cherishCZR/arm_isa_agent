...
**Title**: SQDECP (vector) -- A64 | **Class**: `sve` | **XML ID**: `sqdecp_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed saturating decrement vector by count of true predicate elements
...
### Variant: `SVE`
- **Assembly**: `SQDECP  <Zdn>.<T>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18 17 16 15  11 10   8   4  |
|-----------------------------------------|
| 001 0010 1   size 101 0   1   0   1000 0   00  Pm  Zdn |
```

#### Decode (A64.sve.sve_pred_count_b.sve_int_count_v_sat.sqdecp_z_p_z_)
...
#### Execute (A64.sve.sve_pred_count_b.sve_int_count_v_sat.sqdecp_z_p_z_)
