...
**Title**: SQDMLALB (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `sqdmlalb_z_zzzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating doubling multiply-add long to accumulator (bottom, indexed)

**Description**:
Multiply then double the even-numbered signed elements within each 128-bit segment
of the first source vector and specified signed element in the corresponding
...
### Variant: `32-bit`
- **Assembly**: `SQDMLALB  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   10  1   i3h Zm  001 0   i3l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmla_long_by_indexed_elem.sqdmlalb_z_zzzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmla_long_by_indexed_elem.sqdmlalb_z_zzzi_s)
...
### Variant: `64-bit`
- **Assembly**: `SQDMLALB  <Zda>.D, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   11  1   i2h Zm  001 0   i2l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmla_long_by_indexed_elem.sqdmlalb_z_zzzi_d)
