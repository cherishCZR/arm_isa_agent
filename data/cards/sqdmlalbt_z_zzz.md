...
**Title**: SQDMLALBT -- A64 | **Class**: `sve2` | **XML ID**: `sqdmlalbt_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating doubling multiply-add long to accumulator (bottom × top)
...
### Variant: `SVE2`
- **Assembly**: `SQDMLALBT  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  10  9   4  |
|-----------------------------------|
| 010 0010 0   size 0   Zm  0   0001 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_qdmlalbt.sqdmlalbt_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_qdmlalbt.sqdmlalbt_z_zzz_)
