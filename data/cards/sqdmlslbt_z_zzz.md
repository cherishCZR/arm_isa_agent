...
**Title**: SQDMLSLBT -- A64 | **Class**: `sve2` | **XML ID**: `sqdmlslbt_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating doubling multiply-subtract long from accumulator (bottom × top)

**Description**:
Multiply then double the corresponding even-numbered signed elements of the first
and odd-numbered signed elements of the second source vector. Each intermediate value is saturated to the
...
### Variant: `SVE2`
- **Assembly**: `SQDMLSLBT  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  10  9   4  |
|-----------------------------------|
| 010 0010 0   size 0   Zm  0   0001 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_qdmlalbt.sqdmlslbt_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_qdmlalbt.sqdmlslbt_z_zzz_)
