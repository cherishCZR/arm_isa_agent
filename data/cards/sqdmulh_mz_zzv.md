...
**Title**: SQDMULH (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sqdmulh_mz_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed saturating doubling multiply high by vector

**Description**:
This instruction multiplies then doubles the corresponding signed elements of the two or four first
source vectors and
the signed elements of the second source vector, and destructively places the most significant
...
- **Assembly**: `SQDMULH  { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zdn1>.<T>-<Zdn2>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   4   0 |
|-----------------------------------------|
| 1   10  0000 1   size 10  Zm  10100 1   00  000 Zdn 0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_sqdmulh_sm.sqdmulh_mz_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_sve_2a.mortlach_multi2_z_z_sqdmulh_sm.sqdmulh_mz_zzv_2x1)
...
- **Assembly**: `SQDMULH  { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zdn1>.<T>-<Zdn4>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15  10  9   7   4   1  0 |
|--------------------------------------------|
| 1   10  0000 1   size 10  Zm  10101 1   00  000 Zdn 0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2b.mortlach_multi4_z_z_sqdmulh_sm.sqdmulh_mz_zzv_4x1)
