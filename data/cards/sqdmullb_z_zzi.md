...
**Title**: SQDMULLB (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `sqdmullb_z_zzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating doubling multiply long (bottom, indexed)

**Description**:
Multiply then double the even-numbered signed elements within each 128-bit segment
of the first source vector and the specified element in the corresponding
...
### Variant: `32-bit`
- **Assembly**: `SQDMULLB  <Zd>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  11 10  9   4  |
|--------------------------------------|
| 010 0010 0   10  1   i3h Zm  1110 i3l 0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmul_long_by_indexed_elem.sqdmullb_z_zzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmul_long_by_indexed_elem.sqdmullb_z_zzi_s)
...
### Variant: `64-bit`
- **Assembly**: `SQDMULLB  <Zd>.D, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  11 10  9   4  |
|--------------------------------------|
| 010 0010 0   11  1   i2h Zm  1110 i2l 0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmul_long_by_indexed_elem.sqdmullb_z_zzi_d)
