...
**Title**: SQDMULLT (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `sqdmullt_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating doubling multiply long (top)

**Description**:
Multiply the corresponding odd-numbered signed elements of the first and
second source vectors, double and place the results in
...
### Variant: `SVE2`
- **Assembly**: `SQDMULLT  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   size 0   Zm  0   11  0   0   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_cons_widening.sve_intx_cons_mul_long.sqdmullt_z_zz_)
...
#### Execute (A64.sve.sve_intx_cons_widening.sve_intx_cons_mul_long.sqdmullt_z_zz_)
