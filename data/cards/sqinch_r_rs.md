...
**Title**: SQINCH (scalar) -- A64 | **Class**: `sve` | **XML ID**: `sqinch_r_rs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed saturating increment scalar by multiple of 16-bit predicate constraint element count

**Description**:
Determines the number of active 16-bit
...
### Variant: `32-bit`
- **Assembly**: `SQINCH  <Xdn>, <Wdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   01  1   0   imm4 11  11  0   0   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqinch_r_rs_sx)
...
#### Execute (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqinch_r_rs_sx)
...
### Variant: `64-bit`
- **Assembly**: `SQINCH  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   01  1   1   imm4 11  11  0   0   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.sqinch_r_rs_x)
...
- isa: `A64`
- sve-esize: `esize-halfword`
- source: `sqinch_r_rs.xml`
</details>