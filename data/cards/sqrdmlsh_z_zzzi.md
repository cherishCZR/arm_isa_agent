...
**Title**: SQRDMLSH (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `sqrdmlsh_z_zzzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating rounding doubling multiply-subtract high from accumulator (indexed)
...
and destructively subtract the rounded high half of each result to
...
### Variant: `16-bit`
- **Assembly**: `SQRDMLSH  <Zda>.H, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  10  9   4  |
|--------------------------------------|
| 010 0010 0   0   i3h 1   i3l Zm  00010 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qrdmlah_by_indexed_elem.sqrdmlsh_z_zzzi_h)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_qrdmlah_by_indexed_elem.sqrdmlsh_z_zzzi_h)
...
### Variant: `32-bit`
- **Assembly**: `SQRDMLSH  <Zda>.S, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  00010 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qrdmlah_by_indexed_elem.sqrdmlsh_z_zzzi_s)
...
### Variant: `64-bit`
- **Assembly**: `SQRDMLSH  <Zda>.D, <Zn>.D, <Zm>.D[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   11  1   i1  Zm  00010 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qrdmlah_by_indexed_elem.sqrdmlsh_z_zzzi_d)
