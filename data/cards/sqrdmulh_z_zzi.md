...
**Title**: SQRDMULH (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `sqrdmulh_z_zzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating rounding doubling multiply high (indexed)
...
significant rounded half of the result in the corresponding elements of the
...
### Variant: `16-bit`
- **Assembly**: `SQRDMULH  <Zd>.H, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  10  9   4  |
|--------------------------------------|
| 010 0010 0   0   i3h 1   i3l Zm  11110 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmulh_by_indexed_elem.sqrdmulh_z_zzi_h)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmulh_by_indexed_elem.sqrdmulh_z_zzi_h)
...
### Variant: `32-bit`
- **Assembly**: `SQRDMULH  <Zd>.S, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  11110 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmulh_by_indexed_elem.sqrdmulh_z_zzi_s)
...
### Variant: `64-bit`
- **Assembly**: `SQRDMULH  <Zd>.D, <Zn>.D, <Zm>.D[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   11  1   i1  Zm  11110 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_qdmulh_by_indexed_elem.sqrdmulh_z_zzi_d)
