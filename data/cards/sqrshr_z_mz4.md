...
**Title**: SQRSHR (four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `sqrshr_z_mz4`
...
### Variant: `SME2`
- **Assembly**: `SQRSHR  <Zd>.<T>, { <Zn1>.<Tb>-<Zn4>.<Tb> }, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12  10  9   6  5  4  |
|--------------------------------------------|
| 1   10  0000 1   tsize 1   imm5 110 11  0   Zn  0   0   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_3.mortlach_multi4_qrshr.sqrshr_z_mz4_)
...
#### Execute (A64.sme.mortlach_multi_sve_3.mortlach_multi4_qrshr.sqrshr_z_mz4_)
