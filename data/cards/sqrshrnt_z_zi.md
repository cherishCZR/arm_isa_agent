...
**Title**: SQRSHRNT -- A64 | **Class**: `sve2` | **XML ID**: `sqrshrnt_z_zi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating rounding shift right narrow by immediate (top)
...
### Variant: `SVE2`
- **Assembly**: `SQRSHRNT  <Zd>.<T>, <Zn>.<Tb>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15 14 13 12 11 10  9   4  |
|--------------------------------------------------|
| 010 0010 1   0   tszh 1   tszl imm3 0   0   1   0   1   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_shift_narrow.sqrshrnt_z_zi_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_shift_narrow.sqrshrnt_z_zi_)
