...
**Title**: SQSHLR -- A64 | **Class**: `sve2` | **XML ID**: `sqshlr_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating shift left reversed vectors (predicated)

**Description**:
Shift active signed elements of the second source vector by corresponding
elements of the first source vector and destructively place the results
...
### Variant: `SVE2`
- **Assembly**: `SQSHLR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18 17 16 15  13 12   9   4  |
|-----------------------------------------------|
| 010 0010 0   size 0   0   1   1   0   0   10  0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_bin_pred_shift_sat_round.sqshlr_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_bin_pred_shift_sat_round.sqshlr_z_p_zz_)
