...
**Title**: SQSHLU -- A64 | **Class**: `sve2` | **XML ID**: `sqshlu_z_p_zi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating shift left unsigned by immediate
...
### Variant: `SVE2`
- **Assembly**: `SQSHLU  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  17 16 15  12   9   7   4  |
|--------------------------------------------|
| 000 0010 0   tszh 0   0   11  1   1   100 Pg  tszl imm3 Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.sqshlu_z_p_zi_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.sqshlu_z_p_zi_)
