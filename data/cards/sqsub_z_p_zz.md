...
**Title**: SQSUB (vectors, predicated) -- A64 | **Class**: `sve2` | **XML ID**: `sqsub_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating subtraction (predicated)

**Description**:
Subtract active signed elements of the second source vector from
corresponding signed elements of the first source vector and
...
### Variant: `SVE2`
- **Assembly**: `SQSUB  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  13 12   9   4  |
|--------------------------------------------|
| 010 0010 0   size 0   11  0   1   0   10  0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.sqsub_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.sqsub_z_p_zz_)
