...
**Title**: SQSUB (vectors, unpredicated) -- A64 | **Class**: `sve` | **XML ID**: `sqsub_z_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Signed saturating subtract vectors (unpredicated)
...
### Variant: `SVE`
- **Assembly**: `SQSUB  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 0   size 1   Zm  000 11  0   Zn  Zd  |
```

#### Decode (A64.sve.sve_int_unpred_arit.sve_int_bin_cons_arit_0.sqsub_z_zz_)
...
#### Execute (A64.sve.sve_int_unpred_arit.sve_int_bin_cons_arit_0.sqsub_z_zz_)
