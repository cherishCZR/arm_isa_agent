...
**Title**: SQXTUNT -- A64 | **Class**: `sve2` | **XML ID**: `sqxtunt_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating unsigned extract narrow (top)
...
### Variant: `SVE2`
- **Assembly**: `SQXTUNT  <Zd>.<T>, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  16 15 14  12  10  9   4  |
|-----------------------------------------------|
| 010 0010 1   0   tszh 1   tszl 00  0   0   10  10  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_extract_narrow.sqxtunt_z_zz_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_extract_narrow.sqxtunt_z_zz_)
