...
**Title**: SRSHL (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `srshl_mz_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed rounding shift left
...
- **Assembly**: `SRSHL  { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zdn1>.<T>-<Zdn2>.<T> }, { <Zm1>.<T>-<Zm2>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  16   9   7   4   0 |
|--------------------------------------|
| 1   10  0000 1   size 1   Zm  0101100 10  001 Zdn 0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_shift_mm.srshl_mz_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_sve_2c0.mortlach_multi2_z_z_shift_mm.srshl_mz_zzw_2x2)
...
- **Assembly**: `SRSHL  { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zdn1>.<T>-<Zdn4>.<T> }, { <Zm1>.<T>-<Zm4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17   9   7   4   1  0 |
|-----------------------------------------|
| 1   10  0000 1   size 1   Zm  00101110 10  001 Zdn 0   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_2d0.mortlach_multi4_z_z_shift_mm.srshl_mz_zzw_4x4)
