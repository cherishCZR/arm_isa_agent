...
**Title**: SRSHR -- A64 | **Class**: `sve2` | **XML ID**: `srshr_z_p_zi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed rounding shift right by immediate

**Description**:
Shift right by immediate each active signed element of the source
...
### Variant: `SVE2`
- **Assembly**: `SRSHR  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  17 16 15  12   9   7   4  |
|--------------------------------------------|
| 000 0010 0   tszh 0   0   11  0   0   100 Pg  tszl imm3 Zdn |
```

#### Decode (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.srshr_z_p_zi_)
...
#### Execute (A64.sve.sve_int_pred_shift.sve_int_bin_pred_shift_0.srshr_z_p_zi_)
