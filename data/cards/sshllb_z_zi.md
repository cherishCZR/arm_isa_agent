...
**Title**: SSHLLB -- A64 | **Class**: `sve2` | **XML ID**: `sshllb_z_zi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed shift left long by immediate (bottom)
...
### Variant: `SVE2`
- **Assembly**: `SSHLLB  <Zd>.<T>, <Zn>.<Tb>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  13  11 10  9   4  |
|--------------------------------------------|
| 010 0010 1   0   tszh 0   tszl imm3 10  10  0   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_constructive.sve_intx_shift_long.sshllb_z_zi_)
...
#### Execute (A64.sve.sve_intx_constructive.sve_intx_shift_long.sshllb_z_zi_)
