...
**Title**: SSRA -- A64 | **Class**: `sve2` | **XML ID**: `ssra_z_zi`
...
### Variant: `SVE2`
- **Assembly**: `SSRA  <Zda>.<T>, <Zn>.<T>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  13  11 10  9   4  |
|-----------------------------------------|
| 010 0010 1   tszh 0   tszl imm3 11  10  0   0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_sra.ssra_z_zi_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_sra.ssra_z_zi_)
...
for e = 0 to elements-1
    constant integer element = SInt(Elem[operand1, e, esize]) >> shift;
