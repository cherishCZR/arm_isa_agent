...
**Title**: SSUBLBT -- A64 | **Class**: `sve2` | **XML ID**: `ssublbt_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed subtract long (bottom - top)

**Description**:
Subtract the odd-numbered signed elements of the second source vector
from the even-numbered signed elements of the first source vector,
and place the results in the overlapping double-width elements of
...
### Variant: `SVE2`
- **Assembly**: `SSUBLBT  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11 10  9   4  |
|--------------------------------------|
| 010 0010 1   size 0   Zm  10  00  1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_constructive.sve_intx_clong.ssublbt_z_zz_)
...
#### Execute (A64.sve.sve_intx_constructive.sve_intx_clong.ssublbt_z_zz_)
