...
**Title**: SSUBLT -- A64 | **Class**: `sve2` | **XML ID**: `ssublt_z_zz`
...
**Description**:
Subtract the odd-numbered signed elements of the
...
### Variant: `SVE2`
- **Assembly**: `SSUBLT  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12 11 10  9   4  |
|--------------------------------------------|
| 010 0010 1   size 0   Zm  0   0   0   1   0   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_cons_widening.sve_intx_cons_arith_long.ssublt_z_zz_)
...
#### Execute (A64.sve.sve_intx_cons_widening.sve_intx_cons_arith_long.ssublt_z_zz_)
