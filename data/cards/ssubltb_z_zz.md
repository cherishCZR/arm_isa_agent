...
**Title**: SSUBLTB -- A64 | **Class**: `sve2` | **XML ID**: `ssubltb_z_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed subtract long (top - bottom)

**Description**:
Subtract the even-numbered signed elements of the second source vector
from the odd-numbered signed elements of the first source vector,
...
### Variant: `SVE2`
- **Assembly**: `SSUBLTB  <Zd>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11 10  9   4  |
|--------------------------------------|
| 010 0010 1   size 0   Zm  10  00  1   1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_constructive.sve_intx_clong.ssubltb_z_zz_)
...
#### Execute (A64.sve.sve_intx_constructive.sve_intx_clong.ssubltb_z_zz_)
