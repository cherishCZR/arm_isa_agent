...
**Title**: ST1B (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `st1b_z_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Scatter store bytes from a vector (immediate index)
...
- **Assembly**: `ST1B  { <Zt>.S }, <Pg>, [<Zn>.S{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 00  11  imm5 101 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vi_b.st1b_z_p_ai_s)
...
#### Execute (A64.sve.sve_memst_ss2.sve_mem_sst_vi_b.st1b_z_p_ai_s)
...
- **Assembly**: `ST1B  { <Zt>.D }, <Pg>, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 00  10  imm5 101 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vi_a.st1b_z_p_ai_d)
