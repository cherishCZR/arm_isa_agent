...
**Title**: ST1B (scalar plus immediate, single register) -- A64 | **Class**: `sve` | **XML ID**: `st1b_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous store bytes from vector (immediate index)
...
### Variant: `SVE`
- **Assembly**: `ST1B  { <Zt>.<T> }, <Pg>, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 111 0010 00  size 0   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_si.sve_mem_cst_si.st1b_z_p_bi_)
...
#### Execute (A64.sve.sve_memst_si.sve_mem_cst_si.st1b_z_p_bi_)
