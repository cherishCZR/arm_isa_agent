...
**Title**: ST1B (scalar plus vector) -- A64 | **Class**: `sve` | **XML ID**: `st1b_z_p_bz`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Scatter store bytes from a vector (vector index)

**Description**:
Scatter store
of  bytes from the active elements of a vector register
...
- **Assembly**: `ST1B  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 111 0010 00  00  Zm  1   xs  0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss.sve_mem_sst_vs_a.st1b_z_p_bz_d_x32_unscaled)
...
#### Execute (A64.sve.sve_memst_ss.sve_mem_sst_vs_a.st1b_z_p_bz_d_x32_unscaled)
...
- **Assembly**: `ST1B  { <Zt>.S }, <Pg>, [<Xn|SP>, <Zm>.S, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 111 0010 00  10  Zm  1   xs  0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss.sve_mem_sst_vs_b.st1b_z_p_bz_s_x32_unscaled)
...
- **Assembly**: `ST1B  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 00  00  Zm  101 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vs2.st1b_z_p_bz_d_64_unscaled)
