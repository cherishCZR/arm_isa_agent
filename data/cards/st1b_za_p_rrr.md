...
**Title**: ST1B (scalar plus scalar, tile slice) -- A64 | **Class**: `mortlach` | **XML ID**: `st1b_za_p_rrr`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Contiguous store of bytes from 8-bit element ZA tile slice

**Description**:
This instruction performs a contiguous store of bytes from an 8-bit element ZA tile slice. The slice number within the tile is selected by
...
### Variant: `SME`
- **Assembly**: `ST1B  { ZA0<HV>.B[<Ws>, <offs>] }, <Pg>, [<Xn|SP>{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14  12   9   4  3  |
|-----------------------------------------|
| 1   11  0000 0   00  1   Rm  V   Rs  Pg  Rn  0   off4 |
```

#### Decode (A64.sme.mortlach_mem.mortlach_contig_store.st1b_za_p_rrr_)
...
#### Execute (A64.sme.mortlach_mem.mortlach_contig_store.st1b_za_p_rrr_)
