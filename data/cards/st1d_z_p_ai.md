...
**Title**: ST1D (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `st1d_z_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Scatter store doublewords from a vector (immediate index)
...
### Variant: `SVE`
- **Assembly**: `ST1D  { <Zt>.D }, <Pg>, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 11  10  imm5 101 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vi_a.st1d_z_p_ai_d)
...
#### Execute (A64.sve.sve_memst_ss2.sve_mem_sst_vi_a.st1d_z_p_ai_d)
