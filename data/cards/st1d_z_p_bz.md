...
**Title**: ST1D (scalar plus vector) -- A64 | **Class**: `sve` | **XML ID**: `st1d_z_p_bz`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Scatter store doublewords from a vector (vector index)

**Description**:
Scatter store
of  doublewords from the active elements of a vector register
...
- **Assembly**: `ST1D  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D, <mod> #3]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 111 0010 11  01  Zm  1   xs  0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss.sve_mem_sst_sv_a.st1d_z_p_bz_d_x32_scaled)
...
#### Execute (A64.sve.sve_memst_ss.sve_mem_sst_sv_a.st1d_z_p_bz_d_x32_scaled)
...
- **Assembly**: `ST1D  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D, <mod>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 111 0010 11  00  Zm  1   xs  0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss.sve_mem_sst_vs_a.st1d_z_p_bz_d_x32_unscaled)
...
- **Assembly**: `ST1D  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D, LSL #3]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 11  01  Zm  101 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_sv2.st1d_z_p_bz_d_64_scaled)
...
- **Assembly**: `ST1D  { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 11  00  Zm  101 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vs2.st1d_z_p_bz_d_64_unscaled)
