...
**Title**: ST1D (scalar plus scalar, tile slice) -- A64 | **Class**: `mortlach` | **XML ID**: `st1d_za_p_rrr`

**Architecture**: `FEAT_SME` (PROFILE_A)

**Summary**: Contiguous store of doublewords from 64-bit element ZA tile slice

**Description**:
This instruction performs a contiguous store of doublewords from a 64-bit element ZA tile slice. The slice number within the tile is selected by
...
### Variant: `SME`
- **Assembly**: `ST1D  { <ZAt><HV>.D[<Ws>, <offs>] }, <Pg>, [<Xn|SP>{, <Xm>, LSL #3}]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14  12   9   4  3   0 |
|--------------------------------------------|
| 1   11  0000 0   11  1   Rm  V   Rs  Pg  Rn  0   ZAt o1  |
```

#### Decode (A64.sme.mortlach_mem.mortlach_contig_store.st1d_za_p_rrr_)
...
#### Execute (A64.sme.mortlach_mem.mortlach_contig_store.st1d_za_p_rrr_)
