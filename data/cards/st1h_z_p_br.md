...
**Title**: ST1H (scalar plus scalar, single register) -- A64 | **Class**: `sve` | **XML ID**: `st1h_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous store halfwords from vector (scalar index)
...
### Variant: `SVE`
- **Assembly**: `ST1H  { <Zt>.<T> }, <Pg>, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15 14 13 12   9   4  |
|-----------------------------------|
| 111 0010 01  size ?   0   1   0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_cs.sve_mem_cst_ss.st1h_z_p_br_)
...
#### Execute (A64.sve.sve_memst_cs.sve_mem_cst_ss.st1h_z_p_br_)
