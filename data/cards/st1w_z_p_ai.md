...
**Title**: ST1W (vector plus immediate) -- A64 | **Class**: `sve` | **XML ID**: `st1w_z_p_ai`

**Architecture**: `FEAT_SVE` (PROFILE_A)

**Summary**: Scatter store words from a vector (immediate index)
...
- **Assembly**: `ST1W  { <Zt>.S }, <Pg>, [<Zn>.S{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 10  11  imm5 101 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vi_b.st1w_z_p_ai_s)
...
#### Execute (A64.sve.sve_memst_ss2.sve_mem_sst_vi_b.st1w_z_p_ai_s)
...
- **Assembly**: `ST1W  { <Zt>.D }, <Pg>, [<Zn>.D{, #<imm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 10  10  imm5 101 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memst_ss2.sve_mem_sst_vi_a.st1w_z_p_ai_d)
