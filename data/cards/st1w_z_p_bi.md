...
**Title**: ST1W (scalar plus immediate, single register) -- A64 | **Class**: `N/A` | **XML ID**: `st1w_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p1` (ARMv9.4)

**Summary**: Contiguous store words from vector (immediate index)

**Description**:
Contiguous store
 of  words from elements of a vector register to the memory address
...
### Variant: `32-bit and 64-bit elements`
- **Assembly**: `ST1W  { <Zt>.<T> }, <Pg>, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20 19  15  12   9   4  |
|-----------------------------------|
| 111 0010 10  1   sz  0   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_si.sve_mem_cst_si.st1w_z_p_bi_)
...
#### Execute (A64.sve.sve_memst_si.sve_mem_cst_si.st1w_z_p_bi_)
...
- **Assembly**: `ST1W  { <Zt>.Q }, <Pg>, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 111 0010 10  00  0   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_si.sve_mem_cst_si.st1w_z_p_bi_u128)
