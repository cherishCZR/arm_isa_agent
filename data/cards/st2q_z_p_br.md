...
**Title**: ST2Q (scalar plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `st2q_z_p_br`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Contiguous store two-quadword structures from two vectors (scalar index)
...
### Variant: `SVE2`
- **Assembly**: `ST2Q  { <Zt1>.Q, <Zt2>.Q }, <Pg>, [<Xn|SP>, <Xm>, LSL #4]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 111 0010 0   01  1   ?   0   0   0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_cs.sve_mem_estq_ss.st2q_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memst_cs.sve_mem_estq_ss.st2q_z_p_br_contiguous)
