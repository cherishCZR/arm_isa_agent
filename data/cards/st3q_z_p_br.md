...
**Title**: ST3Q (scalar plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `st3q_z_p_br`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Contiguous store three-quadword structures from three vectors (scalar index)
...
### Variant: `SVE2`
- **Assembly**: `ST3Q  { <Zt1>.Q, <Zt2>.Q, <Zt3>.Q }, <Pg>, [<Xn|SP>, <Xm>, LSL #4]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14 13 12   9   4  |
|--------------------------------------|
| 111 0010 0   10  1   ?   0   0   0   Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_cs.sve_mem_estq_ss.st3q_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memst_cs.sve_mem_estq_ss.st3q_z_p_br_contiguous)
