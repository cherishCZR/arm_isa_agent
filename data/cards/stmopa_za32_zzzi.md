...
**Title**: STMOPA (2-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `stmopa_za32_zzzi`

**Architecture**: `FEAT_SME_TMOP` (ARMv9.6)

**Summary**: Signed integer sparse sum of two outer products, accumulating
...
The 2-in-4 16-bit signed values from overlapping 32-bit
...
### Variant: `SME2`
- **Assembly**: `STMOPA  <ZAda>.S, { <Zn1>.H-<Zn2>.H }, <Zm>.H, <Zk>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14 13 12 11   9   5   3  2  1  |
|-----------------------------------------------------|
| 1   00  0000 0   01  0   Zm  1   0   0   K   Zk  Zn  i2  1   0   ZAda |
```

#### Decode (A64.sme.mortlach2_ss_prod.mortlach_i16i32_2in4ss_prod.stmopa_za32_zzzi_h2x1)
...
#### Execute (A64.sme.mortlach2_ss_prod.mortlach_i16i32_2in4ss_prod.stmopa_za32_zzzi_h2x1)
