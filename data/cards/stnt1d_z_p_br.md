...
**Title**: STNT1D (scalar plus scalar, single register) -- A64 | **Class**: `sve` | **XML ID**: `stnt1d_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous store non-temporal doublewords from vector (scalar index)
...
### Variant: `SVE`
- **Assembly**: `STNT1D  { <Zt>.D }, <Pg>, [<Xn|SP>, <Xm>, LSL #3]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 11  00  ?   011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcst_nt.sve_mem_cstnt_ss.stnt1d_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcst_nt.sve_mem_cstnt_ss.stnt1d_z_p_br_contiguous)
