...
**Title**: STNT1H (vector plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `stnt1h_z_p_ar`

**Architecture**: `FEAT_SVE2` (ARMv9.0)

**Summary**: Scatter store non-temporal halfwords

**Description**:
Scatter store non-temporal of  halfwords from the active
...
- **Assembly**: `STNT1H  { <Zt>.S }, <Pg>, [<Zn>.S{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12   9   4  |
|--------------------------------|
| 111 0010 01  1   0   Rm  001 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memsst_nt.sve_mem_sstnt_32b_vs.stnt1h_z_p_ar_s_x32_unscaled)
...
#### Execute (A64.sve.sve_memsst_nt.sve_mem_sstnt_32b_vs.stnt1h_z_p_ar_s_x32_unscaled)
...
- **Assembly**: `STNT1H  { <Zt>.D }, <Pg>, [<Zn>.D{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12   9   4  |
|--------------------------------|
| 111 0010 01  0   0   Rm  001 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memsst_nt.sve_mem_sstnt_64b_vs.stnt1h_z_p_ar_d_64_unscaled)
