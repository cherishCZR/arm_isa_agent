...
**Title**: STNT1H (scalar plus scalar, single register) -- A64 | **Class**: `sve` | **XML ID**: `stnt1h_z_p_br`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous store non-temporal halfwords from vector (scalar index)
...
### Variant: `SVE`
- **Assembly**: `STNT1H  { <Zt>.H }, <Pg>, [<Xn|SP>, <Xm>, LSL #1]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20  15  12   9   4  |
|-----------------------------|
| 111 0010 01  00  ?   011 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memcst_nt.sve_mem_cstnt_ss.stnt1h_z_p_br_contiguous)
...
#### Execute (A64.sve.sve_memcst_nt.sve_mem_cstnt_ss.stnt1h_z_p_br_contiguous)
