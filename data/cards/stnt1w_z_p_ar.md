...
**Title**: STNT1W (vector plus scalar) -- A64 | **Class**: `sve2` | **XML ID**: `stnt1w_z_p_ar`

**Architecture**: `FEAT_SVE2` (ARMv9.0)

**Summary**: Scatter store non-temporal words

**Description**:
Scatter store non-temporal of  words from the active
...
- **Assembly**: `STNT1W  { <Zt>.S }, <Pg>, [<Zn>.S{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12   9   4  |
|--------------------------------|
| 111 0010 10  1   0   Rm  001 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memsst_nt.sve_mem_sstnt_32b_vs.stnt1w_z_p_ar_s_x32_unscaled)
...
#### Execute (A64.sve.sve_memsst_nt.sve_mem_sstnt_32b_vs.stnt1w_z_p_ar_s_x32_unscaled)
...
- **Assembly**: `STNT1W  { <Zt>.D }, <Pg>, [<Zn>.D{, <Xm>}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12   9   4  |
|--------------------------------|
| 111 0010 10  0   0   Rm  001 Pg  Zn  Zt  |
```

#### Decode (A64.sve.sve_memsst_nt.sve_mem_sstnt_64b_vs.stnt1w_z_p_ar_d_64_unscaled)
