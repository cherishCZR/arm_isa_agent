...
**Title**: STNT1W (scalar plus immediate, single register) -- A64 | **Class**: `sve` | **XML ID**: `stnt1w_z_p_bi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Contiguous store non-temporal words from vector (immediate index)

**Description**:
Contiguous store
non-temporal of  words from elements of a vector register to the memory address
...
### Variant: `SVE`
- **Assembly**: `STNT1W  { <Zt>.S }, <Pg>, [<Xn|SP>{, #<imm>, MUL VL}]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22  20 19  15  12   9   4  |
|--------------------------------|
| 111 0010 10  00  1   imm4 111 Pg  Rn  Zt  |
```

#### Decode (A64.sve.sve_memst_si.sve_mem_cstnt_si.stnt1w_z_p_bi_contiguous)
...
#### Execute (A64.sve.sve_memst_si.sve_mem_cstnt_si.stnt1w_z_p_bi_contiguous)
