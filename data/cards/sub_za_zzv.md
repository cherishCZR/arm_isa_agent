...
**Title**: SUB (array results, multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sub_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Subtract replicated single vector from multi-vector with ZA array vector results

**Description**:
This instruction subtracts all corresponding elements of the second source vector from
...
- **Assembly**: `SUB  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zn1>.<T>-<Zn2>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  10  Zm  0   Rv  110 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_int_sm.sub_za_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_int_sm.sub_za_zzv_2x1)
...
- **Assembly**: `SUB  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zn1>.<T>-<Zn4>.<T> }, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  sz  11  Zm  0   Rv  110 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_int_sm.sub_za_zzv_4x1)
