...
**Title**: SUDOT -- A64 | **Class**: `sve` | **XML ID**: `sudot_z_zzzi`

**Architecture**: `(FEAT_SVE || FEAT_SME) && FEAT_I8MM` ((FEAT_SVE || FEAT_SME) && FEAT_I8MM)

**Summary**: Signed by unsigned 8-bit integer indexed dot product to 32-bit integer

**Description**:
The signed by unsigned integer indexed dot
...
vector multiplied by a group of four unsigned 8-bit  integer values in
...
### Variant: `SVE`
- **Assembly**: `SUDOT  <Zda>.S, <Zn>.B, <Zm>.B[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  00011 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mixed_dot_by_indexed_elem.sudot_z_zzzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_mixed_dot_by_indexed_elem.sudot_z_zzzi_s)
