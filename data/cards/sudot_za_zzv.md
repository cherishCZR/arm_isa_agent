...
**Title**: SUDOT (4-way, multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `sudot_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed by unsigned integer dot-product by vector
...
- **Assembly**: `SUDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.B-<Zn2>.B }, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  0   10  Zm  0   Rv  101 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_mixed_dot_sm.sudot_za_zzv_s2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_mixed_dot_sm.sudot_za_zzv_s2x1)
...
- **Assembly**: `SUDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  0   11  Zm  0   Rv  101 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_z_za_mixed_dot_sm.sudot_za_zzv_s4x1)
