...
**Title**: SUQADD -- A64 | **Class**: `sve2` | **XML ID**: `suqadd_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Signed saturating addition of unsigned value

**Description**:
Add active unsigned elements of the source vector to the
corresponding signed elements of the addend vector, and
...
### Variant: `SVE2`
- **Assembly**: `SUQADD  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  13 12   9   4  |
|--------------------------------------------|
| 010 0010 0   size 0   11  1   0   0   10  0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.suqadd_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.suqadd_z_p_zz_)
