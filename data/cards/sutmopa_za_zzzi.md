...
**Title**: SUTMOPA -- A64 | **Class**: `mortlach2` | **XML ID**: `sutmopa_za_zzzi`

**Architecture**: `FEAT_SME_TMOP` (ARMv9.6)

**Summary**: Signed by unsigned integer sparse sum of four outer products, accumulating

**Description**:
This instruction generates signed by unsigned integer sum of outer
...
selected two sets of 2-in-4 8-bit signed values
from each overlapping 32-bit containers of the two
SVLS×4 sub-matrices in the first source vectors by
the four 8-bit unsigned values from the corresponding 32-bit container of the
...
The two sets of 2-in-4 8-bit signed values from overlapping 32-bit
...
### Variant: `SME2`
- **Assembly**: `SUTMOPA  <ZAda>.S, { <Zn1>.B-<Zn2>.B }, <Zm>.B, <Zk>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14 13 12 11   9   5   3  2  1  |
|-----------------------------------------------------|
| 1   00  0000 0   01  1   Zm  1   0   0   K   Zk  Zn  i2  0   0   ZAda |
```

#### Decode (A64.sme.mortlach2_ss_prod.mortlach_i8i32_2in4ss_prod.sutmopa_za_zzzi_b2x1)
...
#### Execute (A64.sme.mortlach2_ss_prod.mortlach_i8i32_2in4ss_prod.sutmopa_za_zzzi_b2x1)
