...
**Title**: SUVDOT -- A64 | **Class**: `mortlach2` | **XML ID**: `suvdot_za_zzi`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector signed by unsigned integer vertical dot-product by indexed element

**Description**:
This instruction computes the
vertical dot product of the corresponding signed 8-bit elements from the four first source
vectors and four unsigned 8-bit integer values in the corresponding indexed 32-bit element
of the second source vector. The widened dot product result is destructively added to the corresponding
32-bit element of the ZA single-vector groups.
...
### Variant: `SME2`
- **Assembly**: `SUVDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  0   i2  Zn  0   1   1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.suvdot_za_zzi_s4xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.suvdot_za_zzi_s4xi)
...
for r = 0 to 3
    ...
    for e = 0 to elements-1
        ...
        for i = 0 to 3
            ...
            constant integer element1 = SInt(Elem[operand1, 4 * e + r, esize DIV 4]);
