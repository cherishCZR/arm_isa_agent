...
**Title**: SVDOT (4-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `svdot_za_zzi`
...
- **Assembly**: `SVDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  0   i2  Zn  0   1   0   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.svdot_za_zzi_s4xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.svdot_za_zzi_s4xi)
...
- **Assembly**: `SVDOT  ZA.D[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11 10  9   6   4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   11  01  Zm  1   Rv  0   1   i1  Zn  00  0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_d.svdot_za_zzi_d4xi)
