...
**Title**: TBXQ -- A64 | **Class**: `sve2` | **XML ID**: `tbxq_z_zz`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Programmable table lookup within each quadword vector segment (merging)
...
then the corresponding destination vector element is left unchanged.
This instruction is unpredicated.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE2`
- **Assembly**: `TBXQ  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15   9   4  |
|-----------------------------|
| 000 0010 1   size 1   Zm  001101 Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_quads_c.sve_int_perm_tbxquads.tbxq_z_zz_)
...
#### Execute (A64.sve.sve_perm_quads_c.sve_int_perm_tbxquads.tbxq_z_zz_)
