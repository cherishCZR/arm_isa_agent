...
**Title**: UABA -- A64 | **Class**: `sve2` | **XML ID**: `uaba_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Unsigned absolute difference and accumulate

**Description**:
Compute the absolute difference between unsigned integer values in
elements of the second source vector and corresponding elements of the
first source vector, and add the difference to the corresponding
elements of the destination vector. This instruction is unpredicated.

**Attributes**: DIT-sensitive (condition: `FEAT_SVE2 is implemented or FEAT_SME is implemented`)

### Variant: `SVE2`
- **Assembly**: `UABA  <Zda>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  10  9   4  |
|-----------------------------------|
| 010 0010 1   size 0   Zm  11  111 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_acc.sve_intx_aba.uaba_z_zzz_)
...
#### Execute (A64.sve.sve_intx_acc.sve_intx_aba.uaba_z_zzz_)
