...
**Title**: UADALP -- A64 | **Class**: `sve2` | **XML ID**: `uadalp_z_p_z`
...
**Description**:
Add pairs of adjacent unsigned integer values and accumulate the results
...
### Variant: `SVE2`
- **Assembly**: `UADALP  <Zda>.<T>, <Pg>/M, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  16 15  13 12   9   4  |
|--------------------------------------|
| 010 0010 0   size 0   0010 1   10  1   Pg  Zn  Zda |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_accumulate_long_pairs.uadalp_z_p_z_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_accumulate_long_pairs.uadalp_z_p_z_)
...
for e = 0 to elements-1
    if !ActivePredicateElement(mask, e, esize) then
        ...
        constant integer element1 = UInt(Elem[operand_src, 2*e + 0, esize DIV 2]);
        constant integer element2 = UInt(Elem[operand_src, 2*e + 1, esize DIV 2]);
