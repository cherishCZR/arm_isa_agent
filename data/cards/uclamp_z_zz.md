...
**Title**: UCLAMP -- A64 | **Class**: `sve2` | **XML ID**: `uclamp_z_zz`

**Architecture**: `FEAT_SME || FEAT_SVE2p1` (FEAT_SME || FEAT_SVE2p1)

**Summary**: Unsigned clamp to minimum/maximum vector

**Description**:
Clamp each unsigned element in the destination
vector to between the unsigned minimum value in
the corresponding element of the first source
vector and the unsigned maximum value in the
...
### Variant: `SVE2`
- **Assembly**: `UCLAMP  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  10  9   4  |
|--------------------------------|
| 010 0010 0   size 0   Zm  11000 1   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_clamp.sve_intx_clamp.uclamp_z_zz_)
...
#### Execute (A64.sve.sve_intx_clamp.sve_intx_clamp.uclamp_z_zz_)
