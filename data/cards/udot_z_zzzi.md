...
**Title**: UDOT (4-way, indexed) -- A64 | **Class**: `sve` | **XML ID**: `udot_z_zzzi`
...
- **Assembly**: `UDOT  <Zda>.S, <Zn>.B, <Zm>.B[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   10  1   i2  Zm  00000 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.udot_z_zzzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.udot_z_zzzi_s)
...
- **Assembly**: `UDOT  <Zda>.D, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  10  9   4  |
|-----------------------------------|
| 010 0010 0   11  1   i1  Zm  00000 1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_dot_by_indexed_elem.udot_z_zzzi_d)
