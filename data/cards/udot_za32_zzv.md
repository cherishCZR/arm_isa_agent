...
**Title**: UDOT (2-way, multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `udot_za32_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned integer dot-product by vector
...
vectors and two unsigned 16-bit integer values in the corresponding 32-bit element of the second source vector. The widened dot product result is destructively added to
...
- **Assembly**: `UDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  1   10  Zm  0   Rv  101 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_2way_dot_sm.udot_za32_zzv_2x1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi2_z_za_2way_dot_sm.udot_za32_zzv_2x1)
...
- **Assembly**: `UDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.H-<Zn4>.H }, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  |
|--------------------------------------------|
| 1   10  0000 10  1   11  Zm  0   Rv  101 Zn  1   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_z_za_2way_dot_sm.udot_za32_zzv_4x1)
