...
**Title**: UDOT (4-way, multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `udot_za_zzw`
...
- **Assembly**: `UDOT  ZA.<T>[<Wv>, <offs>{, VGx2}], { <Zn1>.<Tb>-<Zn2>.<Tb> }, { <Zm1>.<Tb>-<Zm2>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  |
|-----------------------------------------------|
| 1   10  0000 11  sz  1   Zm  00  Rv  101 Zn  0   1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_4way_dot_mm.udot_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_z_za_4way_dot_mm.udot_za_zzw_2x2)
...
- **Assembly**: `UDOT  ZA.<T>[<Wv>, <offs>{, VGx4}], { <Zn1>.<Tb>-<Zn4>.<Tb> }, { <Zm1>.<Tb>-<Zm4>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  |
|--------------------------------------------------|
| 1   10  0000 11  sz  1   Zm  0   10  Rv  101 Zn  00  1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_z_za_4way_dot_mm.udot_za_zzw_4x4)
