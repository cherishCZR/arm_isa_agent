...
**Title**: UHSUB -- A64 | **Class**: `sve2` | **XML ID**: `uhsub_z_p_zz`
...
**Description**:
Subtract active unsigned elements of the second source vector from
corresponding unsigned elements of the first source vector, shift
...
### Variant: `SVE2`
- **Assembly**: `UHSUB  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  13 12   9   4  |
|--------------------------------------------|
| 010 0010 0   size 0   10  0   1   1   10  0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary.uhsub_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary.uhsub_z_p_zz_)
