...
**Title**: UMAX (immediate) -- A64 | **Class**: `sve` | **XML ID**: `umax_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned maximum with immediate (unpredicated)

**Description**:
Determine the unsigned maximum of an immediate and
...
### Variant: `SVE`
- **Assembly**: `UMAX  <Zdn>.<T>, <Zdn>.<T>, #<imm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  13 12   4  |
|--------------------------------------|
| 001 0010 1   size 1   01  00  1   11  0   imm8 Zdn |
```

#### Decode (A64.sve.sve_wideimm_unpred.sve_int_arith_imm1.umax_z_zi_)
...
#### Execute (A64.sve.sve_wideimm_unpred.sve_int_arith_imm1.umax_z_zi_)
