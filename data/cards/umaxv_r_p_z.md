...
**Title**: UMAXV -- A64 | **Class**: `sve` | **XML ID**: `umaxv_r_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned maximum reduction to scalar

**Description**:
Unsigned maximum horizontally across all lanes of a vector, and place the result in the
...
### Variant: `SVE`
- **Assembly**: `UMAXV  <V><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  17 16 15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   010 0   1   001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_int_pred_red.sve_int_reduce_1.umaxv_r_p_z_)
...
#### Execute (A64.sve.sve_int_pred_red.sve_int_reduce_1.umaxv_r_p_z_)
