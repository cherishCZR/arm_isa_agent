...
**Title**: UMINV -- A64 | **Class**: `sve` | **XML ID**: `uminv_r_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned minimum reduction to scalar

**Description**:
Unsigned minimum horizontally across all lanes of a vector, and place the result in the
...
### Variant: `SVE`
- **Assembly**: `UMINV  <V><d>, <Pg>, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  17 16 15  12   9   4  |
|--------------------------------------|
| 000 0010 0   size 0   010 1   1   001 Pg  Zn  Vd  |
```

#### Decode (A64.sve.sve_int_pred_red.sve_int_reduce_1.uminv_r_p_z_)
...
#### Execute (A64.sve.sve_int_pred_red.sve_int_reduce_1.uminv_r_p_z_)
