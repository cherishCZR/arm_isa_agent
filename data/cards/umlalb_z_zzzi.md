...
**Title**: UMLALB (indexed) -- A64 | **Class**: `sve2` | **XML ID**: `umlalb_z_zzzi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Unsigned multiply-add long to accumulator (bottom, indexed)
...
### Variant: `32-bit`
- **Assembly**: `UMLALB  <Zda>.S, <Zn>.H, <Zm>.H[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  15  13 12 11 10  9   4  |
|--------------------------------------------|
| 010 0010 0   10  1   i3h Zm  10  0   1   i3l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_long_by_indexed_elem.umlalb_z_zzzi_s)
...
#### Execute (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_long_by_indexed_elem.umlalb_z_zzzi_s)
...
### Variant: `64-bit`
- **Assembly**: `UMLALB  <Zda>.D, <Zn>.S, <Zm>.S[<imm>]`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13 12 11 10  9   4  |
|--------------------------------------------|
| 010 0010 0   11  1   i2h Zm  10  0   1   i2l 0   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_by_indexed_elem.sve_intx_mla_long_by_indexed_elem.umlalb_z_zzzi_d)
