...
**Title**: UMLALL (multiple and single vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `umlall_za_zzv`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned integer multiply-add long-long by vector

**Description**:
This instruction
multiplies each unsigned 8-bit or 16-bit element in the one, two, or four
first source vectors with each unsigned 8-bit or 16-bit
element in the second source vector, widens each product to 32 bits or 64 bits,
...
- **Assembly**: `UMLALL  ZA.<T>[<Wv>, <offs1>:<offs4>], <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  1  |
|-----------------------------------------------|
| 1   10  0000 10  sz  10  Zm  0   Rv  001 Zn  1   0   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi1_zz_za_mla_long_long_sm.umlall_za_zzv_1)
...
#### Execute (A64.sme.mortlach_multi_array_1a.mortlach_multi1_zz_za_mla_long_long_sm.umlall_za_zzv_1)
...
- **Assembly**: `UMLALL  ZA.<T>[<Wv>, <offs1>:<offs4>{, VGx2}], { <Zn1>.<Tb>-<Zn2>.<Tb> }, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  1  0 |
|--------------------------------------------------|
| 1   10  0000 10  sz  10  Zm  0   Rv  000 Zn  1   0   0   0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_1a.mortlach_multi2_zz_za_mla_long_long_sm.umlall_za_zzv_2x1)
...
- **Assembly**: `UMLALL  ZA.<T>[<Wv>, <offs1>:<offs4>{, VGx4}], { <Zn1>.<Tb>-<Zn4>.<Tb> }, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21  19  15 14  12   9   4  3  2  1  0 |
|--------------------------------------------------|
| 1   10  0000 10  sz  11  Zm  0   Rv  000 Zn  1   0   0   0   o1  |
```

#### Decode (A64.sme.mortlach_multi_array_1b.mortlach_multi4_zz_za_mla_long_long_sm.umlall_za_zzv_4x1)
