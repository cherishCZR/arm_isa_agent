...
**Title**: UMLALT (vectors) -- A64 | **Class**: `sve2` | **XML ID**: `umlalt_z_zzz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Unsigned multiply-add long to accumulator (top)

**Description**:
Multiply the corresponding odd-numbered unsigned elements of the first
and second source vectors and destructively add to the overlapping double-width
...
### Variant: `SVE2`
- **Assembly**: `UMLALT  <Zda>.<T>, <Zn>.<Tb>, <Zm>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14  12 11 10  9   4  |
|-----------------------------------------|
| 010 0010 0   size 0   Zm  0   10  0   1   1   Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.umlalt_z_zzz_)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_mlal_long.umlalt_z_zzz_)
