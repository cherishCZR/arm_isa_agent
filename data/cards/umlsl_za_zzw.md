...
**Title**: UMLSL (multiple vectors) -- A64 | **Class**: `mortlach2` | **XML ID**: `umlsl_za_zzw`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned integer multiply-subtract long

**Description**:
This instruction multiplies each unsigned 16-bit element
in the two or four first source
vectors with each unsigned 16-bit element in the
...
- **Assembly**: `UMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx2}], { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  16  14  12   9   5  4  3  2  1  |
|--------------------------------------------------|
| 1   10  0000 11  1   1   Zm  00  Rv  010 Zn  0   1   1   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_mla_long_mm.umlsl_za_zzw_2x2)
...
#### Execute (A64.sme.mortlach_multi_array_2a.mortlach_multi2_zz_za_mla_long_mm.umlsl_za_zzw_2x2)
...
- **Assembly**: `UMLSL  ZA.S[<Wv>, <offs1>:<offs2>{, VGx4}], { <Zn1>.H-<Zn4>.H }, { <Zm1>.H-<Zm4>.H }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  22 21 20  17 16  14  12   9   6   4  3  2  1  |
|-----------------------------------------------------|
| 1   10  0000 11  1   1   Zm  0   10  Rv  010 Zn  00  1   1   0   off2 |
```

#### Decode (A64.sme.mortlach_multi_array_2b.mortlach_multi4_zz_za_mla_long_mm.umlsl_za_zzw_4x4)
