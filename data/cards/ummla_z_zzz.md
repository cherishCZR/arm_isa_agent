...
**Title**: UMMLA -- A64 | **Class**: `sve` | **XML ID**: `ummla_z_zzz`

**Architecture**: `FEAT_SVE && FEAT_I8MM` (FEAT_SVE && FEAT_I8MM)

**Summary**: Unsigned 8-bit integer matrix multiply-accumulate to 32-bit integer
...
the first source vector by the 8×2 matrix of unsigned 8-bit integer values in the
...
### Variant: `SVE`
- **Assembly**: `UMMLA  <Zda>.S, <Zn>.B, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13   9   4  |
|--------------------------------|
| 010 0010 1   11  0   Zm  10  0110 Zn  Zda |
```

#### Decode (A64.sve.sve_intx_constructive.sve_intx_mmla.ummla_z_zzz_)
...
#### Execute (A64.sve.sve_intx_constructive.sve_intx_mmla.ummla_z_zzz_)
