...
**Title**: UMOPS (4-way) -- A64 | **Class**: `mortlach` | **XML ID**: `umops_za_pp_zz`
...
### Variant: `32-bit`
- **Assembly**: `UMOPS  <ZAda>.S, <Pn>/M, <Pm>/M, <Zn>.B, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12   9   4  3  2  1  |
|--------------------------------------------|
| 1   01  0000 1   10  1   Zm  Pm  Pn  Zn  1   0   0   ZAda |
```

#### Decode (A64.sme.mortlach_32bit_int_prod.mortlach_i8i32_prod.umops_za_pp_zz_32)
...
#### Execute (A64.sme.mortlach_32bit_int_prod.mortlach_i8i32_prod.umops_za_pp_zz_32)
...
### Variant: `64-bit`
- **Assembly**: `UMOPS  <ZAda>.D, <Pn>/M, <Pm>/M, <Zn>.H, <Zm>.H`
**Encoding Diagram (32-bit)**:

```text
| 31 30 29 28  24 23  21 20  15  12   9   4  3  2  |
|--------------------------------------------|
| 1   0   1   0000 1   11  1   Zm  Pm  Pn  Zn  1   0   ZAda |
```

#### Decode (A64.sme.mortlach_64bit_prod.mortlach_i16i64_prod.umops_za_pp_zz_64)
