...
**Title**: UQADD (immediate) -- A64 | **Class**: `sve` | **XML ID**: `uqadd_z_zi`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned saturating add immediate (unpredicated)
...
### Variant: `SVE`
- **Assembly**: `UQADD  <Zdn>.<T>, <Zdn>.<T>, #<imm>{, <shift>}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18  16 15  13 12   4  |
|--------------------------------------|
| 001 0010 1   size 1   00  10  1   11  sh  imm8 Zdn |
```

#### Decode (A64.sve.sve_wideimm_unpred.sve_int_arith_imm0.uqadd_z_zi_)
...
#### Execute (A64.sve.sve_wideimm_unpred.sve_int_arith_imm0.uqadd_z_zi_)
