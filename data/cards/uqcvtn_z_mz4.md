...
**Title**: UQCVTN -- A64 | **Class**: `mortlach2` | **XML ID**: `uqcvtn_z_mz4`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned saturating extract narrow and interleave

**Description**:
This instruction saturates the unsigned integer value in each element of the four source
vectors to  quarter the original source element width, and places the four-way interleaved results in the quarter-width
...
### Variant: `SME2`
- **Assembly**: `UQCVTN  <Zd>.<T>, { <Zn1>.<Tb>-<Zn4>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23 22 21 20  17  15   9   6  5  4  |
|--------------------------------------------|
| 1   10  0000 1   sz  0   1   100 11  111000 Zn  1   1   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.uqcvtn_z_mz4_)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi4_narrow_int_cvrt.uqcvtn_z_mz4_)
...
for e = 0 to elements-1
    for i = 0 to 3
        ...
        constant integer element = UInt(Elem[operand, e, 4 * esize]);
