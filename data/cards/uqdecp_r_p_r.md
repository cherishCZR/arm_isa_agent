...
**Title**: UQDECP (scalar) -- A64 | **Class**: `sve` | **XML ID**: `uqdecp_r_p_r`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned saturating decrement scalar by count of true predicate elements
...
### Variant: `32-bit`
- **Assembly**: `UQDECP  <Wdn>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18 17 16 15  11 10  9  8   4  |
|--------------------------------------------|
| 001 0010 1   size 101 0   1   1   1000 1   0   0   Pm  Rdn |
```

#### Decode (A64.sve.sve_pred_count_b.sve_int_count_r_sat.uqdecp_r_p_r_uw)
...
#### Execute (A64.sve.sve_pred_count_b.sve_int_count_r_sat.uqdecp_r_p_r_uw)
...
### Variant: `64-bit`
- **Assembly**: `UQDECP  <Xdn>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21  18 17 16 15  11 10  9  8   4  |
|--------------------------------------------|
| 001 0010 1   size 101 0   1   1   1000 1   1   0   Pm  Rdn |
```

#### Decode (A64.sve.sve_pred_count_b.sve_int_count_r_sat.uqdecp_r_p_r_x)
