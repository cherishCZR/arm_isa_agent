...
**Title**: UQINCW (scalar) -- A64 | **Class**: `sve` | **XML ID**: `uqincw_r_rs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned saturating increment scalar by multiple of 32-bit predicate constraint element count
...
### Variant: `32-bit`
- **Assembly**: `UQINCW  <Wdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   10  1   0   imm4 11  11  0   1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.uqincw_r_rs_uw)
...
#### Execute (A64.sve.sve_countelt.sve_int_pred_pattern_b.uqincw_r_rs_uw)
...
### Variant: `64-bit`
- **Assembly**: `UQINCW  <Xdn>{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   10  1   1   imm4 11  11  0   1   pattern Rdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_pred_pattern_b.uqincw_r_rs_x)
