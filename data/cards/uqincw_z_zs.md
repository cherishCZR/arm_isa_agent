...
**Title**: UQINCW (vector) -- A64 | **Class**: `sve` | **XML ID**: `uqincw_z_zs`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned saturating increment vector by multiple of 32-bit predicate constraint element count
...
### Variant: `SVE`
- **Assembly**: `UQINCW  <Zdn>.S{, <pattern>{, MUL #<imm>}}`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  13  11 10  9   4  |
|-----------------------------------------|
| 000 0010 0   10  1   0   imm4 11  00  0   1   pattern Zdn |
```

#### Decode (A64.sve.sve_countelt.sve_int_countvlv0.uqincw_z_zs_)
...
#### Execute (A64.sve.sve_countelt.sve_int_countvlv0.uqincw_z_zs_)
