...
**Title**: UQRSHR (two registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `uqrshr_z_mz2`
...
### Variant: `SME2`
- **Assembly**: `UQRSHR  <Zd>.H, { <Zn1>.S-<Zn2>.S }, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20 19  15  12   9   5  4  |
|-----------------------------------------|
| 1   10  0000 1   11  1   0   imm4 110 101 Zn  1   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_3.mortlach_multi2_qrshr.uqrshr_z_mz2_)
...
#### Execute (A64.sme.mortlach_multi_sve_3.mortlach_multi2_qrshr.uqrshr_z_mz2_)
