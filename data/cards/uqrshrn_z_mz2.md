...
**Title**: UQRSHRN -- A64 | **Class**: `sve2` | **XML ID**: `uqrshrn_z_mz2`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: Unsigned saturating rounding shift right narrow by immediate and interleave

**Description**:
This instruction shifts right by an immediate value the unsigned integer value in each element of
...
### Variant: `16-bit`
- **Assembly**: `UQRSHRN  <Zd>.H, { <Zn1>.S-<Zn2>.S }, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20 19  15 14 13 12 11 10  9   5  4  |
|-----------------------------------------------------|
| 010 0010 1   1   0   1   1   imm4 0   0   1   1   1   0   Zn  0   Zd  |
```

#### Decode (A64.sve.sve_intx_narrowing.sve_intx_multi_shift_narrow.uqrshrn_z_mz2_)
...
#### Execute (A64.sve.sve_intx_narrowing.sve_intx_multi_shift_narrow.uqrshrn_z_mz2_)
