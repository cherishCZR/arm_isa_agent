...
**Title**: UQRSHRN -- A64 | **Class**: `mortlach2` | **XML ID**: `uqrshrn_z_mz4`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned saturating rounding shift right narrow by immediate and interleave
...
### Variant: `SME2`
- **Assembly**: `UQRSHRN  <Zd>.<T>, { <Zn1>.<Tb>-<Zn4>.<Tb> }, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15  12  10  9   6  5  4  |
|--------------------------------------------|
| 1   10  0000 1   tsize 1   imm5 110 11  1   Zn  0   1   Zd  |
```

#### Decode (A64.sme.mortlach_multi_sve_3.mortlach_multi4_qrshr.uqrshrn_z_mz4_)
...
#### Execute (A64.sme.mortlach_multi_sve_3.mortlach_multi4_qrshr.uqrshrn_z_mz4_)
