...
**Title**: URSQRTE -- A64 | **Class**: `sve2` | **XML ID**: `ursqrte_z_p_z`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Unsigned reciprocal square root estimate (predicated)

**Description**:
Find the approximate reciprocal square root of each active unsigned
...
### Variant: `Merging`
- **Assembly**: `URSQRTE  <Zd>.S, <Pg>/M, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18 17 16 15  13 12   9   4  |
|-----------------------------------------------|
| 010 0010 0   size 0   0   0   0   0   1   10  1   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_unary.ursqrte_z_p_z_m)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_pred_arith_unary.ursqrte_z_p_z_m)
...
### Variant: `Zeroing`
- **Assembly**: `URSQRTE  <Zd>.S, <Pg>/Z, <Zn>.S`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18 17 16 15  13 12   9   4  |
|-----------------------------------------------|
| 010 0010 0   size 0   0   0   0   1   1   10  1   Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_unary.ursqrte_z_p_z_z)
