...
**Title**: USDOT (vectors) -- A64 | **Class**: `sve` | **XML ID**: `usdot_z_zzz`

**Architecture**: `(FEAT_SVE || FEAT_SME) && FEAT_I8MM` ((FEAT_SVE || FEAT_SME) && FEAT_I8MM)

**Summary**: Unsigned by signed 8-bit integer dot product to 32-bit integer

**Description**:
The unsigned by signed integer  dot
...
### Variant: `SVE`
- **Assembly**: `USDOT  <Zda>.S, <Zn>.B, <Zm>.B`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15 14   9   4  |
|--------------------------------|
| 010 0010 0   10  0   Zm  0   11110 Zn  Zda |
```

#### Decode (A64.sve.sve_intx_muladd_unpred.sve_intx_mixed_dot.usdot_z_zzz_s)
...
#### Execute (A64.sve.sve_intx_muladd_unpred.sve_intx_mixed_dot.usdot_z_zzz_s)
