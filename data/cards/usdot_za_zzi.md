...
**Title**: USDOT (4-way, multiple and indexed vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `usdot_za_zzi`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Multi-vector unsigned by signed integer dot-product by indexed element
...
- **Assembly**: `USDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.B-<Zn2>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  1   i2  Zn  1   0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.usdot_za_zzi_s2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.usdot_za_zzi_s2xi)
...
- **Assembly**: `USDOT  ZA.S[<Wv>, <offs>{, VGx4}], { <Zn1>.B-<Zn4>.B }, <Zm>.B[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   6  5  4  3  2  |
|-----------------------------------------------------|
| 1   10  0000 1   01  01  Zm  1   Rv  1   i2  Zn  0   1   0   1   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_3.mortlach_multi4_zza_idx_s.usdot_za_zzi_s4xi)
