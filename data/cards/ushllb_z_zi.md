...
**Title**: USHLLB -- A64 | **Class**: `sve2` | **XML ID**: `ushllb_z_zi`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Unsigned shift left long by immediate (bottom)

**Description**:
Shift left by immediate each even-numbered unsigned element of the
source vector, and place the results in the overlapping double-width elements of
...
### Variant: `SVE2`
- **Assembly**: `USHLLB  <Zd>.<T>, <Zn>.<Tb>, #<const>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23 22 21 20  18  15  13  11 10  9   4  |
|--------------------------------------------|
| 010 0010 1   0   tszh 0   tszl imm3 10  10  1   0   Zn  Zd  |
```

#### Decode (A64.sve.sve_intx_constructive.sve_intx_shift_long.ushllb_z_zi_)
...
#### Execute (A64.sve.sve_intx_constructive.sve_intx_shift_long.ushllb_z_zi_)
...
for e = 0 to elements-1
    constant bits(esize) element = Elem[operand, 2*e + 0, esize];
