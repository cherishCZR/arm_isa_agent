...
**Title**: USQADD -- A64 | **Class**: `sve2` | **XML ID**: `usqadd_z_p_zz`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: Unsigned saturating addition of signed value

**Description**:
Add active signed elements of the source vector to the
corresponding unsigned elements of the addend vector, and
destructively place the results in the corresponding
elements of the addend vector.  Each result element is saturated to the
 N-bit element's
...
### Variant: `SVE2`
- **Assembly**: `USQADD  <Zdn>.<T>, <Pg>/M, <Zdn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15  13 12   9   4  |
|--------------------------------------------|
| 010 0010 0   size 0   11  1   0   1   10  0   Pg  Zm  Zdn |
```

#### Decode (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.usqadd_z_p_zz_)
...
#### Execute (A64.sve.sve_intx_predicated.sve_intx_pred_arith_binary_sat.usqadd_z_p_zz_)
