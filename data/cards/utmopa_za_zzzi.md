...
**Title**: UTMOPA (4-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `utmopa_za_zzzi`

**Architecture**: `FEAT_SME_TMOP` (ARMv9.6)

**Summary**: Unsigned integer sparse sum of four outer products, accumulating
...
### Variant: `SME2`
- **Assembly**: `UTMOPA  <ZAda>.S, { <Zn1>.B-<Zn2>.B }, <Zm>.B, <Zk>[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  15 14 13 12 11   9   5   3  2  1  |
|-----------------------------------------------------|
| 1   00  0000 1   01  1   Zm  1   0   0   K   Zk  Zn  i2  0   0   ZAda |
```

#### Decode (A64.sme.mortlach2_ss_prod.mortlach_i8i32_2in4ss_prod.utmopa_za_zzzi_b2x1)
...
#### Execute (A64.sme.mortlach2_ss_prod.mortlach_i8i32_2in4ss_prod.utmopa_za_zzzi_b2x1)
