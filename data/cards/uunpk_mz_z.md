...
**Title**: UUNPK -- A64 | **Class**: `mortlach2` | **XML ID**: `uunpk_mz_z`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Unpack and zero-extend multi-vector elements
...
- **Assembly**: `UUNPK  { <Zd1>.<T>-<Zd2>.<T> }, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   4   0 |
|--------------------------------------|
| 1   10  0000 1   size 1   001 01  111000 Zn  Zd  1   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_int.uunpk_mz_z_2)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi2_wide_int.uunpk_mz_z_2)
...
- **Assembly**: `UUNPK  { <Zd1>.<T>-<Zd4>.<T> }, { <Zn1>.<Tb>-<Zn2>.<Tb> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   5  4   1  0 |
|--------------------------------------------|
| 1   10  0000 1   size 1   101 01  111000 Zn  0   Zd  0   1   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_wide_int.uunpk_mz_z_4)
