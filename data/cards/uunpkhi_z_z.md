...
**Title**: UUNPKHI, UUNPKLO -- A64 | **Class**: `sve` | **XML ID**: `uunpkhi_z_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Unsigned unpack and extend half of vector

**Description**:
Unpack elements from the lowest or highest half of the source
vector and then zero-extend them to place in
...
### Variant: `High half`
- **Assembly**: `UUNPKHI  <Zd>.<T>, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15   9   4  |
|--------------------------------------|
| 000 0010 1   size 1   10  0   1   1   001110 Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_unpred_d.sve_int_perm_unpk.uunpkhi_z_z_)
...
#### Execute (A64.sve.sve_perm_unpred_d.sve_int_perm_unpk.uunpkhi_z_z_)
...
### Variant: `Low half`
- **Assembly**: `UUNPKLO  <Zd>.<T>, <Zn>.<Tb>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  18 17 16 15   9   4  |
|--------------------------------------|
| 000 0010 1   size 1   10  0   1   0   001110 Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_unpred_d.sve_int_perm_unpk.uunpklo_z_z_)
