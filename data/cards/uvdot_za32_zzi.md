...
**Title**: UVDOT (2-way) -- A64 | **Class**: `mortlach2` | **XML ID**: `uvdot_za32_zzi`
...
vertical dot product of the corresponding two unsigned 16-bit integer values held in the
two first source vectors and two unsigned 16-bit integer values in
...
### Variant: `SME2`
- **Assembly**: `UVDOT  ZA.S[<Wv>, <offs>{, VGx2}], { <Zn1>.H-<Zn2>.H }, <Zm>.H[<index>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21  19  15 14  12 11   9   5  4  3  2  |
|--------------------------------------------------|
| 1   10  0000 1   01  01  Zm  0   Rv  0   i2  Zn  1   1   0   off3 |
```

#### Decode (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.uvdot_za32_zzi_2xi)
...
#### Execute (A64.sme.mortlach_multi_indexed_2.mortlach_multi2_zza_idx_s.uvdot_za32_zzi_2xi)
...
for r = 0 to 1
    ...
    for e = 0 to elements-1
        ...
        for i = 0 to 1
            ...
            constant integer element1 = UInt(Elem[operand1, 2 * e + r, esize DIV 2]);
