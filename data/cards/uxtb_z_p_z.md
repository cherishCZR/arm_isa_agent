...
**Title**: UXTB, UXTH, UXTW -- A64 | **Class**: `sve` | **XML ID**: `uxtb_z_p_z`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_SVE2p2 || FEAT_SME2p2` (FEAT_SVE2p2 || FEAT_SME2p2)

**Summary**: Unsigned byte / halfword / word extend (predicated)

**Description**:
Zero-extend the least-significant sub-element  of
...
- **Assembly**: `UXTB  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   1   0   00  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxtb_z_p_z_m)
...
#### Execute (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxtb_z_p_z_m)
...
- **Assembly**: `UXTB  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   0   0   00  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxtb_z_p_z_z)
...
- **Assembly**: `UXTH  <Zd>.<T>, <Pg>/M, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   1   0   01  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxth_z_p_z_m)
...
- **Assembly**: `UXTH  <Zd>.<T>, <Pg>/Z, <Zn>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   0   0   01  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxth_z_p_z_z)
...
- **Assembly**: `UXTW  <Zd>.D, <Pg>/M, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   1   0   10  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxtw_z_p_z_m)
...
- **Assembly**: `UXTW  <Zd>.D, <Pg>/Z, <Zn>.D`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19 18  16 15  12   9   4  |
|-----------------------------------------|
| 000 0010 0   size 0   0   0   10  1   101 Pg  Zn  Zd  |
```

#### Decode (A64.sve.sve_int_pred_un.sve_int_un_pred_arit_0.uxtw_z_p_z_z)
