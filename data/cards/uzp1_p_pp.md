...
**Title**: UZP1, UZP2 (predicates) -- A64 | **Class**: `sve` | **XML ID**: `uzp1_p_pp`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: Concatenate even or odd elements from two predicates

**Description**:
Concatenate adjacent even or odd-numbered elements from the
 first and second
...
### Variant: `Even`
- **Assembly**: `UZP1  <Pd>.<T>, <Pn>.<T>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12  10  9  8   4  3  |
|--------------------------------------------|
| 000 0010 1   size 1   0   Pm  010 01  0   0   Pn  0   Pd  |
```

#### Decode (A64.sve.sve_perm_predicates.sve_int_perm_bin_perm_pp.uzp1_p_pp_)
...
#### Execute (A64.sve.sve_perm_predicates.sve_int_perm_bin_perm_pp.uzp1_p_pp_)
...
### Variant: `Odd`
- **Assembly**: `UZP2  <Pd>.<T>, <Pn>.<T>, <Pm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20 19  15  12  10  9  8   4  3  |
|--------------------------------------------|
| 000 0010 1   size 1   0   Pm  010 01  1   0   Pn  0   Pd  |
```

#### Decode (A64.sve.sve_perm_predicates.sve_int_perm_bin_perm_pp.uzp2_p_pp_)
