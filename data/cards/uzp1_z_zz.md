...
**Title**: UZP1, UZP2 (vectors) -- A64 | **Class**: `sve` | **XML ID**: `uzp1_z_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_F64MM` (PROFILE_A)

**Summary**: Concatenate even or odd elements from two vectors

**Description**:
Concatenate adjacent even or odd-numbered elements
from the 
first and second source vectors and place in
elements of the destination vector.  This instruction is unpredicated.

Note: UZP1 is equivalent to truncating and packing each
element from two source vectors into a single
destination vector with elements of half the size.
...
### Variant: `Even`
- **Assembly**: `UZP1  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 1   size 1   Zm  011 01  0   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.uzp1_z_zz_)
...
#### Execute (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.uzp1_z_zz_)
...
- **Assembly**: `UZP1  <Zd>.Q, <Zn>.Q, <Zm>.Q`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 11  0   1   Zm  000 01  0   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter_long.sve_int_perm_bin_long_perm_zz.uzp1_z_zz_q)
...
### Variant: `Odd`
- **Assembly**: `UZP2  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 1   size 1   Zm  011 01  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.uzp2_z_zz_)
...
- **Assembly**: `UZP2  <Zd>.Q, <Zn>.Q, <Zm>.Q`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 11  0   1   Zm  000 01  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter_long.sve_int_perm_bin_long_perm_zz.uzp2_z_zz_q)
