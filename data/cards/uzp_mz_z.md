...
**Title**: UZP (four registers) -- A64 | **Class**: `mortlach2` | **XML ID**: `uzp_mz_z`

**Architecture**: `FEAT_SME2` (ARMv9.3)

**Summary**: Concatenate elements from four vectors

**Description**:
This instruction concatenates every fourth element from each of the four source vectors
and places them in the corresponding elements of the four destination vectors.
...
- **Assembly**: `UZP  { <Zd1>.<T>-<Zd4>.<T> }, { <Zn1>.<T>-<Zn4>.<T> }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   6   4   1  0 |
|--------------------------------------------|
| 1   10  0000 1   size 1   101 10  111000 Zn  00  Zd  1   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_z_z_zip.uzp_mz_z_4)
...
#### Execute (A64.sme.mortlach_multi_sve_4.mortlach_multi4_z_z_zip.uzp_mz_z_4)
...
- **Assembly**: `UZP  { <Zd1>.Q-<Zd4>.Q }, { <Zn1>.Q-<Zn4>.Q }`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24 23  21 20  17  15   9   6   4   1  0 |
|--------------------------------------------|
| 1   10  0000 1   00  1   101 11  111000 Zn  00  Zd  1   0   |
```

#### Decode (A64.sme.mortlach_multi_sve_4.mortlach_multi4_z_z_long_zip.uzp_mz_z_4q)
