...
**Title**: UZPQ2 -- A64 | **Class**: `sve2` | **XML ID**: `uzpq2_z_zz`

**Architecture**: `FEAT_SVE2p1 || FEAT_SME2p1` (FEAT_SVE2p1 || FEAT_SME2p1)

**Summary**: Concatenate odd elements within each pair of quadword vector segments

**Description**:
Concatenate adjacent odd-numbered elements from the corresponding
...
### Variant: `SVE2`
- **Assembly**: `UZPQ2  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 010 0010 0   size 0   Zm  111 01  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_quads_b.sve_int_perm_binquads.uzpq2_z_zz_)
...
#### Execute (A64.sve.sve_perm_quads_b.sve_int_perm_binquads.uzpq2_z_zz_)
