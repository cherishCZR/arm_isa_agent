...
**Title**: WHILEGT (predicate as counter) -- A64 | **Class**: `sve2` | **XML ID**: `whilegt_pn_rr`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: While decrementing signed scalar greater than scalar (predicate-as-counter)
...
of the first, signed  scalar operand is greater than the second scalar
...
### Variant: `SVE2`
- **Assembly**: `WHILEGT  <PNd>.<T>, <Xn>, <Xm>, <vl>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13 12 11 10  9   4  3  2  |
|-----------------------------------------------|
| 001 0010 1   size 1   Rm  01  vl  0   0   0   Rn  1   1   PNd |
```

#### Decode (A64.sve.sve_while_pn.sve_int_while_rr_pn.whilegt_pn_rr_)
...
#### Execute (A64.sve.sve_while_pn.sve_int_while_rr_pn.whilegt_pn_rr_)
