...
**Title**: WHILEHI (predicate) -- A64 | **Class**: `sve2` | **XML ID**: `whilehi_p_p_rr`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: While decrementing unsigned scalar higher than scalar
...
### Variant: `SVE2`
- **Assembly**: `WHILEHI  <Pd>.<T>, <R><n>, <R><m>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13 12 11 10  9   4  3  |
|--------------------------------------------|
| 001 0010 1   size 1   Rm  00  0   sf  1   0   Rn  1   Pd  |
```

#### Decode (A64.sve.sve_cmpgpr.sve_int_while_rr.whilehi_p_p_rr_)
...
#### Execute (A64.sve.sve_cmpgpr.sve_int_while_rr.whilehi_p_p_rr_)
