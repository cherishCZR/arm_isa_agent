...
**Title**: WHILEHS (predicate pair) -- A64 | **Class**: `sve2` | **XML ID**: `whilehs_pp_rr`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: While decrementing unsigned scalar higher or same as scalar (pair of predicates)

**Description**:
Generate a pair of predicates that starting from the highest numbered element of the pair
is true while the decrementing value of the first, unsigned
 scalar operand is higher or same as the second scalar operand and
...
### Variant: `SVE2`
- **Assembly**: `WHILEHS  { <Pd1>.<T>, <Pd2>.<T> }, <Xn>, <Xm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11 10  9   4  3   0 |
|--------------------------------------------|
| 001 0010 1   size 1   Rm  01  01  1   0   Rn  1   Pd  0   |
```

#### Decode (A64.sve.sve_while_pn.sve_int_while_rr_pair.whilehs_pp_rr_)
...
#### Execute (A64.sve.sve_while_pn.sve_int_while_rr_pair.whilehs_pp_rr_)
