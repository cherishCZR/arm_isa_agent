...
**Title**: WHILELS (predicate pair) -- A64 | **Class**: `sve2` | **XML ID**: `whilels_pp_rr`

**Architecture**: `FEAT_SME2 || FEAT_SVE2p1` (FEAT_SME2 || FEAT_SVE2p1)

**Summary**: While incrementing unsigned scalar lower or same as scalar (pair of predicates)
...
### Variant: `SVE2`
- **Assembly**: `WHILELS  { <Pd1>.<T>, <Pd2>.<T> }, <Xn>, <Xm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11 10  9   4  3   0 |
|--------------------------------------------|
| 001 0010 1   size 1   Rm  01  01  1   1   Rn  1   Pd  1   |
```

#### Decode (A64.sve.sve_while_pn.sve_int_while_rr_pair.whilels_pp_rr_)
...
#### Execute (A64.sve.sve_while_pn.sve_int_while_rr_pair.whilels_pp_rr_)
