...
**Title**: WHILELT (predicate) -- A64 | **Class**: `sve` | **XML ID**: `whilelt_p_p_rr`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME)

**Summary**: While incrementing signed scalar less than scalar
...
### Variant: `SVE`
- **Assembly**: `WHILELT  <Pd>.<T>, <R><n>, <R><m>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13 12 11 10  9   4  3  |
|--------------------------------------------|
| 001 0010 1   size 1   Rm  00  0   sf  0   1   Rn  0   Pd  |
```

#### Decode (A64.sve.sve_cmpgpr.sve_int_while_rr.whilelt_p_p_rr_)
...
#### Execute (A64.sve.sve_cmpgpr.sve_int_while_rr.whilelt_p_p_rr_)
