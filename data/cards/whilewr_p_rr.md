...
**Title**: WHILEWR -- A64 | **Class**: `sve2` | **XML ID**: `whilewr_p_rr`

**Architecture**: `FEAT_SVE2 || FEAT_SME` (FEAT_SVE2 || FEAT_SME)

**Summary**: While free of write-after-read/write conflicts
...
### Variant: `SVE2`
- **Assembly**: `WHILEWR  <Pd>.<T>, <Xn>, <Xm>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  13  11   9   4  3  |
|--------------------------------------|
| 001 0010 1   size 1   Rm  00  11  00  Rn  0   Pd  |
```

#### Decode (A64.sve.sve_cmpgpr.sve_int_whilenc.whilewr_p_rr_)
...
#### Execute (A64.sve.sve_cmpgpr.sve_int_whilenc.whilewr_p_rr_)
