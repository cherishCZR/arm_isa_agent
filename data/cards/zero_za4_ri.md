...
**Title**: ZERO (quad-vector) -- A64 | **Class**: `mortlach2` | **XML ID**: `zero_za4_ri`

**Architecture**: `FEAT_SME2p1` (ARMv9.4)

**Summary**: Zero ZA quad-vector groups
...
- **Assembly**: `ZERO  ZA.D[<Wv>, <offs1>:<offs4>]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  17  14  12   2  1  |
|-----------------------------|
| 1   10  0000 0000011 101 Rv  0000000000 0   off2 |
```

#### Decode (A64.sme.mortlach_multizero.mortlach_multi_zero.zero_za4_ri_1)
...
#### Execute (A64.sme.mortlach_multizero.mortlach_multi_zero.zero_za4_ri_1)
...
- **Assembly**: `ZERO  ZA.D[<Wv>, <offs1>:<offs4>, VGx2]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  17  14  12   2   0 |
|-----------------------------|
| 1   10  0000 0000011 110 Rv  0000000000 00  o1  |
```

#### Decode (A64.sme.mortlach_multizero.mortlach_multi_zero.zero_za4_ri_2)
...
- **Assembly**: `ZERO  ZA.D[<Wv>, <offs1>:<offs4>, VGx4]`
**Encoding Diagram (32-bit)**:

```text
| 31 30  28  24  17  14  12   2   0 |
|-----------------------------|
| 1   10  0000 0000011 111 Rv  0000000000 00  o1  |
```

#### Decode (A64.sme.mortlach_multizero.mortlach_multi_zero.zero_za4_ri_4)
