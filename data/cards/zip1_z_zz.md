...
**Title**: ZIP1, ZIP2 (vectors) -- A64 | **Class**: `sve` | **XML ID**: `zip1_z_zz`

**Architecture**: `FEAT_SVE || FEAT_SME` (FEAT_SVE || FEAT_SME), `FEAT_F64MM` (PROFILE_A)

**Summary**: Interleave elements from two half vectors

**Description**:
Interleave alternating  elements
from the lowest or highest halves of the
...
### Variant: `High halves`
- **Assembly**: `ZIP2  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 1   size 1   Zm  011 00  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.zip2_z_zz_)
...
#### Execute (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.zip2_z_zz_)
...
### Variant: `High halves (quadwords)`
- **Assembly**: `ZIP2  <Zd>.Q, <Zn>.Q, <Zm>.Q`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 11  0   1   Zm  000 00  1   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter_long.sve_int_perm_bin_long_perm_zz.zip2_z_zz_q)
...
### Variant: `Low halves`
- **Assembly**: `ZIP1  <Zd>.<T>, <Zn>.<T>, <Zm>.<T>`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24 23  21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 1   size 1   Zm  011 00  0   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter.sve_int_perm_bin_perm_zz.zip1_z_zz_)
...
### Variant: `Low halves (quadwords)`
- **Assembly**: `ZIP1  <Zd>.Q, <Zn>.Q, <Zm>.Q`
**Encoding Diagram (32-bit)**:

```text
| 31  28  24  22 21 20  15  12  10  9   4  |
|-----------------------------------|
| 000 0010 11  0   1   Zm  000 00  0   Zn  Zd  |
```

#### Decode (A64.sve.sve_perm_inter_long.sve_int_perm_bin_long_perm_zz.zip1_z_zz_q)
